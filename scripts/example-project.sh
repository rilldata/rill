...
curl -s http://pkg.rilldata.com/rill-developer-example/data/aircraftDatabase-2022-02.csv --output ../rill-developer-example/data/flightlist_2022_02.csv
curl -s http://pkg.rilldata.com/rill-developer-example/data/flightlist.zip --output ../rill-developer-example/data/flightlist_README.zip
