...
ALTER TABLE orgs ADD COLUMN quota_users INTEGER NOT NULL DEFAULT -1; -- review: do we need quota on num admins as well
ALTER TABLE orgs ADD COLUMN quota_managed_data_bytes BIGINT NOT NULL DEFAULT -1;
UPDATE orgs SET quota_users = 10, quota_managed_data_bytes = 5368709120; -- review: does this fit with current limits
