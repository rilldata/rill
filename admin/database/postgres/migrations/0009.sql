...
VALUES
    ('12345678-0000-0000-0000-000000000001', 'admin', true, true, true, true, true, true, true),
    ('12345678-0000-0000-0000-000000000002', 'collaborator', true, false, true, false, false, true, false),
    ('12345678-0000-0000-0000-000000000003', 'reader', true, false, true, false, false, true, false);
...
VALUES
    ('12345678-0000-0000-0000-000000000001', 'admin', true, true, true, true, true, true, true, true),
    ('12345678-0000-0000-0000-000000000002', 'collaborator', true, false, true, false, true, true, true, false),
...
INSERT INTO users_usergroups (user_id, group_id)
