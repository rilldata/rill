...
func (CheckProvisionersArgs) Kind() string { return "billing_reporter" }
...
func NewCheckProvisionersWorker(admin *admin.Service, logger *zap.Logger) *CheckProvisionersWorker {
	return &CheckProvisionersWorker{admin: admin, logger: logger}
}
