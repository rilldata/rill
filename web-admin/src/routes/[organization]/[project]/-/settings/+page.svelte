<script lang="ts">
  ...
  import AutoHibernateSettings from "@rilldata/web-admin/features/projects/settings/AutoHibernateSettings.svelte";
...
<AutoHibernateSettings {organization} {project} />
