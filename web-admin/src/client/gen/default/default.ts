...
/**
 * @summary GetEmbeddedAnalytics returns an iframe URL for an embedded analytics canvas.
 */
export const adminServiceGetEmbeddedAnalytics = (
  ...
  return httpClient<V1GetEmbeddedAnalyticsResponse>({
    url: `/v1/orgs/${org}/embedded-analytics/${canvas}`,
    method: "GET",
    signal,
  });
};

export const getAdminServiceGetEmbeddedAnalyticsQueryKey = (
  org?: string,
  canvas?: string,
) => {
  return [`/v1/orgs/${org}/embedded-analytics/${canvas}`] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getAdminServiceGetEmbeddedAnalyticsQueryKey(org, canvas);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof adminServiceGetEmbeddedAnalytics>>
  > = ({ signal }) => adminServiceGetEmbeddedAnalytics(org, canvas, signal);
...
export const getAdminServiceListOrganizationInvitesInfiniteQueryKey = (
  org?: string,
  params?: AdminServiceListOrganizationInvitesParams,
) => {
  return [
...
export const getAdminServiceListOrganizationMemberUsersInfiniteQueryKey = (
  org?: string,
  params?: AdminServiceListOrganizationMemberUsersParams,
) => {
  return [
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getAdminServiceListOrganizationMemberUsersInfiniteQueryKey(org, params);
...
export const getAdminServiceListMagicAuthTokensInfiniteQueryKey = (
  org?: string,
  project?: string,
  params?: AdminServiceListMagicAuthTokensParams,
) => {
...
>(options?: {
  mutation?: CreateMutationOptions<
    ...
    TError,
    { org: string; data: AdminServiceCreateUsergroupBody },
    TContext
  >;
}): CreateMutationOptions<
  Awaited<ReturnType<typeof adminServiceCreateUsergroup>>,
...
/**
 * @summary GetUsergroup returns the user group details
 */
...
/**
 * @summary UpdateUsergroup updates a user group's name and/or description
 */
export const adminServiceUpdateUsergroup = (
  org: string,
  usergroup: string,
  adminServiceUpdateUsergroupBody: AdminServiceUpdateUsergroupBody,
) => {
  return httpClient<V1UpdateUsergroupResponse>({
    url: `/v1/orgs/${org}/usergroups/${usergroup}`,
    method: "PATCH",
    headers: { "Content-Type": "application/json" },
    data: adminServiceUpdateUsergroupBody,
  });
};

export const getAdminServiceUpdateUsergroupMutationOptions = <
  TError = RpcStatus,
  TContext = unknown,
>(options?: {
  mutation?: CreateMutationOptions<
    Awaited<ReturnType<typeof adminServiceUpdateUsergroup>>,
    TError,
    { org: string; usergroup: string; data: AdminServiceUpdateUsergroupBody },
    TContext
  >;
}): CreateMutationOptions<
  Awaited<ReturnType<typeof adminServiceUpdateUsergroup>>,
  ...
  TContext
> => {
  const mutationKey = ["adminServiceUpdateUsergroup"];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return adminServiceUpdateUsergroup(org, usergroup, data);
  };

  return { mutationFn, ...mutationOptions };
};

export type AdminServiceUpdateUsergroupMutationResult = NonNullable<
  Awaited<ReturnType<typeof adminServiceUpdateUsergroup>>
>;
export type AdminServiceUpdateUsergroupMutationBody =
  AdminServiceUpdateUsergroupBody;
export type AdminServiceUpdateUsergroupMutationError = RpcStatus;

/**
 * @summary UpdateUsergroup updates a user group's name and/or description
 */
export const createAdminServiceUpdateUsergroup = <
  TError = RpcStatus,
  TContext = unknown,
>(
  options?: {
...
> => {
  const mutationOptions =
    getAdminServiceUpdateUsergroupMutationOptions(options);
