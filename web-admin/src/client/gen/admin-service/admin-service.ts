...
import type {
  ...
  AdminServiceListProjectMemberUserWithProjectsParams,
  ...
  V1ListProjectMemberUserWithProjectsResponse,
...
/**
 * @summary ListProjectMemberUserWithProjects lists project memberships for a user in the org
 */
export const adminServiceListProjectMemberUserWithProjects = (
  organization: string,
  email: string,
  params?: AdminServiceListProjectMemberUserWithProjectsParams,
  signal?: AbortSignal,
) => {
  return httpClient<V1ListProjectMemberUserWithProjectsResponse>({
    url: `/v1/organizations/${organization}/members/${email}/projects`,
    method: "GET",
    params,
    signal,
  });
...
export const getAdminServiceListProjectMemberUserWithProjectsQueryKey = (
  organization: string,
  email: string,
  params?: AdminServiceListProjectMemberUserWithProjectsParams,
) => {
  return [
    `/v1/organizations/${organization}/members/${email}/projects`,
    ...(params ? [params] : []),
  ] as const;
};

export const getAdminServiceListProjectMemberUserWithProjectsQueryOptions = <
  TData = Awaited<
    ReturnType<typeof adminServiceListProjectMemberUserWithProjects>
  >,
  TError = RpcStatus,
>(
  organization: string,
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getAdminServiceListProjectMemberUserWithProjectsQueryKey(
      organization,
      email,
      params,
    );
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof adminServiceListProjectMemberUserWithProjects>>
  > = ({ signal }) =>
    adminServiceListProjectMemberUserWithProjects(
      organization,
      email,
      params,
      signal,
...
export type AdminServiceListProjectMemberUserWithProjectsQueryResult =
  NonNullable<
    Awaited<ReturnType<typeof adminServiceListProjectMemberUserWithProjects>>
  >;
export type AdminServiceListProjectMemberUserWithProjectsQueryError = RpcStatus;

/**
 * @summary ListProjectMemberUserWithProjects lists project memberships for a user in the org
 */

export function createAdminServiceListProjectMemberUserWithProjects<
  TData = Awaited<
    ReturnType<typeof adminServiceListProjectMemberUserWithProjects>
  >,
  TError = RpcStatus,
>(
  ...
  const queryOptions =
    getAdminServiceListProjectMemberUserWithProjectsQueryOptions(
      organization,
      email,
      params,
      options,
