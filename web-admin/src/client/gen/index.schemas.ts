...
export type V1GetReportMetaResponseRecipientUrls = {[key: string]: GetReportMetaResponseURLs};
...
export interface V1UploadProjectAssetsResponse { [key: string]: unknown }
