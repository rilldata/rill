...
export interface V1ListOrganizationProjectsWithHealthResponse {
  projects?: V1ProjectHealth[];
  nextPageToken?: string;
}

export interface V1ListOrganizationResourcesResponse {
  resources?: V1OrganizationResource[];
}
...
export interface V1OrganizationResource {
  projectName?: string;
  projectId?: string;
  kind?: string;
  name?: string;
...
export type AdminServiceListOrganizationProjectsWithHealthParams = {
  pageSize?: number;
  pageToken?: string;
};

export type AdminServiceListOrganizationResourcesParams = {
  /**
