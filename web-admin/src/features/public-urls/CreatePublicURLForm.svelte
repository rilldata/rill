    ...
    {#if !url}
      ...
      <div class="mt-4" class:mb-4={!hasSomeFilter}>
        ...
        {#if setExpiration}
          <div class="flex items-center gap-x-1 pl-[30px]">
            <label for="expires-at" class="text-muted-foreground font-medium">
      ...
      {#if lockTimeRange}
        <div class="w-full pl-[30px]">
          <label for="lock-time-range" class="text-muted-foreground font-medium">
            {#if interval.isValid}
      ...
      {#if hasSomeFilter}
        ...
        <p class="text-xs text-foreground font-normal mt-4 mb-4">
