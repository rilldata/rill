// Note: This file is somehow breaking Playwright's web server. Playwright unable to build the application.
// Seemingly, the `vitest` import is the problem. To be debugged later.
