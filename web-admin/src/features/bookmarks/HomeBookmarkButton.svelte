    ...
    <DropdownMenuContent class="w-[330px]">
      ...
      {:else}
        <DropdownMenuItem class="py-2">
          ...
          >
            <HomeBookmark size="16px" className="text-surface-foreground" />
      ...
      <DropdownMenuItem on:click={onCreate}>
        <div class="flex flex-row gap-x-2">
          ...
          <div>
            <div class="text-xs font-medium text-surface-foreground h-4">
              Bookmark current view as Home.
            </div>
            <div class="text-[11px] font-normal text-muted-foreground h-4">
