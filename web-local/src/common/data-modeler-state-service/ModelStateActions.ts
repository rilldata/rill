...
import { extractSourceTables } from "$web-local/lib/util/model-structure";
import type { PersistentModelStateActionArg } from "./entity-state-service/PersistentModelEntityService";
import type { ProfileColumn, SourceTable } from "$web-local/lib/types";
...
export class ModelStateActions extends StateActions {
  ...
  @StateActions.DerivedModelAction()
  public updateModelSanitizedQuery(
    { stateService, draftState }: DerivedModelStateActionArg,
    modelId: string,
  ...
  @StateActions.DerivedModelAction()
  public updateModelProfileColumns(
    { stateService, draftState }: DerivedModelStateActionArg,
    modelId: string,
  ...
  @StateActions.DerivedModelAction()
  public updateModelDestinationSize(
    { stateService, draftState }: DerivedModelStateActionArg,
    modelId: string,
    sizeInBytes: number
  ): void {
