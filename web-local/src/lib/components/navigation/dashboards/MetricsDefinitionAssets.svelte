<script lang="ts">
  ...
  import { SourceModelValidationStatus } from "@rilldata/web-common/features/metrics/errors.js";
  import { initBlankDashboardYAML } from "@rilldata/web-common/features/metrics/metrics-internal-store";
  import {
