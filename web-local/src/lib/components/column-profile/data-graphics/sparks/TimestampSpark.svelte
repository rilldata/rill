<script lang="ts">
  ...
  import { createExtremumResolutionStore } from "../../../data-graphic/state/extremum-resolution-store";
  import { areaFactory, lineFactory } from "../../../data-graphic/utils";
  ...
  let data = [];
  $: data = $sparkQuery?.data?.rollup?.spark || [];
  $: console.log($sparkQuery);
