...
import { pgDataset, addFileWithCheck, waitForTable } from "../utils/sourceHelpers";
import { renameFileUsingMenu, checkExistInConnector } from '../utils/commonHelpers';
...
test.describe('PostgreSQL Test with Docker, then read into Rill', () => {
  ...
  test.beforeAll(async () => {
    ...
    execSync(`
      ...
      -e POSTGRES_DB=default -p 5432:5432 -d postgres:14
    `);
  ...
  console.log('Correctly Initialized PostgreSQL Database with sales and customer_data tables.');
