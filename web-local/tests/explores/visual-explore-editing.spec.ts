...
test.describe("visual explore editing", () => {
  ...
  test("visual explore editor runthrough", async ({ page }) => {
    ...
    expect(text).toEqual(
      ' 48123456789101112131415161718192021222324252627282930313233343536373839404142434445464748# Explore YAML# Reference documentation: https://docs.rilldata.com/reference/project-files/explore-dashboardstype: exploretitle: "Adbids dashboard"metrics_view: AdBids_metricsdimensions: []measures: []time_ranges:  - PT6H  - PT24H  - P7D  - P14D  - P4W  - P12M  - rill-TD  - rill-DTD  - rill-WTD  - rill-MTD  - rill-QTD  - rill-YTD  - rill-PDC  - rill-PWC  - rill-PMC  - rill-PQC  - rill-PYC  - inftime_zones:  - UTC  - America/Los_Angeles  - America/Chicago  - America/New_York  - Europe/London  - Europe/Paris  - Asia/Jerusalem  - Europe/Moscow  - Asia/Kolkata  - Asia/Shanghai  - Asia/Tokyo  - Australia/Sydneytheme:  colors:    primary: hsl(180, 100%, 50%)    secondary: lightgreen',
    );
