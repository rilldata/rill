 ...
 */
export type MetricsEventFactoryClasses = PickActionFunctions<CommonFields, (
    ProductHealthEventFactory
)>;
export type MetricsActionDefinition = ExtractActionTypeDefinitions<CommonFields, MetricsEventFactoryClasses>;
