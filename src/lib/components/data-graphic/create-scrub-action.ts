...
export function createScrubAction(
    ...
    return {
        ...
        scrubAction(node) {
            function reset() {
                coordinates.set({ start: DEFAULT_COORDINATES, stop: DEFAULT_COORDINATES })
            ...
            function onScrub(event) {
                ...
                if (moveEventName) {
                    node.dispatchEvent(new CustomEvent(moveEventName, { detail: {
                        ...coords,
                        ...mouseEvents(event)
                    } }));
                }
            ...
            function onScrubEnd(event) {
                ...
                if (coords.start.x && coords.stop.x && completedEventName) {
                    node.dispatchEvent(new CustomEvent(completedEventName, { detail: {
                        ...coords,
                        ...mouseEvents(event)
                    } }));
                }
