...
func (q *MetricsViewRows) Resolve(ctx context.Context, rt *runtime.Runtime, instanceID string, priority int) error {
	...
	e, err := executor.New(ctx, rt, instanceID, q.MetricsViewName, q.MetricsView, q.Streaming, q.ResolvedMVSecurity, priority, nil)
	if err != nil {
		return err
	}
	defer e.Close()
...
func (q *MetricsViewRows) Export(ctx context.Context, rt *runtime.Runtime, instanceID string, w io.Writer, opts *runtime.ExportOptions) error {
	...
	e, err := executor.New(ctx, rt, instanceID, q.MetricsViewName, q.MetricsView, q.Streaming, q.ResolvedMVSecurity, opts.Priority, nil)
	if err != nil {
		return err
	}
	defer e.Close()
