...
func TestTimeseries_SparkOnly(t *testing.T) {
	...
	for i := 0; i < 12; i++ {
		fmt.Println(fmt.Sprintf("%s %.0f %.0f", values[i].Records.Fields["ts"].GetStringValue(), values[i].Records.Fields["bin"].GetNumberValue(), values[i].Records.Fields["count"].GetNumberValue()))
	}
	require.Equal(t, "2019-01-01T00:00:00Z", values[0].Records.Fields["ts"].GetStringValue())
	require.Equal(t, "2019-01-02T00:00:00Z", values[1].Records.Fields["ts"].GetStringValue())
	require.Equal(t, "2019-01-03T00:00:00Z", values[2].Records.Fields["ts"].GetStringValue())
	require.Equal(t, "2019-01-04T00:00:00Z", values[3].Records.Fields["ts"].GetStringValue())
	require.Equal(t, "2019-01-05T00:00:00Z", values[4].Records.Fields["ts"].GetStringValue())
	require.Equal(t, "2019-01-06T00:00:00Z", values[5].Records.Fields["ts"].GetStringValue())
	require.Equal(t, "2019-01-07T00:00:00Z", values[6].Records.Fields["ts"].GetStringValue())
	require.Equal(t, "2019-01-08T00:00:00Z", values[7].Records.Fields["ts"].GetStringValue())
	require.Equal(t, "2019-01-09T00:00:00Z", values[8].Records.Fields["ts"].GetStringValue())
	require.Equal(t, "2019-01-09T00:00:00Z", values[9].Records.Fields["ts"].GetStringValue())
	require.Equal(t, "2019-01-09T00:00:00Z", values[10].Records.Fields["ts"].GetStringValue())
	require.Equal(t, "2019-01-09T00:00:00Z", values[11].Records.Fields["ts"].GetStringValue())

	require.Equal(t, 0.0, values[0].Records.Fields["bin"].GetNumberValue())
	require.Equal(t, 0.0, values[1].Records.Fields["bin"].GetNumberValue())
	require.Equal(t, 0.0, values[2].Records.Fields["bin"].GetNumberValue())
	require.Equal(t, 0.0, values[3].Records.Fields["bin"].GetNumberValue())
	require.Equal(t, 1.0, values[4].Records.Fields["bin"].GetNumberValue())
	require.Equal(t, 1.0, values[5].Records.Fields["bin"].GetNumberValue())
	require.Equal(t, 1.0, values[6].Records.Fields["bin"].GetNumberValue())
	require.Equal(t, 1.0, values[7].Records.Fields["bin"].GetNumberValue())
	require.Equal(t, 2.0, values[8].Records.Fields["bin"].GetNumberValue())
	require.Equal(t, 2.0, values[9].Records.Fields["bin"].GetNumberValue())
	require.Equal(t, 2.0, values[10].Records.Fields["bin"].GetNumberValue())
	require.Equal(t, 2.0, values[11].Records.Fields["bin"].GetNumberValue())
