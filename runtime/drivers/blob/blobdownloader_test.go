...
func TestFetchFileNames(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:    args{context.Background(), prepareBucket(t), Options{GlobPattern: "2020/01/01/aata.txt", KeepFilesUntilClose: true}},
			want:    map[string]struct{}{"hello": {}},
			wantErr: false,
		},
		{
			name:    "recursive glob",
			args:    args{context.Background(), prepareBucket(t), Options{GlobPattern: "2020/**/*.txt", KeepFilesUntilClose: true}},
			want:    map[string]struct{}{"hello": {}, "world": {}, "writing": {}, "test": {}},
			wantErr: false,
		},
		{
			name:    "non recursive glob",
			args:    args{context.Background(), prepareBucket(t), Options{GlobPattern: "2020/0?/0[1-3]/{a,b}ata.txt", KeepFilesUntilClose: true}},
			want:    map[string]struct{}{"hello": {}, "world": {}},
			wantErr: false,
		},
		{
			name:    "glob absent",
			args:    args{context.Background(), prepareBucket(t), Options{GlobPattern: "2020/**/*.csv", KeepFilesUntilClose: true}},
			want:    nil,
			wantErr: true,
		},
		{
			name:    "total size limit",
			args:    args{context.Background(), prepareBucket(t), Options{GlobMaxTotalSize: 1, GlobPattern: "2020/**", KeepFilesUntilClose: true}},
			want:    nil,
			wantErr: true,
		},
		{
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{context.Background(),
				prepareBucket(t),
				Options{ExtractPolicy: &ExtractPolicy{FilesStrategy: ExtractPolicyStrategyHead, FilesLimit: 2}, GlobPattern: "2020/**", KeepFilesUntilClose: true},
			},
			want:    map[string]struct{}{"hello": {}, "world": {}},
			wantErr: false,
		},
		{
			...
			args: args{
				context.Background(),
				prepareBucket(t),
				Options{ExtractPolicy: &ExtractPolicy{FilesStrategy: ExtractPolicyStrategyTail, FilesLimit: 2}, GlobPattern: "2020/**", KeepFilesUntilClose: true},
			},
