...
var spec = drivers.Spec{
	...
	SourceProperties: []drivers.PropertySchema{
		...
		},
		{
			...
			Hint:        "Either set this or pass --variable connector.salesforce.username=... to rill start",
		},
		{
			Key:         "password",
			...
			Type:        drivers.StringPropertyType,
			Required:    false,
			Hint:        "Either set this or pass --variable connector.salesforce.password=... to rill start",
		},
		{
			Key:         "key",
			...
			Type:        drivers.StringPropertyType,
			Required:    false,
			Hint:        "Either set this or pass --variable connector.salesforce.key=... to rill start",
		},
		{
			Key:         "endpoint",
			...
			Hint:        "Either set this or pass --variable connector.salesforce.endpoint=... to rill start",
		},
		{
			Key:         "client_id",
			...
			Hint:        "Either set this or pass --variable connector.salesforce.client_id=... to rill start",
		},
	},
