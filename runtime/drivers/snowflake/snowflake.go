	...
	ConfigProperties: []*drivers.PropertySpec{
		{
			...
			Hint:        "Can be configured here or by setting the 'connector.snowflake.dsn' environment variable (using '.env' or '--env'). Leave empty if using individual fields below.",
			Secret:      true,
		},
		{
			Key:         "account",
