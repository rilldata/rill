	...
	ConfigProperties: []*drivers.PropertySpec{
		...
		},
		{
			...
			Options: []drivers.PropertyOption{
				...
				{Value: "require", Label: "Require", Description: "Always SSL (skip certificate verification)"},
				{Value: "verify-ca", Label: "Verify CA", Description: "Always SSL and verify that the server certificate is signed by a trusted CA"},
				{Value: "verify-full", Label: "Verify Full", Description: "Always SSL and verify that the server certificate is signed by a trusted CA and that the server hostname matches the certificate"},
			},
		},
	},
