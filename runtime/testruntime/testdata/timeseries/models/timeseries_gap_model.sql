...
UNION ALL
SELECT 1.0 AS clicks, 5 as imps, TIMESTAMP '2019-01-06 00:00:00' AS time, DATE '2019-01-06' as day, 'iphone' AS device, null AS publisher, 'msn.com' AS domain, NULL as latitude, NULL as country
