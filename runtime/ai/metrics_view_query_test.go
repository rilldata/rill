...
`,
	...
	t.Run("expression time range and comparison", func(t *testing.T) {
		...
		require.Equal(t, "1D as of watermark/D", res.ResolvedTimeRange.Expression)
		...
		require.Equal(t, "1D as of watermark/D offset -1D", res.ResolvedComparisonTimeRange.Expression)
