...
• Prefer using absolute 'start' and 'end' times in 'time_range' and 'comparison_time_range' if available. Otherwise, for standard ISO8601 durations like 'P7D', 'P1M' etc. prefer using 'iso_duration' and 'iso_offset' over 'expression'.
