...
type DeveloperAgentArgs struct {
	...
	EnableCheckpointCommits bool   `json:"enable_checkpoint_commits,omitempty" jsonschema:"If true, the agent will commit checkpoints to the project's git repository."`
}
