...
func init() {
	runtime.RegisterResolverInitializer("metrics_targets", newTargetsResolver)
}

type metricsTargetsResolver struct {
	instanceID string
	query      *metricsview.TargetsQuery
...
func newTargetsResolver(ctx context.Context, opts *runtime.ResolverOptions) (runtime.Resolver, error) {
...
func (r *metricsTargetsResolver) Close() error {
	r.executor.Close()
	return nil
}

func (r *metricsTargetsResolver) CacheKey(ctx context.Context) ([]byte, bool, error) {
...
func (r *metricsTargetsResolver) Refs() []*runtimev1.ResourceName {
	return []*runtimev1.ResourceName{
		{Kind: runtime.ResourceKindMetricsView, Name: r.query.MetricsView},
	}
}

func (r *metricsTargetsResolver) Validate(ctx context.Context) error {
	return nil
}

func (r *metricsTargetsResolver) ResolveInteractive(ctx context.Context) (runtime.ResolverResult, error) {
	...
	if r.query.TimeRange == nil || r.query.TimeRange.Start.IsZero() || r.query.TimeRange.End.IsZero() {
		...
		err = r.executor.BindTargetsQuery(ctx, r.query, tsRes)
		if err != nil {
			return nil, err
		}
	}

	res, err := r.executor.Targets(ctx, r.query)
	if err != nil {
		return nil, err
	}
...
func (r *metricsTargetsResolver) ResolveExport(ctx context.Context, w io.Writer, opts *runtime.ResolverExportOptions) error {
	return errors.New("not implemented")
}

func (r *metricsTargetsResolver) InferRequiredSecurityRules() ([]*runtimev1.SecurityRule, error) {
