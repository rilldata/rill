...
func (m *metricsViewMigrator) Update(ctx context.Context, olap drivers.OLAPStore, repo drivers.RepoStore, oldCatalogObj *drivers.CatalogEntry, newCatalogObj *drivers.CatalogEntry) error {
	return nil
}
