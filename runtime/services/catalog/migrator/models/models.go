...
func (m *modelMigrator) Create(ctx context.Context, olap drivers.OLAPStore, repo drivers.RepoStore, opts migrator.Options, catalogObj *drivers.CatalogEntry, instanceID string, logger *zap.Logger) error {
...
func (m *modelMigrator) Update(ctx context.Context, olap drivers.OLAPStore, repo drivers.RepoStore, opts migrator.Options, oldCatalogObj, newCatalogObj *drivers.CatalogEntry, instanceID string, logger *zap.Logger) error {
	...
	return m.Create(ctx, olap, repo, opts, newCatalogObj, instanceID, logger)
}
