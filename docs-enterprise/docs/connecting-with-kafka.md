...
hidden: false
createdAt: "2020-05-27T20:22:27.954Z"
updatedAt: "2021-10-06T16:22:28.020Z"
---
#Setup Instructions
  ...
  "images": [
    {
      "image": [
        ...
        "ConfluentCloud_CreateServiceAccount.png",
        1100,
        796,
        "#edf3f4"
      ],
  ...
  "images": [
    {
      "image": [
        ...
        "ConfluentCloud_GetYourAPIKey.png",
        1164,
        1134,
        "#eae8e9"
      ],
  ...
  "images": [
    {
      "image": [
        ...
        "Cluster_API_access_CreateKey.png",
        1724,
        1084,
        "#f6f8f9"
      ],
  ...
  "images": [
    {
      "image": [
        ...
        "Cluster_API_access_CreateKey_existingAccount.png",
        1932,
        942,
        "#f6f9fa"
      ],
  ...
  "images": [
    {
      "image": [
        ...
        "Cluser_API_access_CreateKey_AddACLs.png",
        1940,
        1366,
        "#f7f9fa"
      ],
...
Follow the [Ingestion Tutorials](https://docs.rilldata.com/docs/tutorial-kafka-ingestion) for all of the nuances for getting the data into Rill Data as needed.  The key aspects for Confluent Cloud Ingestion are through establishing the bootstrap-server, customer properties for access, and the topic to consumer from.
...
{
  "type": "info",
  "title": "AWS Private Link with Private DNS",
  "body": "Kafka **EXTERNAL** advertised listeners should match the DNS name configured."
}
[/block]
...
Ref: https://docs.rilldata.com/docs/aws-private-link
...
{
  "type": "danger",
  "body": "It is critical that access via this port is restricted to trusted clients only. Network segmentation and/or authorization ACLs can be used to restrict access to trusted IPs in such cases.",
...
[block:code]
{
  "codes": [
    {
      "code": "export KAFKA_OPTS=\"-Djava.security.auth.login.config=/etc/kafka/kafka_server_jaas.conf\"\nbin/kafka-server-start etc/kafka/server.properties\n",
      "language": "ruby",
      "name": "jvm.properties"
    }
  ]
...
[block:code]
{
  "codes": [
    {
      "code": "listener.name.sasl_ssl.scram-sha-256.sasl.jaas.config=org.apache.kafka.common.security.scram.ScramLoginModule required \\\n  username=\"admin\" \\\n  password=\"admin-secret\";\nlistener.name.sasl_ssl.plain.sasl.jaas.config=org.apache.kafka.common.security.plain.PlainLoginModule required \\\n  username=\"admin\" \\\n  password=\"admin-secret\" \\\n  user_admin=\"admin-secret\" \\\n  user_alice=\"alice-secret\";\n",
      "language": "ruby",
      "name": "server.properties"
    }
  ]
