...
func EditCmd(ch *cmdutil.Helper) *cobra.Command {
	...
	editCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			} else if ch.Interactive && !cmd.Flags().Changed("display-name") {
			...
			} else if ch.Interactive && !cmd.Flags().Changed("description") {
			...
			} else if ch.Interactive && !cmd.Flags().Changed("billing-email") {
