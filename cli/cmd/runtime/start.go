...
type Config struct {
	...
	MemoryGBPerSlot        int64  `default:"2" split_words:"true"`
	CPUPerSlot             int    `default:"1" split_words:"true"`
	StorageGBPerSlot       int64  `default:"40" split_words:"true"`
}
	...
	startCmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			opts := &runtime.Options{
				...
				MemoryGBPerSlot:         conf.MemoryGBPerSlot,
				CPUPerSlot:              conf.CPUPerSlot,
				StorageGBPerSlot:        conf.StorageGBPerSlot,
