...
docs.generate:
	...
	rm -rf docs/docs/reference/cli docs/docs/reference/new-project-files
	...
	go run -ldflags="-X main.Version=$(shell git describe --tags `git rev-list --tags --max-count=1`)" ./cli docs generate-project docs/docs/reference/new-project-files
