...
[binary]() : download the most recent [assets binary](https://github.com/rilldata/rill-developer/releases).
[npm]() : run  `npm install -g @rilldata/rill`
[docker]() : download our [docker container](https://hub.docker.com/r/rilldata/rill-developer)
