...
export class DashboardStateDataLoader {
  ...
  private readonly blankPartialExploreState: CompoundQueryResult<
  ...
  public constructor(
    ...
    this.blankPartialExploreState = getCompoundQuery(
