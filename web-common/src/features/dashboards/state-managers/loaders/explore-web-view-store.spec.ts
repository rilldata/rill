...
const TestCases: {
...

  {
    ...
    view: {
      ...
      expectedSearch:
        "view=pivot&tr=P7D&tz=UTC&compare_tr=rill-PP&f=publisher+IN+%28%27Google%27%29&rows=publisher%2Ctime.hour&cols=domain%2Ctime.day%2Cimpressions&sort_by=time.day&sort_dir=ASC&table_mode=nest",
    },
  },
  {
