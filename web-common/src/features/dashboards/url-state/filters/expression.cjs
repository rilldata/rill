...
let ParserRules = [
    ...
    {"name": "boolean_expr", "symbols": ["simple_expr", "_", "binary_operator", "_", "value"], "postprocess": binaryPostprocessor},
    ...
    {"name": "in_operator", "symbols": ["in_operator$subexpression$3"], "postprocess": id},
    {"name": "in_operator$subexpression$4", "symbols": [/[iI]/, /[nN]/, {"literal":" "}, /[lL]/, /[iI]/, /[sS]/, /[tT]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "in_operator", "symbols": ["in_operator$subexpression$4"], "postprocess": id},
    {"name": "in_operator$subexpression$5", "symbols": [/[nN]/, /[oO]/, /[tT]/, {"literal":" "}, /[iI]/, /[nN]/, {"literal":" "}, /[lL]/, /[iI]/, /[sS]/, /[tT]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "in_operator", "symbols": ["in_operator$subexpression$5"], "postprocess": id},
    {"name": "binary_operator$subexpression$1", "symbols": [/[eE]/, /[qQ]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "binary_operator", "symbols": ["binary_operator$subexpression$1"], "postprocess": id},
    {"name": "binary_operator$subexpression$2", "symbols": [/[nN]/, /[eE]/, /[qQ]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "binary_operator", "symbols": ["binary_operator$subexpression$2"], "postprocess": id},
    {"name": "binary_operator$subexpression$3", "symbols": [/[gG]/, /[tT]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "binary_operator", "symbols": ["binary_operator$subexpression$3"], "postprocess": id},
    {"name": "binary_operator$subexpression$4", "symbols": [/[gG]/, /[tT]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "binary_operator", "symbols": ["binary_operator$subexpression$4"], "postprocess": id},
    {"name": "binary_operator$subexpression$5", "symbols": [/[lL]/, /[tT]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "binary_operator", "symbols": ["binary_operator$subexpression$5"], "postprocess": id},
    {"name": "binary_operator$subexpression$6", "symbols": [/[lL]/, /[tT]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "binary_operator", "symbols": ["binary_operator$subexpression$6"], "postprocess": id},
    {"name": "binary_operator$subexpression$7", "symbols": [/[lL]/, /[iI]/, /[kK]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "binary_operator", "symbols": ["binary_operator$subexpression$7"], "postprocess": id},
    {"name": "binary_operator$subexpression$8", "symbols": [/[nN]/, /[lL]/, /[iI]/, /[kK]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "binary_operator", "symbols": ["binary_operator$subexpression$8"], "postprocess": id},
    {"name": "binary_operator$subexpression$9", "symbols": [/[nN]/, /[oO]/, /[tT]/, {"literal":" "}, /[lL]/, /[iI]/, /[kK]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "binary_operator", "symbols": ["binary_operator$subexpression$9"], "postprocess": id},
