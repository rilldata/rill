...
let ParserRules = [
    ...
    {"name": "in_operator$subexpression$4", "symbols": [/[mM]/, /[aA]/, /[tT]/, /[cC]/, /[hH]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "in_operator", "symbols": ["in_operator$subexpression$4"], "postprocess": id},
    {"name": "in_operator$subexpression$5", "symbols": [/[nN]/, /[oO]/, /[tT]/, {"literal":" "}, /[mM]/, /[aA]/, /[tT]/, /[cC]/, /[hH]/], "postprocess": function(d) {return d.join(""); }},
