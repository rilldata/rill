...
var grammar = {
    ...
    {"name": "compare_operator", "symbols": [{"literal":"="}], "postprocess": id},
    {"name": "compare_operator$string$1", "symbols": [{"literal":"!"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "compare_operator", "symbols": ["compare_operator$string$1"], "postprocess": id},
    {"name": "compare_operator", "symbols": [{"literal":">"}], "postprocess": id},
    {"name": "compare_operator$string$2", "symbols": [{"literal":">"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "compare_operator", "symbols": ["compare_operator$string$2"], "postprocess": id},
    {"name": "compare_operator", "symbols": [{"literal":"<"}], "postprocess": id},
    {"name": "compare_operator$string$3", "symbols": [{"literal":"<"}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "compare_operator", "symbols": ["compare_operator$string$3"], "postprocess": id},
