...
let ParserRules = [
    ...
    {"name": "labeled_anchor", "symbols": ["labeled_anchor$string$1"], "postprocess": id},
    ...
    {"name": "labeled_anchor", "symbols": ["labeled_anchor$string$2"], "postprocess": id},
    {"name": "labeled_anchor$string$3", "symbols": [{"literal":"n"}, {"literal":"o"}, {"literal":"w"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "labeled_anchor", "symbols": ["labeled_anchor$string$3"], "postprocess": id},
    ...
    {"name": "labeled_anchor", "symbols": ["labeled_anchor$string$4"], "postprocess": id},
    {"name": "period_to_grain", "symbols": [/[sSmhHdDwWqQMyY]/, /[T]/, /[sSmhHdDwWqQMyY]/], "postprocess": (args) => args.join("")},
    {"name": "abs_time", "symbols": [/[\d]/, /[\d]/, /[\d]/, /[\d]/, /[\-]/, /[\d]/, /[\d]/, /[\-]/, /[\d]/, /[\d]/, {"literal":"T"}, /[\d]/, /[\d]/, /[:]/, /[\d]/, /[\d]/, /[:]/, /[\d]/, /[\d]/, {"literal":"Z"}], "postprocess": (args) => args.join("")},
    {"name": "abs_time", "symbols": [/[\d]/, /[\d]/, /[\d]/, /[\d]/, /[\-]/, /[\d]/, /[\d]/, /[\-]/, /[\d]/, /[\d]/, {"literal":"T"}, /[\d]/, /[\d]/, /[:]/, /[\d]/, /[\d]/], "postprocess": (args) => args.join("")},
    {"name": "abs_time", "symbols": [/[\d]/, /[\d]/, /[\d]/, /[\d]/, /[\-]/, /[\d]/, /[\d]/, /[\-]/, /[\d]/, /[\d]/, {"literal":"T"}, /[\d]/, /[\d]/], "postprocess": (args) => args.join("")},
    {"name": "abs_time", "symbols": [/[\d]/, /[\d]/, /[\d]/, /[\d]/, /[\-]/, /[\d]/, /[\d]/, /[\-]/, /[\d]/, /[\d]/], "postprocess": (args) => args.join("")},
    {"name": "abs_time", "symbols": [/[\d]/, /[\d]/, /[\d]/, /[\d]/, /[\-]/, /[\d]/, /[\d]/], "postprocess": (args) => args.join("")},
    {"name": "abs_time", "symbols": [/[\d]/, /[\d]/, /[\d]/, /[\d]/], "postprocess": (args) => args.join("")},
