...
let ParserRules = [
    ...
    {"name": "ordinal_interval", "symbols": ["ordinal_duration", "_", "ordinal_interval$subexpression$1", "_", "ordinal_interval_end"], "postprocess": ([parts, , , , end]) => new RillTimeOrdinalInterval(parts, end)},
    {"name": "ordinal_interval", "symbols": ["ordinal_duration"], "postprocess": ([parts, , , , end]) => new RillTimeOrdinalInterval(parts, undefined)},
    {"name": "ordinal_interval_end", "symbols": ["grain_to_interval"], "postprocess": ([grainToInterval]) => new RillOrdinalPartEnd().withGrainToInterval(grainToInterval)},
    {"name": "ordinal_interval_end", "symbols": ["start_end_interval"], "postprocess": ([startEndInterval]) => new RillOrdinalPartEnd().withStartEndInterval(startEndInterval)},
    {"name": "ordinal_interval_end", "symbols": ["grain"], "postprocess": ([grain]) => new RillOrdinalPartEnd().withSingleGrain(grain)},
    ...
    {"name": "ordinal_point_in_time$subexpression$1", "symbols": [/[oO]/, /[fF]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "ordinal_point_in_time$subexpression$2", "symbols": [/[oO]/, /[fF]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "ordinal_point_in_time", "symbols": ["ordinal_point_in_time_start", "_", "ordinal_point_in_time$subexpression$1", "_", "ordinal_duration", "_", "ordinal_point_in_time$subexpression$2", "_", "ordinal_point_in_time_end"], "postprocess": ([start, , , , parts, , , ,end]) => start.withRestOfParts(parts).withEnd(end)},
    {"name": "ordinal_point_in_time$subexpression$3", "symbols": [/[oO]/, /[fF]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "ordinal_point_in_time", "symbols": ["ordinal_point_in_time_start", "_", "ordinal_point_in_time$subexpression$3", "_", "ordinal_duration"], "postprocess": ([start, , , , parts]) => start.withRestOfParts(parts)},
    {"name": "ordinal_point_in_time$subexpression$4", "symbols": [/[oO]/, /[fF]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "ordinal_point_in_time", "symbols": ["ordinal_point_in_time_start", "_", "ordinal_point_in_time$subexpression$4", "_", "ordinal_point_in_time_end"], "postprocess": ([start, , , , end]) => start.withEnd(end)},
    {"name": "ordinal_point_in_time", "symbols": ["ordinal_point_in_time_start"], "postprocess": id},
    {"name": "ordinal_point_in_time_start", "symbols": ["ordinal_part", "_", "suffix"], "postprocess": ([ordinal, suffix]) => new RillOrdinalPointInTime(ordinal, suffix)},
    {"name": "ordinal_point_in_time_end", "symbols": ["grain_to_interval"], "postprocess": ([grainToInterval]) => new RillOrdinalPartEnd().withGrainToInterval(grainToInterval)},
    {"name": "ordinal_point_in_time_end", "symbols": ["grain"], "postprocess": ([grain]) => new RillOrdinalPartEnd().withSingleGrain(grain)},
    ...
    {"name": "ordinal_duration$ebnf$1$subexpression$1", "symbols": ["_", "ordinal_duration$ebnf$1$subexpression$1$subexpression$1", "_", "ordinal_part"]},
    ...
    {"name": "ordinal_duration", "symbols": ["ordinal_part", "ordinal_duration$ebnf$1"], "postprocess": ([part, rest]) => ([part, ...rest.map(([, , , p]) => p)])},
    {"name": "ordinal_part", "symbols": ["ordinal"], "postprocess": ([{num, grain}]) => new RillOrdinalPart(grain, num, undefined)},
    {"name": "ordinal_part", "symbols": ["snap_prefix", "_", "grain_duration_part"], "postprocess": ([snap, , {num, grain}]) => new RillOrdinalPart(grain, num, snap)},
