...
let ParserRules = [
    ...
    {"name": "shorthand_interval$ebnf$1", "symbols": ["grain_point_in_time_part"]},
    {"name": "shorthand_interval$ebnf$1", "symbols": ["shorthand_interval$ebnf$1", "grain_point_in_time_part"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "shorthand_interval", "symbols": ["shorthand_interval$ebnf$1"], "postprocess": ([parts]) => new RillShorthandInterval(parts)},
    ...
    {"name": "point_in_time$ebnf$1", "symbols": ["point_in_time_with_snap"]},
    ...
    {"name": "point_in_time", "symbols": ["point_in_time$ebnf$1"], "postprocess": ([points]) => new RillPointInTime(points)},
    ...
    {"name": "point_in_time_with_snap", "symbols": ["point_in_time_variants"], "postprocess": ([point]) => new RillPointInTimeWithSnap(point, [])},
    ...
    {"name": "labeled_point_in_time", "symbols": ["labeled_point_in_time$string$1"], "postprocess": RillLabelledPointInTime.postProcessor},
    ...
    {"name": "labeled_point_in_time", "symbols": ["labeled_point_in_time$string$2"], "postprocess": RillLabelledPointInTime.postProcessor},
    {"name": "labeled_point_in_time$string$3", "symbols": [{"literal":"n"}, {"literal":"o"}, {"literal":"w"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "labeled_point_in_time", "symbols": ["labeled_point_in_time$string$3"], "postprocess": RillLabelledPointInTime.postProcessor},
    ...
    {"name": "labeled_point_in_time", "symbols": ["labeled_point_in_time$string$4"], "postprocess": RillLabelledPointInTime.postProcessor},
    {"name": "labeled_point_in_time$string$5", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"f"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "labeled_point_in_time", "symbols": ["labeled_point_in_time$string$5"], "postprocess": RillLabelledPointInTime.postProcessor},
