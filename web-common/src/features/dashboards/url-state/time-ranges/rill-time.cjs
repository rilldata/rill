...
let ParserRules = [
    ...
    {"name": "time_anchor_part$subexpression$1", "symbols": [/[tT]/, /[oO]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "time_anchor_part", "symbols": ["time_anchor", "_", "time_anchor_part$subexpression$1", "_", "time_anchor"], "postprocess": ([start, , , , end]) => ({ start, end })},
    ...
    {"name": "grain_and_at_part$subexpression$1", "symbols": [/[bB]/, /[yY]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "grain_and_at_part", "symbols": ["grain_and_at_part$subexpression$1", "_", "range_grain_modifier", "_", {"literal":"@"}, "_", "at_modifiers"], "postprocess": ([, , grain, , , , modifier]) => ({ grain, modifier })},
    {"name": "grain_and_at_part$subexpression$2", "symbols": [/[bB]/, /[yY]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "grain_and_at_part", "symbols": ["grain_and_at_part$subexpression$2", "_", "range_grain_modifier"], "postprocess": ([, , grain]) => ({ grain })},
