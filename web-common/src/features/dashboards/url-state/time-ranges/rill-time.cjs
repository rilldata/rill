...
let ParserRules = [
    ...
    {"name": "time_anchor", "symbols": ["time_anchor_offset", "_", "time_anchor_offset", "_", {"literal":"/"}, "_", "grain"], "postprocess": ([mod, , offset, , , , truncate]) => mod.withOffset(offset).withTruncate(truncate)},
