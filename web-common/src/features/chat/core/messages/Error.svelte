...
>
  <div class="flex items-start gap-2">
    ...
    <div class="font-medium text-fg-primary">{headline}</div>
  </div>
  {#if error}
    <details class="group mt-2">
      <summary
        class="flex cursor-pointer items-center gap-1.5 text-xs text-fg-secondary hover:text-fg-primary hover:underline"
      >
