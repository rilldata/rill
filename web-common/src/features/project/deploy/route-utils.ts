 ...
 * 1. If the project is not a github repo it returns the create project route (/developer/deploy/project/create) directly.
 ...
 *    it returns the create project route with github option (/developer/deploy/project/create?use_git=true).
