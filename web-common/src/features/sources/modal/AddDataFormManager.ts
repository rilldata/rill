...
export class AddDataFormManager {
  ...
  /**
   * Compute YAML preview for the current form state via the GenerateFile RPC.
   * The runtime handles secret extraction, env-var name resolution, and YAML
   * formatting from the active template's declarative definition.
   */
