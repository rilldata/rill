        ...
        <svelte:fragment slot="error">
          {#if allErrors.length > 0}
            <div
              ...
              class="error bottom-4 break-words overflow-auto p-6 border-2 border-gray-300 font-bold text-gray-800 w-full shrink-0 max-h-[60%] bg-gray-100 flex flex-col gap-2"
            >
