...
>
  <div class="w-full h-4 z-40 group flex items-center justify-center relative">
    ...
    <span
      ...
      class="sr-only peer-hover:not-sr-only peer-active:sr-only hover:not-sr-only flex shadow-sm pointer-events-auto !absolute left-1/2 w-fit z-50 bg-surface -translate-x-1/2 border rounded-sm"
    >
