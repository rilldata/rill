...
<article
  ...
  class="group component-card size-full flex flex-col cursor-pointer z-10 p-0 relative outline-[1px] outline-gray-200 bg-surface overflow-hidden rounded-sm"
>
  {#if editable}
