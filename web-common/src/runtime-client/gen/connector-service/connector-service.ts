...
import type {
  ...
  ConnectorServiceListDatabasesParams,
...
/**
 * @summary ListDatabases list all databases
 */
export const connectorServiceListDatabases = (
  params?: ConnectorServiceListDatabasesParams,
  signal?: AbortSignal,
) => {
  return httpClient<V1ListDatabasesResponse>({
    url: `/v1/connectors/databases`,
    method: "GET",
    params,
    signal,
  });
...
export const getConnectorServiceListDatabasesQueryKey = (
  params?: ConnectorServiceListDatabasesParams,
) => {
  return [`/v1/connectors/databases`, ...(params ? [params] : [])] as const;
};

export const getConnectorServiceListDatabasesQueryOptions = <
  TData = Awaited<ReturnType<typeof connectorServiceListDatabases>>,
  TError = ErrorType<RpcStatus>,
>(
  params?: ConnectorServiceListDatabasesParams,
  options?: {
    query?: Partial<
      CreateQueryOptions<
        Awaited<ReturnType<typeof connectorServiceListDatabases>>,
        TError,
        TData
      >
    >;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getConnectorServiceListDatabasesQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof connectorServiceListDatabases>>
  > = ({ signal }) => connectorServiceListDatabases(params, signal);
...
export type ConnectorServiceListDatabasesQueryResult = NonNullable<
  Awaited<ReturnType<typeof connectorServiceListDatabases>>
>;
export type ConnectorServiceListDatabasesQueryError = ErrorType<RpcStatus>;

/**
 * @summary ListDatabases list all databases
 */

export function createConnectorServiceListDatabases<
  TData = Awaited<ReturnType<typeof connectorServiceListDatabases>>,
  TError = ErrorType<RpcStatus>,
>(
  params?: ConnectorServiceListDatabasesParams,
  ...
  const queryOptions = getConnectorServiceListDatabasesQueryOptions(
    params,
    options,
  );
...
/**
 * @summary ListSchemas list all schemas in a database
 */
