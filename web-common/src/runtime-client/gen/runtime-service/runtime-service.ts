...
import type {
  RpcStatus,
  RuntimeServiceBeginFileTransactionBody,
  RuntimeServiceCommitFileTransactionBody,
  ...
  RuntimeServiceRollbackFileTransactionBody,
  ...
  V1BeginFileTransactionResponse,
  V1CommitFileTransactionResponse,
  ...
  V1RollbackFileTransactionResponse,
...
/**
 * @summary BeginFileTransaction stages multiple files in a temporary area as part of a new transaction and returns a transaction ID.
 */
export const runtimeServiceBeginFileTransaction = (
  instanceId: string,
  runtimeServiceBeginFileTransactionBody: RuntimeServiceBeginFileTransactionBody,
  signal?: AbortSignal,
) => {
  return httpClient<V1BeginFileTransactionResponse>({
    url: `/v1/instances/${instanceId}/files/transaction/begin`,
    method: "POST",
    headers: { "Content-Type": "application/json" },
    data: runtimeServiceBeginFileTransactionBody,
    signal,
  });
};

export const getRuntimeServiceBeginFileTransactionMutationOptions = <
  TError = ErrorType<RpcStatus>,
  TContext = unknown,
>(options?: {
  mutation?: CreateMutationOptions<
    Awaited<ReturnType<typeof runtimeServiceBeginFileTransaction>>,
    TError,
    { instanceId: string; data: RuntimeServiceBeginFileTransactionBody },
    TContext
  >;
}): CreateMutationOptions<
  Awaited<ReturnType<typeof runtimeServiceBeginFileTransaction>>,
  ...
  TContext
> => {
  const mutationKey = ["runtimeServiceBeginFileTransaction"];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return runtimeServiceBeginFileTransaction(instanceId, data);
  };

  return { mutationFn, ...mutationOptions };
};

export type RuntimeServiceBeginFileTransactionMutationResult = NonNullable<
  Awaited<ReturnType<typeof runtimeServiceBeginFileTransaction>>
>;
export type RuntimeServiceBeginFileTransactionMutationBody =
  RuntimeServiceBeginFileTransactionBody;
export type RuntimeServiceBeginFileTransactionMutationError =
  ErrorType<RpcStatus>;

/**
 * @summary BeginFileTransaction stages multiple files in a temporary area as part of a new transaction and returns a transaction ID.
 */
export const createRuntimeServiceBeginFileTransaction = <
  TError = ErrorType<RpcStatus>,
  TContext = unknown,
>(
  options?: {
...
> => {
  const mutationOptions =
    getRuntimeServiceBeginFileTransactionMutationOptions(options);

  return createMutation(mutationOptions, queryClient);
};
/**
 * @summary CommitFileTransaction commits all staged files for the given transaction ID to their final locations atomically.
 */
export const runtimeServiceCommitFileTransaction = (
  instanceId: string,
  runtimeServiceCommitFileTransactionBody: RuntimeServiceCommitFileTransactionBody,
  signal?: AbortSignal,
) => {
  return httpClient<V1CommitFileTransactionResponse>({
    url: `/v1/instances/${instanceId}/files/transaction/commit`,
    method: "POST",
    headers: { "Content-Type": "application/json" },
    data: runtimeServiceCommitFileTransactionBody,
    signal,
  });
};

export const getRuntimeServiceCommitFileTransactionMutationOptions = <
  TError = ErrorType<RpcStatus>,
  TContext = unknown,
>(options?: {
  mutation?: CreateMutationOptions<
    Awaited<ReturnType<typeof runtimeServiceCommitFileTransaction>>,
    TError,
    { instanceId: string; data: RuntimeServiceCommitFileTransactionBody },
    TContext
  >;
}): CreateMutationOptions<
  Awaited<ReturnType<typeof runtimeServiceCommitFileTransaction>>,
  ...
  TContext
> => {
  const mutationKey = ["runtimeServiceCommitFileTransaction"];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return runtimeServiceCommitFileTransaction(instanceId, data);
  };

  return { mutationFn, ...mutationOptions };
};

export type RuntimeServiceCommitFileTransactionMutationResult = NonNullable<
  Awaited<ReturnType<typeof runtimeServiceCommitFileTransaction>>
>;
export type RuntimeServiceCommitFileTransactionMutationBody =
  RuntimeServiceCommitFileTransactionBody;
export type RuntimeServiceCommitFileTransactionMutationError =
  ErrorType<RpcStatus>;

/**
 * @summary CommitFileTransaction commits all staged files for the given transaction ID to their final locations atomically.
 */
export const createRuntimeServiceCommitFileTransaction = <
  TError = ErrorType<RpcStatus>,
  TContext = unknown,
>(
  options?: {
...
> => {
  const mutationOptions =
    getRuntimeServiceCommitFileTransactionMutationOptions(options);

  return createMutation(mutationOptions, queryClient);
};
/**
 * @summary RollbackFileTransaction discards all staged files for the given transaction ID.
 */
export const runtimeServiceRollbackFileTransaction = (
  instanceId: string,
  runtimeServiceRollbackFileTransactionBody: RuntimeServiceRollbackFileTransactionBody,
  signal?: AbortSignal,
) => {
  return httpClient<V1RollbackFileTransactionResponse>({
    url: `/v1/instances/${instanceId}/files/transaction/rollback`,
    method: "POST",
    headers: { "Content-Type": "application/json" },
    data: runtimeServiceRollbackFileTransactionBody,
    signal,
  });
};

export const getRuntimeServiceRollbackFileTransactionMutationOptions = <
  TError = ErrorType<RpcStatus>,
  TContext = unknown,
>(options?: {
  mutation?: CreateMutationOptions<
    Awaited<ReturnType<typeof runtimeServiceRollbackFileTransaction>>,
    TError,
    { instanceId: string; data: RuntimeServiceRollbackFileTransactionBody },
    TContext
  >;
}): CreateMutationOptions<
  Awaited<ReturnType<typeof runtimeServiceRollbackFileTransaction>>,
  ...
  TContext
> => {
  const mutationKey = ["runtimeServiceRollbackFileTransaction"];
  const { mutation: mutationOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return runtimeServiceRollbackFileTransaction(instanceId, data);
  };

  return { mutationFn, ...mutationOptions };
};

export type RuntimeServiceRollbackFileTransactionMutationResult = NonNullable<
  Awaited<ReturnType<typeof runtimeServiceRollbackFileTransaction>>
>;
export type RuntimeServiceRollbackFileTransactionMutationBody =
  RuntimeServiceRollbackFileTransactionBody;
export type RuntimeServiceRollbackFileTransactionMutationError =
  ErrorType<RpcStatus>;

/**
 * @summary RollbackFileTransaction discards all staged files for the given transaction ID.
 */
export const createRuntimeServiceRollbackFileTransaction = <
  TError = ErrorType<RpcStatus>,
  TContext = unknown,
>(
  options?: {
...
> => {
  const mutationOptions =
    getRuntimeServiceRollbackFileTransactionMutationOptions(options);
