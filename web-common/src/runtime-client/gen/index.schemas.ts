...
export interface V1CanvasDefaultFilters {
  measures?: V1CanvasMeasureFilter[];
  dimensions?: V1CanvasDimensionFilter[];
}

export interface V1CanvasDimensionFilter {
  dimension?: string;
  values?: string[];
  limit?: number;
  removable?: boolean;
...
export interface V1CanvasMeasureFilter {
  measure?: string;
  values?: number[];
  limit?: number;
  removable?: boolean;
...
If not found in `time_ranges`, it should be added to the list. */
  ...
  filters?: V1CanvasDefaultFilters;
}
