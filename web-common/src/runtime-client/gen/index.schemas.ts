...
export type ExplorePresetExpressionMetadataDimensionInListFilter = {
  [key: string]: boolean;
};

export interface ExplorePresetExpressionMetadata {
  dimensionInListFilter?: ExplorePresetExpressionMetadataDimensionInListFilter;
}
