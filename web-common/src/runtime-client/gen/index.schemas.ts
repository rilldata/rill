...
export interface V1BeginFileTransactionResponse {
  txnId?: string;
}
...
export interface V1CommitFileTransactionResponse {
  [key: string]: unknown;
}
...
export interface V1RollbackFileTransactionResponse {
  [key: string]: unknown;
}
...
export type RuntimeServiceBeginFileTransactionBody = {
  files?: V1StagedFile[];
};

export type RuntimeServiceCommitFileTransactionBody = {
  txnId?: string;
};

export type RuntimeServiceRollbackFileTransactionBody = {
  txnId?: string;
};
