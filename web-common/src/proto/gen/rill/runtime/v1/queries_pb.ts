...
export enum QueryBatchType {
  /**
   * @generated from enum value: MetricsViewToplist = 0;
   */
  MetricsViewToplist = 0,

  /**
   * @generated from enum value: MetricsViewTimeSeries = 1;
   */
  MetricsViewTimeSeries = 1,

  /**
   * @generated from enum value: MetricsViewTotals = 2;
   */
  MetricsViewTotals = 2,

  /**
   * @generated from enum value: ColumnRollupInterval = 3;
   */
  ColumnRollupInterval = 3,

  /**
   * @generated from enum value: ColumnTopK = 4;
   */
  ColumnTopK = 4,

  /**
   * @generated from enum value: ColumnNullCount = 5;
   */
  ColumnNullCount = 5,

  /**
   * @generated from enum value: ColumnDescriptiveStatistics = 6;
   */
  ColumnDescriptiveStatistics = 6,

  /**
   * @generated from enum value: ColumnTimeGrain = 7;
   */
  ColumnTimeGrain = 7,

  /**
   * @generated from enum value: ColumnNumericHistogram = 8;
   */
  ColumnNumericHistogram = 8,

  /**
   * @generated from enum value: ColumnRugHistogram = 9;
   */
  ColumnRugHistogram = 9,

  /**
   * @generated from enum value: ColumnTimeRange = 10;
   */
  ColumnTimeRange = 10,

  /**
   * @generated from enum value: ColumnCardinality = 11;
   */
  ColumnCardinality = 11,

  /**
   * @generated from enum value: ColumnTimeSeries = 12;
   */
  ColumnTimeSeries = 12,

  /**
   * @generated from enum value: TableCardinality = 13;
   */
  TableCardinality = 13,

  /**
   * @generated from enum value: TableColumns = 14;
   */
  TableColumns = 14,

  /**
   * @generated from enum value: TableRows = 15;
   */
  TableRows = 15,
}
...
proto3.util.setEnumType(QueryBatchType, "rill.runtime.v1.QueryBatchType", [
  { no: 0, name: "MetricsViewToplist" },
  { no: 1, name: "MetricsViewTimeSeries" },
  { no: 2, name: "MetricsViewTotals" },
  { no: 3, name: "ColumnRollupInterval" },
  { no: 4, name: "ColumnTopK" },
  { no: 5, name: "ColumnNullCount" },
  { no: 6, name: "ColumnDescriptiveStatistics" },
  { no: 7, name: "ColumnTimeGrain" },
  { no: 8, name: "ColumnNumericHistogram" },
  { no: 9, name: "ColumnRugHistogram" },
  { no: 10, name: "ColumnTimeRange" },
  { no: 11, name: "ColumnCardinality" },
  { no: 12, name: "ColumnTimeSeries" },
  { no: 13, name: "TableCardinality" },
  { no: 14, name: "TableColumns" },
  { no: 15, name: "TableRows" },
]);
...
export class QueryBatchSingleRequest extends Message<QueryBatchSingleRequest> {
   ...
   */
  type = QueryBatchType.MetricsViewToplist;
  ...
  query: {
    ...
    /**
     * @generated from field: rill.runtime.v1.MetricsViewTimeSeriesRequest metricsViewTimeSeriesRequest = 4;
     */
    value: MetricsViewTimeSeriesRequest;
    case: "metricsViewTimeSeriesRequest";
  } | {
    /**
     * @generated from field: rill.runtime.v1.MetricsViewTotalsRequest metricsViewTotalsRequest = 5;
     */
    value: MetricsViewTotalsRequest;
    case: "metricsViewTotalsRequest";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnRollupIntervalRequest columnRollupIntervalRequest = 6;
     */
    value: ColumnRollupIntervalRequest;
    case: "columnRollupIntervalRequest";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnTopKRequest columnTopKRequest = 7;
     */
    value: ColumnTopKRequest;
    case: "columnTopKRequest";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnNullCountRequest columnNullCountRequest = 8;
     */
    value: ColumnNullCountRequest;
    case: "columnNullCountRequest";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnDescriptiveStatisticsRequest columnDescriptiveStatisticsRequest = 9;
     */
    value: ColumnDescriptiveStatisticsRequest;
    case: "columnDescriptiveStatisticsRequest";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnTimeGrainRequest columnTimeGrainRequest = 10;
     */
    value: ColumnTimeGrainRequest;
    case: "columnTimeGrainRequest";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnNumericHistogramRequest columnNumericHistogramRequest = 11;
     */
    value: ColumnNumericHistogramRequest;
    case: "columnNumericHistogramRequest";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnRugHistogramRequest columnRugHistogramRequest = 12;
     */
    value: ColumnRugHistogramRequest;
    case: "columnRugHistogramRequest";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnTimeRangeRequest columnTimeRangeRequest = 13;
     */
    value: ColumnTimeRangeRequest;
    case: "columnTimeRangeRequest";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnCardinalityRequest columnCardinalityRequest = 14;
     */
    value: ColumnCardinalityRequest;
    case: "columnCardinalityRequest";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnTimeSeriesRequest columnTimeSeriesRequest = 15;
     */
    value: ColumnTimeSeriesRequest;
    case: "columnTimeSeriesRequest";
  } | {
    /**
     * @generated from field: rill.runtime.v1.TableCardinalityRequest tableCardinalityRequest = 16;
     */
    value: TableCardinalityRequest;
    case: "tableCardinalityRequest";
  } | {
    /**
     * @generated from field: rill.runtime.v1.TableColumnsRequest tableColumnsRequest = 17;
     */
    value: TableColumnsRequest;
    case: "tableColumnsRequest";
  } | {
    /**
     * @generated from field: rill.runtime.v1.TableRowsRequest tableRowsRequest = 18;
     */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "metricsViewTimeSeriesRequest", kind: "message", T: MetricsViewTimeSeriesRequest, oneof: "query" },
    { no: 5, name: "metricsViewTotalsRequest", kind: "message", T: MetricsViewTotalsRequest, oneof: "query" },
    { no: 6, name: "columnRollupIntervalRequest", kind: "message", T: ColumnRollupIntervalRequest, oneof: "query" },
    { no: 7, name: "columnTopKRequest", kind: "message", T: ColumnTopKRequest, oneof: "query" },
    { no: 8, name: "columnNullCountRequest", kind: "message", T: ColumnNullCountRequest, oneof: "query" },
    { no: 9, name: "columnDescriptiveStatisticsRequest", kind: "message", T: ColumnDescriptiveStatisticsRequest, oneof: "query" },
    { no: 10, name: "columnTimeGrainRequest", kind: "message", T: ColumnTimeGrainRequest, oneof: "query" },
    { no: 11, name: "columnNumericHistogramRequest", kind: "message", T: ColumnNumericHistogramRequest, oneof: "query" },
    { no: 12, name: "columnRugHistogramRequest", kind: "message", T: ColumnRugHistogramRequest, oneof: "query" },
    { no: 13, name: "columnTimeRangeRequest", kind: "message", T: ColumnTimeRangeRequest, oneof: "query" },
    { no: 14, name: "columnCardinalityRequest", kind: "message", T: ColumnCardinalityRequest, oneof: "query" },
    { no: 15, name: "columnTimeSeriesRequest", kind: "message", T: ColumnTimeSeriesRequest, oneof: "query" },
    { no: 16, name: "tableCardinalityRequest", kind: "message", T: TableCardinalityRequest, oneof: "query" },
    { no: 17, name: "tableColumnsRequest", kind: "message", T: TableColumnsRequest, oneof: "query" },
    { no: 18, name: "tableRowsRequest", kind: "message", T: TableRowsRequest, oneof: "query" },
  ]);
...
export class QueryBatchResponse extends Message<QueryBatchResponse> {
  ...
  query: {
    ...
    /**
     * @generated from field: rill.runtime.v1.MetricsViewTimeSeriesResponse metricsViewTimeSeriesResponse = 4;
     */
    value: MetricsViewTimeSeriesResponse;
    case: "metricsViewTimeSeriesResponse";
  } | {
    /**
     * @generated from field: rill.runtime.v1.MetricsViewTotalsResponse metricsViewTotalsResponse = 5;
     */
    value: MetricsViewTotalsResponse;
    case: "metricsViewTotalsResponse";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnRollupIntervalResponse columnRollupIntervalResponse = 6;
     */
    value: ColumnRollupIntervalResponse;
    case: "columnRollupIntervalResponse";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnTopKResponse columnTopKResponse = 7;
     */
    value: ColumnTopKResponse;
    case: "columnTopKResponse";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnNullCountResponse columnNullCountResponse = 8;
     */
    value: ColumnNullCountResponse;
    case: "columnNullCountResponse";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnDescriptiveStatisticsResponse columnDescriptiveStatisticsResponse = 9;
     */
    value: ColumnDescriptiveStatisticsResponse;
    case: "columnDescriptiveStatisticsResponse";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnTimeGrainResponse columnTimeGrainResponse = 10;
     */
    value: ColumnTimeGrainResponse;
    case: "columnTimeGrainResponse";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnNumericHistogramResponse columnNumericHistogramResponse = 11;
     */
    value: ColumnNumericHistogramResponse;
    case: "columnNumericHistogramResponse";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnRugHistogramResponse columnRugHistogramResponse = 12;
     */
    value: ColumnRugHistogramResponse;
    case: "columnRugHistogramResponse";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnTimeRangeResponse columnTimeRangeResponse = 13;
     */
    value: ColumnTimeRangeResponse;
    case: "columnTimeRangeResponse";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnCardinalityResponse columnCardinalityResponse = 14;
     */
    value: ColumnCardinalityResponse;
    case: "columnCardinalityResponse";
  } | {
    /**
     * @generated from field: rill.runtime.v1.ColumnTimeSeriesResponse columnTimeSeriesResponse = 15;
     */
    value: ColumnTimeSeriesResponse;
    case: "columnTimeSeriesResponse";
  } | {
    /**
     * @generated from field: rill.runtime.v1.TableCardinalityResponse tableCardinalityResponse = 16;
     */
    value: TableCardinalityResponse;
    case: "tableCardinalityResponse";
  } | {
    /**
     * @generated from field: rill.runtime.v1.TableColumnsResponse tableColumnsResponse = 17;
     */
    value: TableColumnsResponse;
    case: "tableColumnsResponse";
  } | {
    /**
     * @generated from field: rill.runtime.v1.TableRowsResponse tableRowsResponse = 18;
     */
  ...
  /**
   * @generated from field: string error = 19;
   */
  error = "";
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 4, name: "metricsViewTimeSeriesResponse", kind: "message", T: MetricsViewTimeSeriesResponse, oneof: "query" },
    { no: 5, name: "metricsViewTotalsResponse", kind: "message", T: MetricsViewTotalsResponse, oneof: "query" },
    { no: 6, name: "columnRollupIntervalResponse", kind: "message", T: ColumnRollupIntervalResponse, oneof: "query" },
    { no: 7, name: "columnTopKResponse", kind: "message", T: ColumnTopKResponse, oneof: "query" },
    { no: 8, name: "columnNullCountResponse", kind: "message", T: ColumnNullCountResponse, oneof: "query" },
    { no: 9, name: "columnDescriptiveStatisticsResponse", kind: "message", T: ColumnDescriptiveStatisticsResponse, oneof: "query" },
    { no: 10, name: "columnTimeGrainResponse", kind: "message", T: ColumnTimeGrainResponse, oneof: "query" },
    { no: 11, name: "columnNumericHistogramResponse", kind: "message", T: ColumnNumericHistogramResponse, oneof: "query" },
    { no: 12, name: "columnRugHistogramResponse", kind: "message", T: ColumnRugHistogramResponse, oneof: "query" },
    { no: 13, name: "columnTimeRangeResponse", kind: "message", T: ColumnTimeRangeResponse, oneof: "query" },
    { no: 14, name: "columnCardinalityResponse", kind: "message", T: ColumnCardinalityResponse, oneof: "query" },
    { no: 15, name: "columnTimeSeriesResponse", kind: "message", T: ColumnTimeSeriesResponse, oneof: "query" },
    { no: 16, name: "tableCardinalityResponse", kind: "message", T: TableCardinalityResponse, oneof: "query" },
    { no: 17, name: "tableColumnsResponse", kind: "message", T: TableColumnsResponse, oneof: "query" },
    { no: 18, name: "tableRowsResponse", kind: "message", T: TableRowsResponse, oneof: "query" },
    { no: 19, name: "error", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
