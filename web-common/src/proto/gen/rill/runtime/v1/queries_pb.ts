...
export class MeasureFilter extends Message<MeasureFilter> {
  /**
   * @generated from oneof rill.runtime.v1.MeasureFilter.entry
   */
  entry: {
    /**
     * @generated from field: rill.runtime.v1.MeasureFilterEntry MeasureFilterEntry = 1;
     */
    value: MeasureFilterEntry;
    case: "MeasureFilterEntry";
  } | {
    /**
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "MeasureFilterEntry", kind: "message", T: MeasureFilterEntry, oneof: "entry" },
...
/**
 * @generated from message rill.runtime.v1.MeasureFilterEntry
 */
export class MeasureFilterEntry extends Message<MeasureFilterEntry> {
  /**
  ...
  constructor(data?: PartialMessage<MeasureFilterEntry>) {
    super();
    proto3.util.initPartial(data, this);
  }
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): MeasureFilterEntry {
    return new MeasureFilterEntry().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): MeasureFilterEntry {
    return new MeasureFilterEntry().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): MeasureFilterEntry {
    return new MeasureFilterEntry().fromJsonString(jsonString, options);
  }

  static equals(a: MeasureFilterEntry | PlainMessage<MeasureFilterEntry> | undefined, b: MeasureFilterEntry | PlainMessage<MeasureFilterEntry> | undefined): boolean {
    return proto3.util.equals(MeasureFilterEntry, a, b);
  }
}

/**
 * @generated from enum rill.runtime.v1.MeasureFilterEntry.ColumnType
 */
export enum MeasureFilterEntry_ColumnType {
  /**
...
// Retrieve enum metadata with: proto3.getEnumType(MeasureFilterEntry_ColumnType)
proto3.util.setEnumType(MeasureFilterEntry_ColumnType, "rill.runtime.v1.MeasureFilterEntry.ColumnType", [
...
export class MeasureFilterExpression extends Message<MeasureFilterExpression> {
  /**
   * @generated from field: repeated rill.runtime.v1.MeasureFilter entries = 1;
   */
  entries: MeasureFilter[] = [];

  /**
   * @generated from field: rill.runtime.v1.MeasureFilterExpression.Joiner joiner = 2;
   */
  joiner = MeasureFilterExpression_Joiner.UNSPECIFIED;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "entries", kind: "message", T: MeasureFilter, repeated: true },
    { no: 2, name: "joiner", kind: "enum", T: proto3.getEnumType(MeasureFilterExpression_Joiner) },
  ]);
...
/**
 * @generated from enum rill.runtime.v1.MeasureFilterExpression.Joiner
 */
export enum MeasureFilterExpression_Joiner {
  /**
   * @generated from enum value: JOINER_UNSPECIFIED = 0;
   */
  UNSPECIFIED = 0,

  /**
   * @generated from enum value: JOINER_OR = 2;
   */
  OR = 2,

  /**
   * @generated from enum value: JOINER_AND = 3;
   */
  AND = 3,
}
// Retrieve enum metadata with: proto3.getEnumType(MeasureFilterExpression_Joiner)
proto3.util.setEnumType(MeasureFilterExpression_Joiner, "rill.runtime.v1.MeasureFilterExpression.Joiner", [
  { no: 0, name: "JOINER_UNSPECIFIED" },
  { no: 2, name: "JOINER_OR" },
  { no: 3, name: "JOINER_AND" },
]);
