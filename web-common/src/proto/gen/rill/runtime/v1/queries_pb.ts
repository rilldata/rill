...
export class MetricsViewComparisonRequest extends Message<MetricsViewComparisonRequest> {
  ...
  /**
   * @generated from field: string iso_time_range = 7;
   */
  isoTimeRange = "";

  /**
   * @generated from field: rill.runtime.v1.TimeRange comparison_time_range = 8;
   */
  comparisonTimeRange?: TimeRange;

  /**
   * @generated from field: string iso_comparison_time_range_offset = 9;
   */
  isoComparisonTimeRangeOffset = "";
  ...
  /**
   * @generated from field: bool exact = 14;
   */
  exact = false;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 7, name: "iso_time_range", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 8, name: "comparison_time_range", kind: "message", T: TimeRange },
    { no: 9, name: "iso_comparison_time_range_offset", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 10, name: "filter", kind: "message", T: MetricsViewFilter },
    { no: 11, name: "limit", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 12, name: "offset", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 13, name: "priority", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 14, name: "exact", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);
