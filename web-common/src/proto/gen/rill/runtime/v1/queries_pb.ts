...
export class ExportRequest extends Message<ExportRequest> {
  ...
  request: {
    /**
     * @generated from field: rill.runtime.v1.MetricsViewAggregationRequest metrics_view_aggregation_request = 7;
     */
    ...
    /**
     * @generated from field: rill.runtime.v1.MetricsViewComparisonRequest metrics_view_comparison_request = 8;
     */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 7, name: "metrics_view_aggregation_request", kind: "message", T: MetricsViewAggregationRequest, oneof: "request" },
    ...
    { no: 8, name: "metrics_view_comparison_request", kind: "message", T: MetricsViewComparisonRequest, oneof: "request" },
  ]);
