...
export class Table extends Message<Table> {
  ...
  static equals(
    a: Table | PlainMessage<Table> | undefined,
    b: Table | PlainMessage<Table> | undefined
  ): boolean {
...
export class Source extends Message<Source> {
  ...
  static equals(
    a: Source | PlainMessage<Source> | undefined,
    b: Source | PlainMessage<Source> | undefined
  ): boolean {
...
export class Source_ExtractPolicy extends Message<Source_ExtractPolicy> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    {
      ...
      name: "rows_strategy",
      kind: "enum",
      T: proto3.getEnumType(Source_ExtractPolicy_Strategy),
    },
    {
      no: 2,
      name: "rows_limit_bytes",
      kind: "scalar",
  ...
  static equals(
    a: Source_ExtractPolicy | PlainMessage<Source_ExtractPolicy> | undefined,
    b: Source_ExtractPolicy | PlainMessage<Source_ExtractPolicy> | undefined
  ): boolean {
...
proto3.util.setEnumType(
  ...
  "rill.runtime.v1.Source.ExtractPolicy.Strategy",
  [
...
export class Model extends Message<Model> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "sql", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    {
      ...
      name: "dialect",
      kind: "enum",
      T: proto3.getEnumType(Model_Dialect),
    },
...
export class MetricsView extends Message<MetricsView> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    {
      no: 9,
      name: "smallest_time_grain",
      kind: "enum",
      T: proto3.getEnumType(TimeGrain),
    },
    {
      no: 10,
  ...
  static equals(
    a: MetricsView | PlainMessage<MetricsView> | undefined,
    b: MetricsView | PlainMessage<MetricsView> | undefined
  ): boolean {
...
export class MetricsView_Dimension extends Message<MetricsView_Dimension> {
  ...
  static equals(
    a: MetricsView_Dimension | PlainMessage<MetricsView_Dimension> | undefined,
    b: MetricsView_Dimension | PlainMessage<MetricsView_Dimension> | undefined
  ): boolean {
...
export class MetricsView_Measure extends Message<MetricsView_Measure> {
  ...
  static equals(
    a: MetricsView_Measure | PlainMessage<MetricsView_Measure> | undefined,
    b: MetricsView_Measure | PlainMessage<MetricsView_Measure> | undefined
  ): boolean {
