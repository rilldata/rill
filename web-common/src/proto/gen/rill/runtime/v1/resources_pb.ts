...
export class ExploreState extends Message<ExploreState> {
   ...
   *
   * @generated from field: repeated rill.runtime.v1.AIPrompt ai_suggested_prompts = 3;
   */
  aiSuggestedPrompts: AIPrompt[] = [];
   ...
   *
   * @generated from field: string ai_suggested_prompts_hash = 4;
   */
  aiSuggestedPromptsHash = "";
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 3, name: "ai_suggested_prompts", kind: "message", T: AIPrompt, repeated: true },
    { no: 4, name: "ai_suggested_prompts_hash", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
