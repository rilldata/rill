...
export class ExplorePreset extends Message<ExplorePreset> {
  ...
  /**
   * @generated from field: optional uint32 exploreLeaderboardMeasureCount = 21;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 21, name: "exploreLeaderboardMeasureCount", kind: "scalar", T: 13 /* ScalarType.UINT32 */, opt: true },
