...
export class GetGithubRepoStatusResponse extends Message<GetGithubRepoStatusResponse> {
  /**
   * @generated from field: rill.admin.v1.GetGithubRepoStatusResponse.AccessStatus access_status = 1;
   */
  accessStatus = GetGithubRepoStatusResponse_AccessStatus.UNSPECIFIED;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "access_status", kind: "enum", T: proto3.getEnumType(GetGithubRepoStatusResponse_AccessStatus) },
...
/**
 * @generated from enum rill.admin.v1.GetGithubRepoStatusResponse.AccessStatus
 */
export enum GetGithubRepoStatusResponse_AccessStatus {
  /**
   * @generated from enum value: ACCESS_STATUS_UNSPECIFIED = 0;
   */
  UNSPECIFIED = 0,

  /**
   * @generated from enum value: ACCESS_STATUS_REJECTED = 1;
   */
  REJECTED = 1,

  /**
   * @generated from enum value: ACCESS_STATUS_REQUESTED = 2;
   */
  REQUESTED = 2,

  /**
   * @generated from enum value: ACCESS_STATUS_GRANTED = 3;
   */
  GRANTED = 3,
}
// Retrieve enum metadata with: proto3.getEnumType(GetGithubRepoStatusResponse_AccessStatus)
proto3.util.setEnumType(GetGithubRepoStatusResponse_AccessStatus, "rill.admin.v1.GetGithubRepoStatusResponse.AccessStatus", [
  { no: 0, name: "ACCESS_STATUS_UNSPECIFIED" },
  { no: 1, name: "ACCESS_STATUS_REJECTED" },
  { no: 2, name: "ACCESS_STATUS_REQUESTED" },
  { no: 3, name: "ACCESS_STATUS_GRANTED" },
]);
