...
/**
 * @generated from message rill.local.v1.ListCandidateProjectsRequest
 */
export class ListCandidateProjectsRequest extends Message<ListCandidateProjectsRequest> {
  constructor(data?: PartialMessage<ListCandidateProjectsRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "rill.local.v1.ListCandidateProjectsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ListCandidateProjectsRequest {
    return new ListCandidateProjectsRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ListCandidateProjectsRequest {
    return new ListCandidateProjectsRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ListCandidateProjectsRequest {
    return new ListCandidateProjectsRequest().fromJsonString(jsonString, options);
  }

  static equals(a: ListCandidateProjectsRequest | PlainMessage<ListCandidateProjectsRequest> | undefined, b: ListCandidateProjectsRequest | PlainMessage<ListCandidateProjectsRequest> | undefined): boolean {
    return proto3.util.equals(ListCandidateProjectsRequest, a, b);
  }
}

/**
 * @generated from message rill.local.v1.ListCandidateProjectsResponse
 */
export class ListCandidateProjectsResponse extends Message<ListCandidateProjectsResponse> {
  /**
   * @generated from field: repeated rill.admin.v1.Project projects = 1;
   */
  projects: Project[] = [];

  constructor(data?: PartialMessage<ListCandidateProjectsResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "rill.local.v1.ListCandidateProjectsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "projects", kind: "message", T: Project, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ListCandidateProjectsResponse {
    return new ListCandidateProjectsResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ListCandidateProjectsResponse {
    return new ListCandidateProjectsResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ListCandidateProjectsResponse {
    return new ListCandidateProjectsResponse().fromJsonString(jsonString, options);
  }

  static equals(a: ListCandidateProjectsResponse | PlainMessage<ListCandidateProjectsResponse> | undefined, b: ListCandidateProjectsResponse | PlainMessage<ListCandidateProjectsResponse> | undefined): boolean {
    return proto3.util.equals(ListCandidateProjectsResponse, a, b);
  }
}
