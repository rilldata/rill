...
/**
 * @generated from message rill.local.v1.CheckOrgNameRequest
 */
export class CheckOrgNameRequest extends Message<CheckOrgNameRequest> {
  /**
   * @generated from field: string org = 1;
   */
  org = "";

  constructor(data?: PartialMessage<CheckOrgNameRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "rill.local.v1.CheckOrgNameRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "org", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): CheckOrgNameRequest {
    return new CheckOrgNameRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): CheckOrgNameRequest {
    return new CheckOrgNameRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): CheckOrgNameRequest {
    return new CheckOrgNameRequest().fromJsonString(jsonString, options);
  }

  static equals(a: CheckOrgNameRequest | PlainMessage<CheckOrgNameRequest> | undefined, b: CheckOrgNameRequest | PlainMessage<CheckOrgNameRequest> | undefined): boolean {
    return proto3.util.equals(CheckOrgNameRequest, a, b);
  }
}

/**
 * @generated from message rill.local.v1.CheckOrgNameResponse
 */
export class CheckOrgNameResponse extends Message<CheckOrgNameResponse> {
  /**
   * @generated from field: bool available = 1;
   */
  available = false;

  constructor(data?: PartialMessage<CheckOrgNameResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "rill.local.v1.CheckOrgNameResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "available", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): CheckOrgNameResponse {
    return new CheckOrgNameResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): CheckOrgNameResponse {
    return new CheckOrgNameResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): CheckOrgNameResponse {
    return new CheckOrgNameResponse().fromJsonString(jsonString, options);
  }

  static equals(a: CheckOrgNameResponse | PlainMessage<CheckOrgNameResponse> | undefined, b: CheckOrgNameResponse | PlainMessage<CheckOrgNameResponse> | undefined): boolean {
    return proto3.util.equals(CheckOrgNameResponse, a, b);
  }
}
