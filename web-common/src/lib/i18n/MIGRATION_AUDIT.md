...
- Current after PRs 2–6 and 8: 105 candidates across 42 files
- Current split: 87 candidates in `web-admin` and 18 in `web-common`
- No candidates in `web-local`
- Current categories: 62 visible-text findings, 28 attribute findings, and 15
  copy-property findings
- Currently, 19 candidates have an exact English-text match in the existing
...
PRs 1–6 and 8 are completed. PRs 7 and 9–12 can be developed independently,
