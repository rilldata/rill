...
vi.mock("@rilldata/web-common/paraglide/runtime.js", async (importOriginal) => {
  const actual =
    await importOriginal<
      typeof import("@rilldata/web-common/paraglide/runtime.js")
    >();
  return {
    ...actual,
    getLocale: vi.fn(() => "en"),
...
import { setLocale } from "@rilldata/web-common/paraglide/runtime.js";
