...
<div class="flex flex-col gap-2 w-full">
  <div class="flex justify-between items-center px-2">
    <button
      type="button"
      class="hover:bg-gray-200 text-muted-foreground rounded-full aspect-square size-5 flex items-center justify-center"
...
<style lang="postcss">
  .weekday {
    @apply text-center w-full aspect-[2/1] text-muted-foreground select-none;
  }
