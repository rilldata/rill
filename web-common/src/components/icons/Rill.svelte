...
>
  <path
    d="M17.3382 0H14.0645V2.98905H17.3382V0Z"
    class="fill-accent-primary-action"
  />
  <path
    d="M23.0244 0L23.0361 16H26.323V0H23.0244Z"
    class="fill-accent-primary-action"
  />
  <path
    d="M18.5432 16H21.8308V0H18.5322L18.5432 16Z"
    class="fill-accent-primary-action"
  />
  <path
  ...
  />
  <path
    d="M17.3382 4.17285H14.0645V15.9996H17.3382V4.17285Z"
    class="fill-accent-primary-action"
  />
</svg>
