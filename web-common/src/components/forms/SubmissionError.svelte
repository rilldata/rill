...
<div class="error-container">
  <div class="flex items-start gap-1 min-w-0">
    ...
    <div class="flex-1 min-w-0">
      <div class="message text-surface-foreground font-normal text-sm">
        {message}
      </div>
      {#if details}
        <button
        ...
        >
          <span class="text-xs font-semibold text-muted-foreground capitalize"
...
<style lang="postcss">
  ...
  .details {
    @apply text-muted-foreground whitespace-pre-wrap break-words;
  }
</style>
