...
export const defaultChipColors: ChipColors = {
  ...
  outlineClass: "outline outline-1 outline-blue-100 dark:outline-blue-500 hover:outline-blue-200",
...
export const measureChipColors = {
  ...
  outlineClass: "outline outline-1 outline-indigo-100 dark:outline-indigo-500 hover:outline-indigo-200",
...
export const specialChipColors = {
  ...
  outlineClass: "outline outline-1 outline-purple-100 dark:outline-purple-500 hover:outline-purple-200",
