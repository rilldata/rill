...
export class EstimateIdealRollupInterval extends FunctionalTestBase  {
    ...
    public seriesGeneratedTimegrainData(): DataProviderData<[EstimatedRollupIntervalTestCase]> {
    ...
    public async shouldEstimateInterval(args:EstimatedRollupIntervalTestCase) {
        ...
        await this.dbClient.execute(generateSeries('_test', args.start, args.end, args.interval));
        /** roll up our _test.ts column */
        const result =( await this.databaseService
            .dispatch("estimateIdealRollupInterval", 
                ['_test', "ts"]
        ));
