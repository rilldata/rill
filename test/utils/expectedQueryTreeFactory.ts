...
export function expectedCTE(tables: Array<TableNodeJSON>, select: SelectNodeJSON): CTENodeJSON {
    return {
...
export function expectedSelect(tables: Array<TableNodeJSON>, columns: Array<ColumnNodeJSON>): SelectNodeJSON {
    return {
...
export function expectedTable(tableName: string, alias?: string): TableNodeJSON {
    return {
...
export function expectedColumn(refs: Array<string>, alias?: string): ColumnNodeJSON {
    return {
