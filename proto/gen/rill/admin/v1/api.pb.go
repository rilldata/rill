...
func (x *TelemetryRequest) GetEvent() map[string]string {
	if x != nil {
		return x.Event
	}
	return nil
...
var file_rill_admin_v1_api_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x79, 0x61, 0x6d, 0x6c, 0x22, 0x8e, 0x01, 0x0a,
	0x10, 0x54, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x40, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	...
	0x65, 0x6e, 0x74, 0x1a, 0x38, 0x0a, 0x0a, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x45, 0x6e, 0x74, 0x72,
	...
	0x69, 0x6e, 0x67, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x73, 0x22, 0xe9, 0x04, 0x0a, 0x07, 0x50,
	...
	0x61, 0x74, 0x65, 0x64, 0x4f, 0x6e, 0x22, 0x92, 0x03, 0x0a, 0x0a, 0x44, 0x65, 0x70, 0x6c, 0x6f,
	...
	0x22, 0xde, 0x03, 0x0a, 0x12, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x50, 0x65, 0x72, 0x6d,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0xa6, 0x02, 0x0a,
	...
	0x12, 0x25, 0x0a, 0x0e, 0x64, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x5f, 0x6e, 0x61,
	0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x64, 0x61, 0x73, 0x68, 0x62, 0x6f,
	0x61, 0x72, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x6a, 0x65,
	...
	0x70, 0x52, 0x09, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x4f, 0x6e, 0x22, 0x8a, 0x01, 0x0a,
	...
	0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x09,
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x4f, 0x6e, 0x22, 0xf4, 0x02, 0x0a, 0x0d, 0x52, 0x65,
	...
	0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x04, 0x32, 0xc4,
	0x52, 0x0a, 0x0c, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
...
var file_rill_admin_v1_api_proto_msgTypes = make([]protoimpl.MessageInfo, 157)
var file_rill_admin_v1_api_proto_goTypes = []interface{}{
	...
	(*TelemetryRequest)(nil),                     // 134: rill.admin.v1.TelemetryRequest
	(*TelemetryResponse)(nil),                    // 135: rill.admin.v1.TelemetryResponse
	(*User)(nil),                                 // 136: rill.admin.v1.User
	(*Service)(nil),                              // 137: rill.admin.v1.Service
	(*Organization)(nil),                         // 138: rill.admin.v1.Organization
	(*UserQuotas)(nil),                           // 139: rill.admin.v1.UserQuotas
	(*OrganizationQuotas)(nil),                   // 140: rill.admin.v1.OrganizationQuotas
	(*Project)(nil),                              // 141: rill.admin.v1.Project
	(*Deployment)(nil),                           // 142: rill.admin.v1.Deployment
	(*OrganizationPermissions)(nil),              // 143: rill.admin.v1.OrganizationPermissions
	(*ProjectPermissions)(nil),                   // 144: rill.admin.v1.ProjectPermissions
	(*Member)(nil),                               // 145: rill.admin.v1.Member
	(*UserInvite)(nil),                           // 146: rill.admin.v1.UserInvite
	(*WhitelistedDomain)(nil),                    // 147: rill.admin.v1.WhitelistedDomain
	(*Bookmark)(nil),                             // 148: rill.admin.v1.Bookmark
	(*ServiceToken)(nil),                         // 149: rill.admin.v1.ServiceToken
	(*VirtualFile)(nil),                          // 150: rill.admin.v1.VirtualFile
	(*ReportOptions)(nil),                        // 151: rill.admin.v1.ReportOptions
	nil,                                          // 152: rill.admin.v1.GetProjectVariablesResponse.VariablesEntry
	nil,                                          // 153: rill.admin.v1.CreateProjectRequest.VariablesEntry
	nil,                                          // 154: rill.admin.v1.UpdateProjectVariablesRequest.VariablesEntry
	nil,                                          // 155: rill.admin.v1.UpdateProjectVariablesResponse.VariablesEntry
	nil,                                          // 156: rill.admin.v1.GetReportMetaRequest.AnnotationsEntry
	nil,                                          // 157: rill.admin.v1.TelemetryRequest.EventEntry
	(*timestamppb.Timestamp)(nil),                // 158: google.protobuf.Timestamp
	(*structpb.Struct)(nil),                      // 159: google.protobuf.Struct
	(v1.ExportFormat)(0),                         // 160: rill.runtime.v1.ExportFormat
}
var file_rill_admin_v1_api_proto_depIdxs = []int32{
	158, // 0: rill.admin.v1.PingResponse.time:type_name -> google.protobuf.Timestamp
	138, // 1: rill.admin.v1.ListOrganizationsResponse.organizations:type_name -> rill.admin.v1.Organization
	138, // 2: rill.admin.v1.GetOrganizationResponse.organization:type_name -> rill.admin.v1.Organization
	143, // 3: rill.admin.v1.GetOrganizationResponse.permissions:type_name -> rill.admin.v1.OrganizationPermissions
	138, // 4: rill.admin.v1.CreateOrganizationResponse.organization:type_name -> rill.admin.v1.Organization
	138, // 5: rill.admin.v1.UpdateOrganizationResponse.organization:type_name -> rill.admin.v1.Organization
	141, // 6: rill.admin.v1.ListProjectsForOrganizationResponse.projects:type_name -> rill.admin.v1.Project
	141, // 7: rill.admin.v1.GetProjectResponse.project:type_name -> rill.admin.v1.Project
	142, // 8: rill.admin.v1.GetProjectResponse.prod_deployment:type_name -> rill.admin.v1.Deployment
	144, // 9: rill.admin.v1.GetProjectResponse.project_permissions:type_name -> rill.admin.v1.ProjectPermissions
	152, // 10: rill.admin.v1.GetProjectVariablesResponse.variables:type_name -> rill.admin.v1.GetProjectVariablesResponse.VariablesEntry
	136, // 11: rill.admin.v1.SearchProjectUsersResponse.users:type_name -> rill.admin.v1.User
	159, // 12: rill.admin.v1.GetDeploymentCredentialsRequest.attrs:type_name -> google.protobuf.Struct
	137, // 13: rill.admin.v1.ListServicesResponse.services:type_name -> rill.admin.v1.Service
	137, // 14: rill.admin.v1.CreateServiceResponse.service:type_name -> rill.admin.v1.Service
	137, // 15: rill.admin.v1.UpdateServiceResponse.service:type_name -> rill.admin.v1.Service
	137, // 16: rill.admin.v1.DeleteServiceResponse.service:type_name -> rill.admin.v1.Service
	153, // 17: rill.admin.v1.CreateProjectRequest.variables:type_name -> rill.admin.v1.CreateProjectRequest.VariablesEntry
	141, // 18: rill.admin.v1.CreateProjectResponse.project:type_name -> rill.admin.v1.Project
	141, // 19: rill.admin.v1.UpdateProjectResponse.project:type_name -> rill.admin.v1.Project
	154, // 20: rill.admin.v1.UpdateProjectVariablesRequest.variables:type_name -> rill.admin.v1.UpdateProjectVariablesRequest.VariablesEntry
	155, // 21: rill.admin.v1.UpdateProjectVariablesResponse.variables:type_name -> rill.admin.v1.UpdateProjectVariablesResponse.VariablesEntry
	145, // 22: rill.admin.v1.ListOrganizationMembersResponse.members:type_name -> rill.admin.v1.Member
	146, // 23: rill.admin.v1.ListOrganizationInvitesResponse.invites:type_name -> rill.admin.v1.UserInvite
	136, // 24: rill.admin.v1.ListSuperusersResponse.users:type_name -> rill.admin.v1.User
	136, // 25: rill.admin.v1.SudoGetResourceResponse.user:type_name -> rill.admin.v1.User
	138, // 26: rill.admin.v1.SudoGetResourceResponse.org:type_name -> rill.admin.v1.Organization
	141, // 27: rill.admin.v1.SudoGetResourceResponse.project:type_name -> rill.admin.v1.Project
	142, // 28: rill.admin.v1.SudoGetResourceResponse.deployment:type_name -> rill.admin.v1.Deployment
	142, // 29: rill.admin.v1.SudoGetResourceResponse.instance:type_name -> rill.admin.v1.Deployment
	138, // 30: rill.admin.v1.SudoUpdateOrganizationQuotasResponse.organization:type_name -> rill.admin.v1.Organization
	136, // 31: rill.admin.v1.SudoUpdateUserQuotasResponse.user:type_name -> rill.admin.v1.User
	145, // 32: rill.admin.v1.ListProjectMembersResponse.members:type_name -> rill.admin.v1.Member
	146, // 33: rill.admin.v1.ListProjectInvitesResponse.invites:type_name -> rill.admin.v1.UserInvite
	136, // 34: rill.admin.v1.GetCurrentUserResponse.user:type_name -> rill.admin.v1.User
	83,  // 35: rill.admin.v1.GetCurrentUserResponse.preferences:type_name -> rill.admin.v1.UserPreferences
	136, // 36: rill.admin.v1.GetUserResponse.user:type_name -> rill.admin.v1.User
	...
	148, // 39: rill.admin.v1.ListBookmarksResponse.bookmarks:type_name -> rill.admin.v1.Bookmark
	148, // 40: rill.admin.v1.GetBookmarkResponse.bookmark:type_name -> rill.admin.v1.Bookmark
	148, // 41: rill.admin.v1.CreateBookmarkResponse.bookmark:type_name -> rill.admin.v1.Bookmark
	136, // 42: rill.admin.v1.SearchUsersResponse.users:type_name -> rill.admin.v1.User
	149, // 43: rill.admin.v1.ListServiceAuthTokensResponse.tokens:type_name -> rill.admin.v1.ServiceToken
	147, // 44: rill.admin.v1.ListWhitelistedDomainsResponse.domains:type_name -> rill.admin.v1.WhitelistedDomain
	158, // 45: rill.admin.v1.GetRepoMetaResponse.git_url_expires_on:type_name -> google.protobuf.Timestamp
	150, // 46: rill.admin.v1.PullVirtualRepoResponse.files:type_name -> rill.admin.v1.VirtualFile
	156, // 47: rill.admin.v1.GetReportMetaRequest.annotations:type_name -> rill.admin.v1.GetReportMetaRequest.AnnotationsEntry
	151, // 48: rill.admin.v1.CreateReportRequest.options:type_name -> rill.admin.v1.ReportOptions
	151, // 49: rill.admin.v1.EditReportRequest.options:type_name -> rill.admin.v1.ReportOptions
	151, // 50: rill.admin.v1.GenerateReportYAMLRequest.options:type_name -> rill.admin.v1.ReportOptions
	157, // 51: rill.admin.v1.TelemetryRequest.event:type_name -> rill.admin.v1.TelemetryRequest.EventEntry
	139, // 52: rill.admin.v1.User.quotas:type_name -> rill.admin.v1.UserQuotas
	158, // 53: rill.admin.v1.User.created_on:type_name -> google.protobuf.Timestamp
	158, // 54: rill.admin.v1.User.updated_on:type_name -> google.protobuf.Timestamp
	158, // 55: rill.admin.v1.Service.created_on:type_name -> google.protobuf.Timestamp
	158, // 56: rill.admin.v1.Service.updated_on:type_name -> google.protobuf.Timestamp
	140, // 57: rill.admin.v1.Organization.quotas:type_name -> rill.admin.v1.OrganizationQuotas
	158, // 58: rill.admin.v1.Organization.created_on:type_name -> google.protobuf.Timestamp
	158, // 59: rill.admin.v1.Organization.updated_on:type_name -> google.protobuf.Timestamp
	158, // 60: rill.admin.v1.Project.created_on:type_name -> google.protobuf.Timestamp
	158, // 61: rill.admin.v1.Project.updated_on:type_name -> google.protobuf.Timestamp
	0,   // 62: rill.admin.v1.Deployment.status:type_name -> rill.admin.v1.DeploymentStatus
	158, // 63: rill.admin.v1.Deployment.created_on:type_name -> google.protobuf.Timestamp
	158, // 64: rill.admin.v1.Deployment.updated_on:type_name -> google.protobuf.Timestamp
	158, // 65: rill.admin.v1.Member.created_on:type_name -> google.protobuf.Timestamp
	158, // 66: rill.admin.v1.Member.updated_on:type_name -> google.protobuf.Timestamp
	158, // 67: rill.admin.v1.Bookmark.created_on:type_name -> google.protobuf.Timestamp
	158, // 68: rill.admin.v1.Bookmark.updated_on:type_name -> google.protobuf.Timestamp
	158, // 69: rill.admin.v1.ServiceToken.created_on:type_name -> google.protobuf.Timestamp
	158, // 70: rill.admin.v1.ServiceToken.expires_on:type_name -> google.protobuf.Timestamp
	158, // 71: rill.admin.v1.VirtualFile.updated_on:type_name -> google.protobuf.Timestamp
	160, // 72: rill.admin.v1.ReportOptions.export_format:type_name -> rill.runtime.v1.ExportFormat
	1,   // 73: rill.admin.v1.AdminService.Ping:input_type -> rill.admin.v1.PingRequest
	3,   // 74: rill.admin.v1.AdminService.ListOrganizations:input_type -> rill.admin.v1.ListOrganizationsRequest
	5,   // 75: rill.admin.v1.AdminService.GetOrganization:input_type -> rill.admin.v1.GetOrganizationRequest
	7,   // 76: rill.admin.v1.AdminService.CreateOrganization:input_type -> rill.admin.v1.CreateOrganizationRequest
	9,   // 77: rill.admin.v1.AdminService.DeleteOrganization:input_type -> rill.admin.v1.DeleteOrganizationRequest
	11,  // 78: rill.admin.v1.AdminService.UpdateOrganization:input_type -> rill.admin.v1.UpdateOrganizationRequest
	13,  // 79: rill.admin.v1.AdminService.ListProjectsForOrganization:input_type -> rill.admin.v1.ListProjectsForOrganizationRequest
	15,  // 80: rill.admin.v1.AdminService.GetProject:input_type -> rill.admin.v1.GetProjectRequest
	17,  // 81: rill.admin.v1.AdminService.SearchProjectNames:input_type -> rill.admin.v1.SearchProjectNamesRequest
	19,  // 82: rill.admin.v1.AdminService.GetProjectVariables:input_type -> rill.admin.v1.GetProjectVariablesRequest
	33,  // 83: rill.admin.v1.AdminService.CreateProject:input_type -> rill.admin.v1.CreateProjectRequest
	35,  // 84: rill.admin.v1.AdminService.DeleteProject:input_type -> rill.admin.v1.DeleteProjectRequest
	37,  // 85: rill.admin.v1.AdminService.UpdateProject:input_type -> rill.admin.v1.UpdateProjectRequest
	39,  // 86: rill.admin.v1.AdminService.UpdateProjectVariables:input_type -> rill.admin.v1.UpdateProjectVariablesRequest
	41,  // 87: rill.admin.v1.AdminService.TriggerReconcile:input_type -> rill.admin.v1.TriggerReconcileRequest
	43,  // 88: rill.admin.v1.AdminService.TriggerRefreshSources:input_type -> rill.admin.v1.TriggerRefreshSourcesRequest
	45,  // 89: rill.admin.v1.AdminService.TriggerRedeploy:input_type -> rill.admin.v1.TriggerRedeployRequest
	47,  // 90: rill.admin.v1.AdminService.ListOrganizationMembers:input_type -> rill.admin.v1.ListOrganizationMembersRequest
	49,  // 91: rill.admin.v1.AdminService.ListOrganizationInvites:input_type -> rill.admin.v1.ListOrganizationInvitesRequest
	51,  // 92: rill.admin.v1.AdminService.AddOrganizationMember:input_type -> rill.admin.v1.AddOrganizationMemberRequest
	53,  // 93: rill.admin.v1.AdminService.RemoveOrganizationMember:input_type -> rill.admin.v1.RemoveOrganizationMemberRequest
	55,  // 94: rill.admin.v1.AdminService.LeaveOrganization:input_type -> rill.admin.v1.LeaveOrganizationRequest
	57,  // 95: rill.admin.v1.AdminService.SetOrganizationMemberRole:input_type -> rill.admin.v1.SetOrganizationMemberRoleRequest
	69,  // 96: rill.admin.v1.AdminService.ListProjectMembers:input_type -> rill.admin.v1.ListProjectMembersRequest
	71,  // 97: rill.admin.v1.AdminService.ListProjectInvites:input_type -> rill.admin.v1.ListProjectInvitesRequest
	73,  // 98: rill.admin.v1.AdminService.AddProjectMember:input_type -> rill.admin.v1.AddProjectMemberRequest
	75,  // 99: rill.admin.v1.AdminService.RemoveProjectMember:input_type -> rill.admin.v1.RemoveProjectMemberRequest
	77,  // 100: rill.admin.v1.AdminService.SetProjectMemberRole:input_type -> rill.admin.v1.SetProjectMemberRoleRequest
	79,  // 101: rill.admin.v1.AdminService.GetCurrentUser:input_type -> rill.admin.v1.GetCurrentUserRequest
	98,  // 102: rill.admin.v1.AdminService.IssueRepresentativeAuthToken:input_type -> rill.admin.v1.IssueRepresentativeAuthTokenRequest
	96,  // 103: rill.admin.v1.AdminService.RevokeCurrentAuthToken:input_type -> rill.admin.v1.RevokeCurrentAuthTokenRequest
	106, // 104: rill.admin.v1.AdminService.GetGithubRepoStatus:input_type -> rill.admin.v1.GetGithubRepoStatusRequest
	108, // 105: rill.admin.v1.AdminService.GetGitCredentials:input_type -> rill.admin.v1.GetGitCredentialsRequest
	110, // 106: rill.admin.v1.AdminService.CreateWhitelistedDomain:input_type -> rill.admin.v1.CreateWhitelistedDomainRequest
	112, // 107: rill.admin.v1.AdminService.RemoveWhitelistedDomain:input_type -> rill.admin.v1.RemoveWhitelistedDomainRequest
	114, // 108: rill.admin.v1.AdminService.ListWhitelistedDomains:input_type -> rill.admin.v1.ListWhitelistedDomainsRequest
	81,  // 109: rill.admin.v1.AdminService.GetUser:input_type -> rill.admin.v1.GetUserRequest
	94,  // 110: rill.admin.v1.AdminService.SearchUsers:input_type -> rill.admin.v1.SearchUsersRequest
	21,  // 111: rill.admin.v1.AdminService.SearchProjectUsers:input_type -> rill.admin.v1.SearchProjectUsersRequest
	59,  // 112: rill.admin.v1.AdminService.ListSuperusers:input_type -> rill.admin.v1.ListSuperusersRequest
	23,  // 113: rill.admin.v1.AdminService.GetDeploymentCredentials:input_type -> rill.admin.v1.GetDeploymentCredentialsRequest
	61,  // 114: rill.admin.v1.AdminService.SetSuperuser:input_type -> rill.admin.v1.SetSuperuserRequest
	63,  // 115: rill.admin.v1.AdminService.SudoGetResource:input_type -> rill.admin.v1.SudoGetResourceRequest
	67,  // 116: rill.admin.v1.AdminService.SudoUpdateUserQuotas:input_type -> rill.admin.v1.SudoUpdateUserQuotasRequest
	65,  // 117: rill.admin.v1.AdminService.SudoUpdateOrganizationQuotas:input_type -> rill.admin.v1.SudoUpdateOrganizationQuotasRequest
	25,  // 118: rill.admin.v1.AdminService.ListServices:input_type -> rill.admin.v1.ListServicesRequest
	27,  // 119: rill.admin.v1.AdminService.CreateService:input_type -> rill.admin.v1.CreateServiceRequest
	29,  // 120: rill.admin.v1.AdminService.UpdateService:input_type -> rill.admin.v1.UpdateServiceRequest
	31,  // 121: rill.admin.v1.AdminService.DeleteService:input_type -> rill.admin.v1.DeleteServiceRequest
	104, // 122: rill.admin.v1.AdminService.ListServiceAuthTokens:input_type -> rill.admin.v1.ListServiceAuthTokensRequest
	102, // 123: rill.admin.v1.AdminService.IssueServiceAuthToken:input_type -> rill.admin.v1.IssueServiceAuthTokenRequest
	100, // 124: rill.admin.v1.AdminService.RevokeServiceAuthToken:input_type -> rill.admin.v1.RevokeServiceAuthTokenRequest
	84,  // 125: rill.admin.v1.AdminService.UpdateUserPreferences:input_type -> rill.admin.v1.UpdateUserPreferencesRequest
	86,  // 126: rill.admin.v1.AdminService.ListBookmarks:input_type -> rill.admin.v1.ListBookmarksRequest
	88,  // 127: rill.admin.v1.AdminService.GetBookmark:input_type -> rill.admin.v1.GetBookmarkRequest
	90,  // 128: rill.admin.v1.AdminService.CreateBookmark:input_type -> rill.admin.v1.CreateBookmarkRequest
	92,  // 129: rill.admin.v1.AdminService.RemoveBookmark:input_type -> rill.admin.v1.RemoveBookmarkRequest
	116, // 130: rill.admin.v1.AdminService.GetRepoMeta:input_type -> rill.admin.v1.GetRepoMetaRequest
	118, // 131: rill.admin.v1.AdminService.PullVirtualRepo:input_type -> rill.admin.v1.PullVirtualRepoRequest
	120, // 132: rill.admin.v1.AdminService.GetReportMeta:input_type -> rill.admin.v1.GetReportMetaRequest
	122, // 133: rill.admin.v1.AdminService.CreateReport:input_type -> rill.admin.v1.CreateReportRequest
	124, // 134: rill.admin.v1.AdminService.EditReport:input_type -> rill.admin.v1.EditReportRequest
	126, // 135: rill.admin.v1.AdminService.UnsubscribeReport:input_type -> rill.admin.v1.UnsubscribeReportRequest
	128, // 136: rill.admin.v1.AdminService.DeleteReport:input_type -> rill.admin.v1.DeleteReportRequest
	130, // 137: rill.admin.v1.AdminService.TriggerReport:input_type -> rill.admin.v1.TriggerReportRequest
	132, // 138: rill.admin.v1.AdminService.GenerateReportYAML:input_type -> rill.admin.v1.GenerateReportYAMLRequest
	134, // 139: rill.admin.v1.AdminService.Telemetry:input_type -> rill.admin.v1.TelemetryRequest
	2,   // 140: rill.admin.v1.AdminService.Ping:output_type -> rill.admin.v1.PingResponse
	4,   // 141: rill.admin.v1.AdminService.ListOrganizations:output_type -> rill.admin.v1.ListOrganizationsResponse
	6,   // 142: rill.admin.v1.AdminService.GetOrganization:output_type -> rill.admin.v1.GetOrganizationResponse
	8,   // 143: rill.admin.v1.AdminService.CreateOrganization:output_type -> rill.admin.v1.CreateOrganizationResponse
	10,  // 144: rill.admin.v1.AdminService.DeleteOrganization:output_type -> rill.admin.v1.DeleteOrganizationResponse
	12,  // 145: rill.admin.v1.AdminService.UpdateOrganization:output_type -> rill.admin.v1.UpdateOrganizationResponse
	14,  // 146: rill.admin.v1.AdminService.ListProjectsForOrganization:output_type -> rill.admin.v1.ListProjectsForOrganizationResponse
	16,  // 147: rill.admin.v1.AdminService.GetProject:output_type -> rill.admin.v1.GetProjectResponse
	18,  // 148: rill.admin.v1.AdminService.SearchProjectNames:output_type -> rill.admin.v1.SearchProjectNamesResponse
	20,  // 149: rill.admin.v1.AdminService.GetProjectVariables:output_type -> rill.admin.v1.GetProjectVariablesResponse
	34,  // 150: rill.admin.v1.AdminService.CreateProject:output_type -> rill.admin.v1.CreateProjectResponse
	36,  // 151: rill.admin.v1.AdminService.DeleteProject:output_type -> rill.admin.v1.DeleteProjectResponse
	38,  // 152: rill.admin.v1.AdminService.UpdateProject:output_type -> rill.admin.v1.UpdateProjectResponse
	40,  // 153: rill.admin.v1.AdminService.UpdateProjectVariables:output_type -> rill.admin.v1.UpdateProjectVariablesResponse
	42,  // 154: rill.admin.v1.AdminService.TriggerReconcile:output_type -> rill.admin.v1.TriggerReconcileResponse
	44,  // 155: rill.admin.v1.AdminService.TriggerRefreshSources:output_type -> rill.admin.v1.TriggerRefreshSourcesResponse
	46,  // 156: rill.admin.v1.AdminService.TriggerRedeploy:output_type -> rill.admin.v1.TriggerRedeployResponse
	48,  // 157: rill.admin.v1.AdminService.ListOrganizationMembers:output_type -> rill.admin.v1.ListOrganizationMembersResponse
	50,  // 158: rill.admin.v1.AdminService.ListOrganizationInvites:output_type -> rill.admin.v1.ListOrganizationInvitesResponse
	52,  // 159: rill.admin.v1.AdminService.AddOrganizationMember:output_type -> rill.admin.v1.AddOrganizationMemberResponse
	54,  // 160: rill.admin.v1.AdminService.RemoveOrganizationMember:output_type -> rill.admin.v1.RemoveOrganizationMemberResponse
	56,  // 161: rill.admin.v1.AdminService.LeaveOrganization:output_type -> rill.admin.v1.LeaveOrganizationResponse
	58,  // 162: rill.admin.v1.AdminService.SetOrganizationMemberRole:output_type -> rill.admin.v1.SetOrganizationMemberRoleResponse
	70,  // 163: rill.admin.v1.AdminService.ListProjectMembers:output_type -> rill.admin.v1.ListProjectMembersResponse
	72,  // 164: rill.admin.v1.AdminService.ListProjectInvites:output_type -> rill.admin.v1.ListProjectInvitesResponse
	74,  // 165: rill.admin.v1.AdminService.AddProjectMember:output_type -> rill.admin.v1.AddProjectMemberResponse
	76,  // 166: rill.admin.v1.AdminService.RemoveProjectMember:output_type -> rill.admin.v1.RemoveProjectMemberResponse
	78,  // 167: rill.admin.v1.AdminService.SetProjectMemberRole:output_type -> rill.admin.v1.SetProjectMemberRoleResponse
	80,  // 168: rill.admin.v1.AdminService.GetCurrentUser:output_type -> rill.admin.v1.GetCurrentUserResponse
	99,  // 169: rill.admin.v1.AdminService.IssueRepresentativeAuthToken:output_type -> rill.admin.v1.IssueRepresentativeAuthTokenResponse
	97,  // 170: rill.admin.v1.AdminService.RevokeCurrentAuthToken:output_type -> rill.admin.v1.RevokeCurrentAuthTokenResponse
	107, // 171: rill.admin.v1.AdminService.GetGithubRepoStatus:output_type -> rill.admin.v1.GetGithubRepoStatusResponse
	109, // 172: rill.admin.v1.AdminService.GetGitCredentials:output_type -> rill.admin.v1.GetGitCredentialsResponse
	111, // 173: rill.admin.v1.AdminService.CreateWhitelistedDomain:output_type -> rill.admin.v1.CreateWhitelistedDomainResponse
	113, // 174: rill.admin.v1.AdminService.RemoveWhitelistedDomain:output_type -> rill.admin.v1.RemoveWhitelistedDomainResponse
	115, // 175: rill.admin.v1.AdminService.ListWhitelistedDomains:output_type -> rill.admin.v1.ListWhitelistedDomainsResponse
	82,  // 176: rill.admin.v1.AdminService.GetUser:output_type -> rill.admin.v1.GetUserResponse
	95,  // 177: rill.admin.v1.AdminService.SearchUsers:output_type -> rill.admin.v1.SearchUsersResponse
	22,  // 178: rill.admin.v1.AdminService.SearchProjectUsers:output_type -> rill.admin.v1.SearchProjectUsersResponse
	60,  // 179: rill.admin.v1.AdminService.ListSuperusers:output_type -> rill.admin.v1.ListSuperusersResponse
	24,  // 180: rill.admin.v1.AdminService.GetDeploymentCredentials:output_type -> rill.admin.v1.GetDeploymentCredentialsResponse
	62,  // 181: rill.admin.v1.AdminService.SetSuperuser:output_type -> rill.admin.v1.SetSuperuserResponse
	64,  // 182: rill.admin.v1.AdminService.SudoGetResource:output_type -> rill.admin.v1.SudoGetResourceResponse
	68,  // 183: rill.admin.v1.AdminService.SudoUpdateUserQuotas:output_type -> rill.admin.v1.SudoUpdateUserQuotasResponse
	66,  // 184: rill.admin.v1.AdminService.SudoUpdateOrganizationQuotas:output_type -> rill.admin.v1.SudoUpdateOrganizationQuotasResponse
	26,  // 185: rill.admin.v1.AdminService.ListServices:output_type -> rill.admin.v1.ListServicesResponse
	28,  // 186: rill.admin.v1.AdminService.CreateService:output_type -> rill.admin.v1.CreateServiceResponse
	30,  // 187: rill.admin.v1.AdminService.UpdateService:output_type -> rill.admin.v1.UpdateServiceResponse
	32,  // 188: rill.admin.v1.AdminService.DeleteService:output_type -> rill.admin.v1.DeleteServiceResponse
	105, // 189: rill.admin.v1.AdminService.ListServiceAuthTokens:output_type -> rill.admin.v1.ListServiceAuthTokensResponse
	103, // 190: rill.admin.v1.AdminService.IssueServiceAuthToken:output_type -> rill.admin.v1.IssueServiceAuthTokenResponse
	101, // 191: rill.admin.v1.AdminService.RevokeServiceAuthToken:output_type -> rill.admin.v1.RevokeServiceAuthTokenResponse
	85,  // 192: rill.admin.v1.AdminService.UpdateUserPreferences:output_type -> rill.admin.v1.UpdateUserPreferencesResponse
	87,  // 193: rill.admin.v1.AdminService.ListBookmarks:output_type -> rill.admin.v1.ListBookmarksResponse
	89,  // 194: rill.admin.v1.AdminService.GetBookmark:output_type -> rill.admin.v1.GetBookmarkResponse
	91,  // 195: rill.admin.v1.AdminService.CreateBookmark:output_type -> rill.admin.v1.CreateBookmarkResponse
	93,  // 196: rill.admin.v1.AdminService.RemoveBookmark:output_type -> rill.admin.v1.RemoveBookmarkResponse
	117, // 197: rill.admin.v1.AdminService.GetRepoMeta:output_type -> rill.admin.v1.GetRepoMetaResponse
	119, // 198: rill.admin.v1.AdminService.PullVirtualRepo:output_type -> rill.admin.v1.PullVirtualRepoResponse
	121, // 199: rill.admin.v1.AdminService.GetReportMeta:output_type -> rill.admin.v1.GetReportMetaResponse
	123, // 200: rill.admin.v1.AdminService.CreateReport:output_type -> rill.admin.v1.CreateReportResponse
	125, // 201: rill.admin.v1.AdminService.EditReport:output_type -> rill.admin.v1.EditReportResponse
	127, // 202: rill.admin.v1.AdminService.UnsubscribeReport:output_type -> rill.admin.v1.UnsubscribeReportResponse
	129, // 203: rill.admin.v1.AdminService.DeleteReport:output_type -> rill.admin.v1.DeleteReportResponse
	131, // 204: rill.admin.v1.AdminService.TriggerReport:output_type -> rill.admin.v1.TriggerReportResponse
	133, // 205: rill.admin.v1.AdminService.GenerateReportYAML:output_type -> rill.admin.v1.GenerateReportYAMLResponse
	135, // 206: rill.admin.v1.AdminService.Telemetry:output_type -> rill.admin.v1.TelemetryResponse
