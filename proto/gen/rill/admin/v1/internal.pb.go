...
var file_rill_admin_v1_internal_proto_goTypes = []any{
...
func file_rill_admin_v1_internal_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rill_admin_v1_internal_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_rill_admin_v1_internal_proto_msgTypes[1].Exporter = func(v any, i int) any {
