...
const (
	...
	AdminService_SudoUpdateOrganizationBilling_FullMethodName  = "/rill.admin.v1.AdminService/SudoUpdateOrganizationBilling"
...
type AdminServiceClient interface {
	...
	// SudoUpdateOrganizationBilling update the quotas available for orgs
	SudoUpdateOrganizationBilling(ctx context.Context, in *SudoUpdateOrganizationBillingRequest, opts ...grpc.CallOption) (*SudoUpdateOrganizationBillingResponse, error)
...
func (c *adminServiceClient) ListOrganizationMembers(ctx context.Context, in *ListOrganizationMembersRequest, opts ...grpc.CallOption) (*ListOrganizationMembersResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdminService_ListOrganizationMembers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) RemoveOrganizationMember(ctx context.Context, in *RemoveOrganizationMemberRequest, opts ...grpc.CallOption) (*RemoveOrganizationMemberResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdminService_RemoveOrganizationMember_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) SetOrganizationMemberRole(ctx context.Context, in *SetOrganizationMemberRoleRequest, opts ...grpc.CallOption) (*SetOrganizationMemberRoleResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdminService_SetOrganizationMemberRole_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) ListProjectMembers(ctx context.Context, in *ListProjectMembersRequest, opts ...grpc.CallOption) (*ListProjectMembersResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdminService_ListProjectMembers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) AddProjectMember(ctx context.Context, in *AddProjectMemberRequest, opts ...grpc.CallOption) (*AddProjectMemberResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdminService_AddProjectMember_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) RemoveProjectMember(ctx context.Context, in *RemoveProjectMemberRequest, opts ...grpc.CallOption) (*RemoveProjectMemberResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdminService_RemoveProjectMember_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) SetProjectMemberRole(ctx context.Context, in *SetProjectMemberRoleRequest, opts ...grpc.CallOption) (*SetProjectMemberRoleResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdminService_SetProjectMemberRole_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) SudoUpdateOrganizationBilling(ctx context.Context, in *SudoUpdateOrganizationBillingRequest, opts ...grpc.CallOption) (*SudoUpdateOrganizationBillingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SudoUpdateOrganizationBillingResponse)
	err := c.cc.Invoke(ctx, AdminService_SudoUpdateOrganizationBilling_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServiceServer interface {
	...
	// SudoUpdateOrganizationBilling update the quotas available for orgs
	SudoUpdateOrganizationBilling(context.Context, *SudoUpdateOrganizationBillingRequest) (*SudoUpdateOrganizationBillingResponse, error)
	// SudoUpdateAnnotations endpoint for superusers to update project annotations
...
func (UnimplementedAdminServiceServer) SudoUpdateOrganizationBilling(context.Context, *SudoUpdateOrganizationBillingRequest) (*SudoUpdateOrganizationBillingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SudoUpdateOrganizationBilling not implemented")
}
...
func _AdminService_SudoUpdateOrganizationBilling_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SudoUpdateOrganizationBillingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServiceServer).SudoUpdateOrganizationBilling(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_SudoUpdateOrganizationBilling_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).SudoUpdateOrganizationBilling(ctx, req.(*SudoUpdateOrganizationBillingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdminService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SudoUpdateOrganizationBilling",
			Handler:    _AdminService_SudoUpdateOrganizationBilling_Handler,
		},
		{
