...
// Validate checks the field values on CompletionMessageContext with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CompletionMessageContext) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CompletionMessageContext with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CompletionMessageContextMultiError, or nil if none found.
func (m *CompletionMessageContext) ValidateAll() error {
	return m.validate(true)
}

func (m *CompletionMessageContext) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CompletionMessageContextMultiError(errors)
	}

	return nil
}

// CompletionMessageContextMultiError is an error wrapping multiple validation
// errors returned by CompletionMessageContext.ValidateAll() if the designated
// constraints aren't met.
type CompletionMessageContextMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CompletionMessageContextMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CompletionMessageContextMultiError) AllErrors() []error { return m }

// CompletionMessageContextValidationError is the validation error returned by
// CompletionMessageContext.Validate if the designated constraints aren't met.
type CompletionMessageContextValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CompletionMessageContextValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CompletionMessageContextValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CompletionMessageContextValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CompletionMessageContextValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CompletionMessageContextValidationError) ErrorName() string {
	return "CompletionMessageContextValidationError"
}

// Error satisfies the builtin error interface
func (e CompletionMessageContextValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCompletionMessageContext.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CompletionMessageContextValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CompletionMessageContextValidationError{}
