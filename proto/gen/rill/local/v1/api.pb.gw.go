...
func request_LocalService_WatchGitStatus_0(ctx context.Context, marshaler runtime.Marshaler, client LocalServiceClient, req *http.Request, pathParams map[string]string) (LocalService_WatchGitStatusClient, runtime.ServerMetadata, error) {
	...
	stream, err := client.WatchGitStatus(ctx, &protoReq)
	if err != nil {
...
func RegisterLocalServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server LocalServiceServer) error {
	...
	mux.Handle("POST", pattern_LocalService_WatchGitStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterLocalServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LocalServiceClient) error {
	...
	mux.Handle("POST", pattern_LocalService_WatchGitStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/rill.local.v1.LocalService/WatchGitStatus", runtime.WithHTTPPathPattern("/rill.local.v1.LocalService/WatchGitStatus"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_LocalService_WatchGitStatus_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_LocalService_WatchGitStatus_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_LocalService_WatchGitStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"rill.local.v1.LocalService", "WatchGitStatus"}, ""))
...
var (
	...
	forward_LocalService_WatchGitStatus_0 = runtime.ForwardResponseStream
