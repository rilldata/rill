...
const (
	UncommittedChanges_UNCOMMITTED_CHANGES_UNKNOWN UncommittedChanges = 0
...
type DeployValidationResponse struct {
	...
	IsRepoAccessGranted        bool                   `protobuf:"varint,3,opt,name=is_repo_access_granted,json=isRepoAccessGranted,proto3" json:"is_repo_access_granted,omitempty"` // if true below fields are relevant after git repo access granted
	GitGrantAccessUrl          string                 `protobuf:"bytes,4,opt,name=git_grant_access_url,json=gitGrantAccessUrl,proto3" json:"git_grant_access_url,omitempty"`        // redirect to this if is_github_connected or is_repo_access_granted is false
	GitUserName                string                 `protobuf:"bytes,5,opt,name=git_user_name,json=gitUserName,proto3" json:"git_user_name,omitempty"`
	GitUserOrgs                []string               `protobuf:"bytes,6,rep,name=git_user_orgs,json=gitUserOrgs,proto3" json:"git_user_orgs,omitempty"`
	IsGitRepo                  bool                   `protobuf:"varint,7,opt,name=is_git_repo,json=isGitRepo,proto3" json:"is_git_repo,omitempty"`
	GitRemoteFound             bool                   `protobuf:"varint,8,opt,name=git_remote_found,json=gitRemoteFound,proto3" json:"git_remote_found,omitempty"`                                                  // only applicable when is_git_repo is true
	GitUrl                     string                 `protobuf:"bytes,9,opt,name=git_url,json=gitUrl,proto3" json:"git_url,omitempty"`                                                                             // only applicable when is_git_repo is true and remote found
	UncommittedChanges         UncommittedChanges     `protobuf:"varint,10,opt,name=uncommitted_changes,json=uncommittedChanges,proto3,enum=rill.local.v1.UncommittedChanges" json:"uncommitted_changes,omitempty"` // only applicable when is_git_repo is true and remote found
	RillOrgExistsAsGitUserName bool                   `protobuf:"varint,11,opt,name=rill_org_exists_as_git_user_name,json=rillOrgExistsAsGitUserName,proto3" json:"rill_org_exists_as_git_user_name,omitempty"`     // only applicable when user does not have any orgs
	RillUserOrgs               []string               `protobuf:"bytes,12,rep,name=rill_user_orgs,json=rillUserOrgs,proto3" json:"rill_user_orgs,omitempty"`
	LocalProjectName           string                 `protobuf:"bytes,13,opt,name=local_project_name,json=localProjectName,proto3" json:"local_project_name,omitempty"`
	OrganizationsWithApp       []*OrganizationWithApp `protobuf:"bytes,14,rep,name=organizations_with_app,json=organizationsWithApp,proto3" json:"organizations_with_app,omitempty"`
}
...
func (x *DeployValidationResponse) GetUncommittedChanges() UncommittedChanges {
	...
	return UncommittedChanges_UNCOMMITTED_CHANGES_UNKNOWN
}
...
var file_rill_local_v1_api_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x22, 0xce, 0x05, 0x0a, 0x18, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x56, 0x61,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x22, 0x00, 0x12, 0x50, 0x0a, 0x09, 0x50, 0x75, 0x73, 0x68, 0x54, 0x6f, 0x47, 0x69, 0x74,
	0x12, 0x1f, 0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x2e, 0x76, 0x31,
	0x2e, 0x50, 0x75, 0x73, 0x68, 0x54, 0x6f, 0x47, 0x69, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x20, 0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x2e, 0x76,
	0x31, 0x2e, 0x50, 0x75, 0x73, 0x68, 0x54, 0x6f, 0x47, 0x69, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x47, 0x0a, 0x06, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x12,
	0x1c, 0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x2e, 0x76, 0x31, 0x2e,
	...
	0x70, 0x6c, 0x6f, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0xad,
