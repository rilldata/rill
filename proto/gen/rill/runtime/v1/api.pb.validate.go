...
// Validate checks the field values on PullEnvRequest with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *PullEnvRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PullEnvRequest with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in PullEnvRequestMultiError,
// or nil if none found.
func (m *PullEnvRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *PullEnvRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if !_PullEnvRequest_InstanceId_Pattern.MatchString(m.GetInstanceId()) {
		err := PullEnvRequestValidationError{
			field:  "InstanceId",
			reason: "value does not match regex pattern \"^[_\\\\-a-zA-Z0-9]+$\"",
		}
		if !all {
...
// PullEnvRequestMultiError is an error wrapping multiple validation errors
// returned by PullEnvRequest.ValidateAll() if the designated constraints
// aren't met.
type PullEnvRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PullEnvRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PullEnvRequestMultiError) AllErrors() []error { return m }

// PullEnvRequestValidationError is the validation error returned by
// PullEnvRequest.Validate if the designated constraints aren't met.
type PullEnvRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e PullEnvRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PullEnvRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PullEnvRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PullEnvRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PullEnvRequestValidationError) ErrorName() string { return "PullEnvRequestValidationError" }

// Error satisfies the builtin error interface
func (e PullEnvRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = PullEnvRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = PullEnvRequestValidationError{}

var _PullEnvRequest_InstanceId_Pattern = regexp.MustCompile("^[_\\-a-zA-Z0-9]+$")

// Validate checks the field values on PullEnvResponse with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *PullEnvResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PullEnvResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// PullEnvResponseMultiError, or nil if none found.
func (m *PullEnvResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *PullEnvResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return PullEnvResponseMultiError(errors)
	}

	return nil
}

// PullEnvResponseMultiError is an error wrapping multiple validation errors
// returned by PullEnvResponse.ValidateAll() if the designated constraints
// aren't met.
type PullEnvResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PullEnvResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PullEnvResponseMultiError) AllErrors() []error { return m }

// PullEnvResponseValidationError is the validation error returned by
// PullEnvResponse.Validate if the designated constraints aren't met.
type PullEnvResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e PullEnvResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PullEnvResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PullEnvResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PullEnvResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PullEnvResponseValidationError) ErrorName() string { return "PullEnvResponseValidationError" }

// Error satisfies the builtin error interface
func (e PullEnvResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sPullEnvResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = PullEnvResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = PullEnvResponseValidationError{}
