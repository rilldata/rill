...
func (m *OpenAPISpec) validate(all bool) error {
	...
	// no validation rules for ReqSummary

	for idx, item := range m.GetReqParams() {
		_, _ = idx, item
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, OpenAPISpecValidationError{
						field:  fmt.Sprintf("ReqParams[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
			...
			if err := v.Validate(); err != nil {
				return OpenAPISpecValidationError{
					field:  fmt.Sprintf("ReqParams[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	// no validation rules for ResDescription

	if all {
		switch v := interface{}(m.GetResSchema()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, OpenAPISpecValidationError{
					field:  "ResSchema",
	...
	} else if v, ok := interface{}(m.GetResSchema()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return OpenAPISpecValidationError{
				field:  "ResSchema",
				reason: "embedded message failed validation",
