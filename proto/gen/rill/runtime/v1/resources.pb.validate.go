...
// Validate checks the field values on Grid with the rules defined in the proto
// definition for this message. If any rules are violated, the first error
// encountered is returned, or nil if there are no violations.
func (m *Grid) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on Grid with the rules defined in the
// proto definition for this message. If any rules are violated, the result is
// a list of violation errors wrapped in GridMultiError, or nil if none found.
func (m *Grid) ValidateAll() error {
	return m.validate(true)
}

func (m *Grid) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GridMultiError(errors)
	}

	return nil
}

// GridMultiError is an error wrapping multiple validation errors returned by
// Grid.ValidateAll() if the designated constraints aren't met.
type GridMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GridMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GridMultiError) AllErrors() []error { return m }

// GridValidationError is the validation error returned by Grid.Validate if the
...
// Field function returns field value.
func (e GridValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GridValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GridValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GridValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GridValidationError) ErrorName() string { return "GridValidationError" }
...
var _ error = GridValidationError{}
