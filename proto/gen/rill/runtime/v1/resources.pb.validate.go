...
func (m *SecurityRuleFieldAccess) validate(all bool) error {
	...
	// no validation rules for AllExcept
...
// Validate checks the field values on SecurityCondition with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *SecurityCondition) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SecurityCondition with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SecurityConditionMultiError, or nil if none found.
func (m *SecurityCondition) ValidateAll() error {
	return m.validate(true)
}

func (m *SecurityCondition) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	case *SecurityCondition_Expression:
		if v == nil {
			err := SecurityConditionValidationError{
				field:  "Condition",
				reason: "oneof value cannot be a typed-nil",
			}
			if !all {
	...
	case *SecurityCondition_ResourceKind:
		if v == nil {
			err := SecurityConditionValidationError{
				field:  "Condition",
				reason: "oneof value cannot be a typed-nil",
	...
	case *SecurityCondition_ResourceName:
		if v == nil {
			err := SecurityConditionValidationError{
				field:  "Condition",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, SecurityConditionValidationError{
						field:  "ResourceName",
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return SecurityConditionValidationError{
					field:  "ResourceName",
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return SecurityConditionMultiError(errors)
	}

	return nil
}

// SecurityConditionMultiError is an error wrapping multiple validation errors
// returned by SecurityCondition.ValidateAll() if the designated constraints
// aren't met.
type SecurityConditionMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SecurityConditionMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SecurityConditionMultiError) AllErrors() []error { return m }

// SecurityConditionValidationError is the validation error returned by
// SecurityCondition.Validate if the designated constraints aren't met.
type SecurityConditionValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SecurityConditionValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SecurityConditionValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SecurityConditionValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SecurityConditionValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SecurityConditionValidationError) ErrorName() string {
	return "SecurityConditionValidationError"
}

// Error satisfies the builtin error interface
func (e SecurityConditionValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSecurityCondition.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SecurityConditionValidationError{}
