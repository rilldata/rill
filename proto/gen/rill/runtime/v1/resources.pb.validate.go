...
// Validate checks the field values on DashboardVariable with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *DashboardVariable) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on DashboardVariable with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// DashboardVariableMultiError, or nil if none found.
func (m *DashboardVariable) ValidateAll() error {
	return m.validate(true)
}

func (m *DashboardVariable) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return DashboardVariableMultiError(errors)
	}

	return nil
}

// DashboardVariableMultiError is an error wrapping multiple validation errors
// returned by DashboardVariable.ValidateAll() if the designated constraints
// aren't met.
type DashboardVariableMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m DashboardVariableMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m DashboardVariableMultiError) AllErrors() []error { return m }

// DashboardVariableValidationError is the validation error returned by
// DashboardVariable.Validate if the designated constraints aren't met.
type DashboardVariableValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e DashboardVariableValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e DashboardVariableValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e DashboardVariableValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e DashboardVariableValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e DashboardVariableValidationError) ErrorName() string {
	return "DashboardVariableValidationError"
}

// Error satisfies the builtin error interface
func (e DashboardVariableValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sDashboardVariable.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = DashboardVariableValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = DashboardVariableValidationError{}
