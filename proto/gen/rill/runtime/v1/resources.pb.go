...
type MetricsViewSpec struct {
	...
	AvailableTimeRanges []*MetricsViewSpec_AvailableTimeRange `protobuf:"bytes,14,rep,name=available_time_ranges,json=availableTimeRanges,proto3" json:"available_time_ranges,omitempty"`
}
...
type MetricsViewSpec_AvailableTimeRange struct {
	...
	ComparisonRanges []string `protobuf:"bytes,2,rep,name=comparison_ranges,json=comparisonRanges,proto3" json:"comparison_ranges,omitempty"`
}
...
func (x *MetricsViewSpec_AvailableTimeRange) GetComparisonRanges() []string {
	if x != nil {
		return x.ComparisonRanges
	}
	return nil
}
...
var file_rill_runtime_v1_resources_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x86, 0x0c, 0x0a, 0x0f, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x56, 0x69, 0x65,
	...
	0x72, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x72,
	0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4d,
	...
	0x52, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x1a, 0x89, 0x01, 0x0a, 0x0b, 0x44, 0x69, 0x6d, 0x65, 0x6e,
	...
	0x73, 0x1a, 0x57, 0x0a, 0x12, 0x41, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x54, 0x69,
	0x6d, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x72, 0x61, 0x6e, 0x67, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x2b, 0x0a,
	0x11, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x72, 0x69, 0x73, 0x6f, 0x6e, 0x5f, 0x72, 0x61, 0x6e, 0x67,
	0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x10, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x72,
	0x69, 0x73, 0x6f, 0x6e, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x22, 0x53, 0x0a, 0x10, 0x4d, 0x65,
...
var file_rill_runtime_v1_resources_proto_goTypes = []interface{}{
	...
	(*MetricsViewSpec_AvailableTimeRange)(nil),          // 43: rill.runtime.v1.MetricsViewSpec.AvailableTimeRange
...
var file_rill_runtime_v1_resources_proto_depIdxs = []int32{
	...
	43, // 38: rill.runtime.v1.MetricsViewSpec.available_time_ranges:type_name -> rill.runtime.v1.MetricsViewSpec.AvailableTimeRange
	...
	23, // 48: rill.runtime.v1.ReportState.current_execution:type_name -> rill.runtime.v1.ReportExecution
	23, // 49: rill.runtime.v1.ReportState.execution_history:type_name -> rill.runtime.v1.ReportExecution
	...
	25, // 53: rill.runtime.v1.PullTrigger.spec:type_name -> rill.runtime.v1.PullTriggerSpec
	26, // 54: rill.runtime.v1.PullTrigger.state:type_name -> rill.runtime.v1.PullTriggerState
	28, // 55: rill.runtime.v1.RefreshTrigger.spec:type_name -> rill.runtime.v1.RefreshTriggerSpec
	29, // 56: rill.runtime.v1.RefreshTrigger.state:type_name -> rill.runtime.v1.RefreshTriggerState
	4,  // 57: rill.runtime.v1.RefreshTriggerSpec.only_names:type_name -> rill.runtime.v1.ResourceName
	31, // 58: rill.runtime.v1.BucketPlanner.spec:type_name -> rill.runtime.v1.BucketPlannerSpec
	32, // 59: rill.runtime.v1.BucketPlanner.state:type_name -> rill.runtime.v1.BucketPlannerState
	33, // 60: rill.runtime.v1.BucketPlannerSpec.extract_policy:type_name -> rill.runtime.v1.BucketExtractPolicy
	1,  // 61: rill.runtime.v1.BucketExtractPolicy.rows_strategy:type_name -> rill.runtime.v1.BucketExtractPolicy.Strategy
	1,  // 62: rill.runtime.v1.BucketExtractPolicy.files_strategy:type_name -> rill.runtime.v1.BucketExtractPolicy.Strategy
	39, // 63: rill.runtime.v1.ParseError.start_location:type_name -> rill.runtime.v1.CharLocation
