...
const (
	...
	ReportStatus_REPORT_STATUS_QUERYING    ReportStatus = 2
	ReportStatus_REPORT_STATUS_EXPORTING   ReportStatus = 3
	ReportStatus_REPORT_STATUS_SENDING     ReportStatus = 4
	ReportStatus_REPORT_STATUS_CANCELLED   ReportStatus = 5
	ReportStatus_REPORT_STATUS_FAILED      ReportStatus = 6
	ReportStatus_REPORT_STATUS_SUCCEEDED   ReportStatus = 7
)
...
var (
	ReportStatus_name = map[int32]string{
		...
		2: "REPORT_STATUS_QUERYING",
		3: "REPORT_STATUS_EXPORTING",
		4: "REPORT_STATUS_SENDING",
		5: "REPORT_STATUS_CANCELLED",
		6: "REPORT_STATUS_FAILED",
		7: "REPORT_STATUS_SUCCEEDED",
	}
	ReportStatus_value = map[string]int32{
		"REPORT_STATUS_UNSPECIFIED": 0,
		"REPORT_STATUS_PENDING":     1,
		"REPORT_STATUS_QUERYING":    2,
		"REPORT_STATUS_EXPORTING":   3,
		"REPORT_STATUS_SENDING":     4,
		"REPORT_STATUS_CANCELLED":   5,
		"REPORT_STATUS_FAILED":      6,
		"REPORT_STATUS_SUCCEEDED":   7,
	}
)
...
type ReportSpec struct {
	...
	OperationProperties *structpb.Struct `protobuf:"bytes,11,opt,name=operation_properties,json=operationProperties,proto3" json:"operation_properties,omitempty"`
	OperationTimeRange  string           `protobuf:"bytes,12,opt,name=operation_time_range,json=operationTimeRange,proto3" json:"operation_time_range,omitempty"`
	ExportLimit         uint32           `protobuf:"varint,13,opt,name=export_limit,json=exportLimit,proto3" json:"export_limit,omitempty"`
	ExportFormat        ExportFormat     `protobuf:"varint,14,opt,name=export_format,json=exportFormat,proto3,enum=rill.runtime.v1.ExportFormat" json:"export_format,omitempty"`
	Recipients          []string         `protobuf:"bytes,15,rep,name=recipients,proto3" json:"recipients,omitempty"`
}
...
func (x *ReportSpec) GetDisabled() bool {
	if x != nil {
		return x.Disabled
	}
	return false
...
func (x *ReportSpec) GetOperationName() string {
	if x != nil {
...
func (x *ReportSpec) GetOperationTimeRange() string {
	if x != nil {
		return x.OperationTimeRange
	}
	return ""
}

func (x *ReportSpec) GetExportLimit() uint32 {
	if x != nil {
...
func (x *ReportSpec) GetRecipients() []string {
	if x != nil {
		return x.Recipients
	}
	return nil
...
type ReportExecution struct {
	...
	Status       ReportStatus           `protobuf:"varint,2,opt,name=status,proto3,enum=rill.runtime.v1.ReportStatus" json:"status,omitempty"`
	ErrorMessage string                 `protobuf:"bytes,3,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"`
	ReportTime   *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=report_time,json=reportTime,proto3" json:"report_time,omitempty"`
...
func (x *ReportExecution) GetStatus() ReportStatus {
	if x != nil {
		return x.Status
	}
...
var file_rill_runtime_v1_resources_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x81, 0x0a, 0x0a, 0x0f, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x56, 0x69, 0x65,
	...
	0x73, 0x74, 0x4d, 0x6f, 0x6e, 0x74, 0x68, 0x4f, 0x66, 0x59, 0x65, 0x61, 0x72, 0x1a, 0x71, 0x0a,
	...
	0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0xf3, 0x03, 0x0a, 0x0a, 0x52, 0x65, 0x70,
	...
	0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x64, 0x69, 0x73, 0x61, 0x62,
	0x6c, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x64, 0x69, 0x73, 0x61, 0x62,
	0x6c, 0x65, 0x64, 0x12, 0x44, 0x0a, 0x10, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x5f, 0x73,
	...
	,
	...
	0x52, 0x0c, 0x65, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12, 0x1e,
	0x0a, 0x0a, 0x72, 0x65, 0x63, 0x69, 0x70, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x0f, 0x20, 0x03,
	0x28, 0x09, 0x52, 0x0a, 0x72, 0x65, 0x63, 0x69, 0x70, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x90,
	...
	0x74, 0x22, 0xb8, 0x02, 0x0a, 0x0f, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x45, 0x78, 0x65, 0x63,
	0x75, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x64, 0x68, 0x6f, 0x63, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x61, 0x64, 0x68, 0x6f, 0x63, 0x12, 0x35, 0x0a, 0x06, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x72, 0x69,
	...
	0x5f, 0x52, 0x55, 0x4e, 0x4e, 0x49, 0x4e, 0x47, 0x10, 0x03, 0x2a, 0xf0, 0x01, 0x0a, 0x0c, 0x52,
	...
	,
...
var file_rill_runtime_v1_resources_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_rill_runtime_v1_resources_proto_goTypes = []interface{}{
	(ReconcileStatus)(0),                                // 0: rill.runtime.v1.ReconcileStatus
	(ReportStatus)(0),                                   // 1: rill.runtime.v1.ReportStatus
	...
	(*MetricsViewSpec_SecurityV2_FieldConditionV2)(nil), // 44: rill.runtime.v1.MetricsViewSpec.SecurityV2.FieldConditionV2
...
var file_rill_runtime_v1_resources_proto_depIdxs = []int32{
	...
	16, // 38: rill.runtime.v1.MetricsViewState.valid_spec:type_name -> rill.runtime.v1.MetricsViewSpec
	19, // 39: rill.runtime.v1.Migration.spec:type_name -> rill.runtime.v1.MigrationSpec
	20, // 40: rill.runtime.v1.Migration.state:type_name -> rill.runtime.v1.MigrationState
	22, // 41: rill.runtime.v1.Report.spec:type_name -> rill.runtime.v1.ReportSpec
	23, // 42: rill.runtime.v1.Report.state:type_name -> rill.runtime.v1.ReportState
	35, // 43: rill.runtime.v1.ReportSpec.refresh_schedule:type_name -> rill.runtime.v1.Schedule
	46, // 44: rill.runtime.v1.ReportSpec.operation_properties:type_name -> google.protobuf.Struct
	48, // 45: rill.runtime.v1.ReportSpec.export_format:type_name -> rill.runtime.v1.ExportFormat
	45, // 46: rill.runtime.v1.ReportState.next_run_on:type_name -> google.protobuf.Timestamp
	24, // 47: rill.runtime.v1.ReportState.current_execution:type_name -> rill.runtime.v1.ReportExecution
	24, // 48: rill.runtime.v1.ReportState.execution_history:type_name -> rill.runtime.v1.ReportExecution
	1,  // 49: rill.runtime.v1.ReportExecution.status:type_name -> rill.runtime.v1.ReportStatus
	45, // 50: rill.runtime.v1.ReportExecution.report_time:type_name -> google.protobuf.Timestamp
	45, // 51: rill.runtime.v1.ReportExecution.started_on:type_name -> google.protobuf.Timestamp
	45, // 52: rill.runtime.v1.ReportExecution.finished_on:type_name -> google.protobuf.Timestamp
	...
	44, // 64: rill.runtime.v1.MetricsViewSpec.SecurityV2.include:type_name -> rill.runtime.v1.MetricsViewSpec.SecurityV2.FieldConditionV2
	44, // 65: rill.runtime.v1.MetricsViewSpec.SecurityV2.exclude:type_name -> rill.runtime.v1.MetricsViewSpec.SecurityV2.FieldConditionV2
