...
type ReportSpec struct {
	...
	Security        *ReportSpec_Security `protobuf:"bytes,14,opt,name=security,proto3" json:"security,omitempty"`
}
...
func (x *ReportSpec) GetSecurity() *ReportSpec_Security {
	if x != nil {
		return x.Security
	}
	return nil
...
type ReportSpec_Security struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	OwnerUserId string `protobuf:"bytes,1,opt,name=owner_user_id,json=ownerUserId,proto3" json:"owner_user_id,omitempty"`
	ManagedByUi bool   `protobuf:"varint,2,opt,name=managed_by_ui,json=managedByUi,proto3" json:"managed_by_ui,omitempty"`
}

func (x *ReportSpec_Security) Reset() {
	*x = ReportSpec_Security{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReportSpec_Security) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportSpec_Security) ProtoMessage() {}

func (x *ReportSpec_Security) ProtoReflect() protoreflect.Message {
	mi := &file_rill_runtime_v1_resources_proto_msgTypes[42]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportSpec_Security.ProtoReflect.Descriptor instead.
func (*ReportSpec_Security) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_resources_proto_rawDescGZIP(), []int{19, 0}
}

func (x *ReportSpec_Security) GetOwnerUserId() string {
	if x != nil {
...
func (x *ReportSpec_Security) GetManagedByUi() bool {
	if x != nil {
		return x.ManagedByUi
	}
	return false
}
...
var file_rill_runtime_v1_resources_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x22, 0xba, 0x05, 0x0a, 0x0a, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x53, 0x70, 0x65,
	...
	,
	...
	0x41, 0x54, 0x45, 0x47, 0x59, 0x5f, 0x54, 0x41, 0x49, 0x4c, 0x10, 0x02, 0x22, 0x62, 0x0a, 0x08,
	...
	0x4e, 0x47, 0x10, 0x03, 0x42, 0xc1, 0x01, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x72, 0x69, 0x6c,
...
var file_rill_runtime_v1_resources_proto_goTypes = []interface{}{
	...
	(*ReportSpec_Security)(nil),                         // 44: rill.runtime.v1.ReportSpec.Security
...
var file_rill_runtime_v1_resources_proto_depIdxs = []int32{
	...
	44, // 45: rill.runtime.v1.ReportSpec.security:type_name -> rill.runtime.v1.ReportSpec.Security
...
func file_rill_runtime_v1_resources_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rill_runtime_v1_resources_proto_msgTypes[42].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReportSpec_Security); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
