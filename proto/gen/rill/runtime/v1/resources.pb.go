...
type ExplorePreset struct {
	...
	ExploreLeaderboardShowAllMeasures *bool            `protobuf:"varint,32,opt,name=explore_leaderboard_show_all_measures,json=exploreLeaderboardShowAllMeasures,proto3,oneof" json:"explore_leaderboard_show_all_measures,omitempty"`
