...
type AIEvalVerdict int32

const (
	AIEvalVerdict_AI_EVAL_VERDICT_UNSPECIFIED AIEvalVerdict = 0
	AIEvalVerdict_AI_EVAL_VERDICT_PENDING     AIEvalVerdict = 1
	AIEvalVerdict_AI_EVAL_VERDICT_RUNNING     AIEvalVerdict = 2
	AIEvalVerdict_AI_EVAL_VERDICT_PASS        AIEvalVerdict = 3
	AIEvalVerdict_AI_EVAL_VERDICT_FAIL        AIEvalVerdict = 4
	// Infrastructure error or timeout, distinct from a graded failure.
	AIEvalVerdict_AI_EVAL_VERDICT_ERROR AIEvalVerdict = 5
	// The case never ran because the run was canceled or interrupted.
	AIEvalVerdict_AI_EVAL_VERDICT_SKIPPED AIEvalVerdict = 6
)

// Enum value maps for AIEvalVerdict.
var (
	AIEvalVerdict_name = map[int32]string{
		0: "AI_EVAL_VERDICT_UNSPECIFIED",
		1: "AI_EVAL_VERDICT_PENDING",
		2: "AI_EVAL_VERDICT_RUNNING",
		3: "AI_EVAL_VERDICT_PASS",
		4: "AI_EVAL_VERDICT_FAIL",
		5: "AI_EVAL_VERDICT_ERROR",
		6: "AI_EVAL_VERDICT_SKIPPED",
	}
	AIEvalVerdict_value = map[string]int32{
...
func (x AIEvalVerdict) Enum() *AIEvalVerdict {
	p := new(AIEvalVerdict)
	*p = x
	return p
}

func (x AIEvalVerdict) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AIEvalVerdict) Descriptor() protoreflect.EnumDescriptor {
	return file_rill_runtime_v1_resources_proto_enumTypes[6].Descriptor()
}

func (AIEvalVerdict) Type() protoreflect.EnumType {
	return &file_rill_runtime_v1_resources_proto_enumTypes[6]
}

func (x AIEvalVerdict) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AIEvalVerdict.Descriptor instead.
func (AIEvalVerdict) EnumDescriptor() ([]byte, []int) {
...
func (x *Resource) GetAiEval() *AIEval {
	if x, ok := x.GetResource().(*Resource_AiEval); ok {
		return x.AiEval
	}
	return nil
}
...
type Resource_AiEval struct {
	AiEval *AIEval `protobuf:"bytes,18,opt,name=ai_eval,json=aiEval,proto3,oneof"`
}
...
func (*Resource_AiEval) isResource_Resource() {}
...
type AIEval struct {
	...
	Spec  *AIEvalSpec  `protobuf:"bytes,1,opt,name=spec,proto3" json:"spec,omitempty"`
	State *AIEvalState `protobuf:"bytes,2,opt,name=state,proto3" json:"state,omitempty"`
}
...
func (x *AIEval) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AIEval) ProtoMessage() {}

func (x *AIEval) ProtoReflect() protoreflect.Message {
	mi := &file_rill_runtime_v1_resources_proto_msgTypes[42]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AIEval.ProtoReflect.Descriptor instead.
func (*AIEval) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_resources_proto_rawDescGZIP(), []int{42}
}

func (x *AIEval) GetSpec() *AIEvalSpec {
	if x != nil {
		return x.Spec
	}
	return nil
...
func (x *AIEval) GetState() *AIEvalState {
	if x != nil {
		return x.State
	}
	return nil
...
type AIEvalSpec struct {
	...
	CaseTimeoutSeconds uint32 `protobuf:"varint,6,opt,name=case_timeout_seconds,json=caseTimeoutSeconds,proto3" json:"case_timeout_seconds,omitempty"`
	...
	Cases       []*AIEvalCase `protobuf:"bytes,8,rep,name=cases,proto3" json:"cases,omitempty"`
	...
	TriggerCases []string `protobuf:"bytes,10,rep,name=trigger_cases,json=triggerCases,proto3" json:"trigger_cases,omitempty"`
}

func (x *AIEvalSpec) Reset() {
	*x = AIEvalSpec{}
	if protoimpl.UnsafeEnabled {
...
func (x *AIEvalSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AIEvalSpec) ProtoMessage() {}

func (x *AIEvalSpec) ProtoReflect() protoreflect.Message {
	mi := &file_rill_runtime_v1_resources_proto_msgTypes[43]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AIEvalSpec.ProtoReflect.Descriptor instead.
func (*AIEvalSpec) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_resources_proto_rawDescGZIP(), []int{43}
}

func (x *AIEvalSpec) GetDisplayName() string {
	if x != nil {
		return x.DisplayName
	}
	return ""
...
func (x *AIEvalSpec) GetAgent() string {
	if x != nil {
		return x.Agent
	}
	return ""
...
func (x *AIEvalSpec) GetNotes() string {
	if x != nil {
		return x.Notes
	}
	return ""
...
func (x *AIEvalSpec) GetExplore() string {
	if x != nil {
		return x.Explore
	}
	return ""
...
func (x *AIEvalSpec) GetTimeoutSeconds() uint32 {
	if x != nil {
		return x.TimeoutSeconds
	}
	return 0
...
func (x *AIEvalSpec) GetCaseTimeoutSeconds() uint32 {
	if x != nil {
		return x.CaseTimeoutSeconds
	}
	return 0
}

func (x *AIEvalSpec) GetConcurrency() uint32 {
	if x != nil {
...
func (x *AIEvalSpec) GetCases() []*AIEvalCase {
	if x != nil {
		return x.Cases
	}
	return nil
...
func (x *AIEvalSpec) GetTrigger() bool {
	if x != nil {
		return x.Trigger
	}
	return false
...
func (x *AIEvalSpec) GetTriggerCases() []string {
	if x != nil {
		return x.TriggerCases
	}
	return nil
}
...
type AIEvalCase struct {
	...
	ExpectAnswer string `protobuf:"bytes,5,opt,name=expect_answer,json=expectAnswer,proto3" json:"expect_answer,omitempty"`
	// Metrics view the agent is expected to query; asserted structurally.
	ExpectMetricsView string `protobuf:"bytes,6,opt,name=expect_metrics_view,json=expectMetricsView,proto3" json:"expect_metrics_view,omitempty"`
	// Measures the agent's queries are expected to include; asserted structurally.
	ExpectMeasures []string `protobuf:"bytes,7,rep,name=expect_measures,json=expectMeasures,proto3" json:"expect_measures,omitempty"`
	// Dimensions the agent's queries are expected to include; asserted structurally.
	ExpectDimensions []string `protobuf:"bytes,8,rep,name=expect_dimensions,json=expectDimensions,proto3" json:"expect_dimensions,omitempty"`
	// Ground-truth metrics SQL whose result the agent's query result must match.
	// Reserved for future use; not asserted yet.
	ExpectResultSql     string `protobuf:"bytes,9,opt,name=expect_result_sql,json=expectResultSql,proto3" json:"expect_result_sql,omitempty"`
	ExpectResultOrdered bool   `protobuf:"varint,10,opt,name=expect_result_ordered,json=expectResultOrdered,proto3" json:"expect_result_ordered,omitempty"`
}

func (x *AIEvalCase) Reset() {
	*x = AIEvalCase{}
	if protoimpl.UnsafeEnabled {
...
func (x *AIEvalCase) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AIEvalCase) ProtoMessage() {}

func (x *AIEvalCase) ProtoReflect() protoreflect.Message {
	mi := &file_rill_runtime_v1_resources_proto_msgTypes[44]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AIEvalCase.ProtoReflect.Descriptor instead.
func (*AIEvalCase) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_resources_proto_rawDescGZIP(), []int{44}
}

func (x *AIEvalCase) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *AIEvalCase) GetQuestion() string {
	if x != nil {
		return x.Question
	}
	return ""
...
func (x *AIEvalCase) GetNotes() string {
	if x != nil {
		return x.Notes
	}
	return ""
...
func (x *AIEvalCase) GetExplore() string {
	if x != nil {
		return x.Explore
	}
	return ""
...
func (x *AIEvalCase) GetExpectAnswer() string {
	if x != nil {
		return x.ExpectAnswer
	}
	return ""
}

func (x *AIEvalCase) GetExpectMetricsView() string {
	if x != nil {
		return x.ExpectMetricsView
	}
	return ""
}

func (x *AIEvalCase) GetExpectMeasures() []string {
	if x != nil {
		return x.ExpectMeasures
	}
	return nil
}

func (x *AIEvalCase) GetExpectDimensions() []string {
	if x != nil {
		return x.ExpectDimensions
	}
	return nil
}

func (x *AIEvalCase) GetExpectResultSql() string {
	if x != nil {
		return x.ExpectResultSql
	}
	return ""
}

func (x *AIEvalCase) GetExpectResultOrdered() bool {
	if x != nil {
		return x.ExpectResultOrdered
	}
	return false
}

type AIEvalState struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CurrentExecution *AIEvalExecution   `protobuf:"bytes,1,opt,name=current_execution,json=currentExecution,proto3" json:"current_execution,omitempty"`
	ExecutionHistory []*AIEvalExecution `protobuf:"bytes,2,rep,name=execution_history,json=executionHistory,proto3" json:"execution_history,omitempty"`
...
func (x *AIEvalState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AIEvalState) ProtoMessage() {}

func (x *AIEvalState) ProtoReflect() protoreflect.Message {
	mi := &file_rill_runtime_v1_resources_proto_msgTypes[45]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AIEvalState.ProtoReflect.Descriptor instead.
func (*AIEvalState) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_resources_proto_rawDescGZIP(), []int{45}
}

func (x *AIEvalState) GetCurrentExecution() *AIEvalExecution {
	if x != nil {
		return x.CurrentExecution
	}
	return nil
...
func (x *AIEvalState) GetExecutionHistory() []*AIEvalExecution {
	if x != nil {
		return x.ExecutionHistory
	}
	return nil
...
func (x *AIEvalState) GetExecutionCount() uint32 {
	if x != nil {
		return x.ExecutionCount
	}
	return 0
...
type AIEvalExecution struct {
	...
	TriggerCases []string               `protobuf:"bytes,2,rep,name=trigger_cases,json=triggerCases,proto3" json:"trigger_cases,omitempty"`
	ErrorMessage string                 `protobuf:"bytes,3,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"`
	Canceled     bool                   `protobuf:"varint,4,opt,name=canceled,proto3" json:"canceled,omitempty"`
	StartedOn    *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=started_on,json=startedOn,proto3" json:"started_on,omitempty"`
	FinishedOn   *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=finished_on,json=finishedOn,proto3" json:"finished_on,omitempty"`
	CaseResults  []*AIEvalCaseResult    `protobuf:"bytes,7,rep,name=case_results,json=caseResults,proto3" json:"case_results,omitempty"`
	PassedCount  uint32                 `protobuf:"varint,8,opt,name=passed_count,json=passedCount,proto3" json:"passed_count,omitempty"`
	FailedCount  uint32                 `protobuf:"varint,9,opt,name=failed_count,json=failedCount,proto3" json:"failed_count,omitempty"`
	ErroredCount uint32                 `protobuf:"varint,10,opt,name=errored_count,json=erroredCount,proto3" json:"errored_count,omitempty"`
}

func (x *AIEvalExecution) Reset() {
	*x = AIEvalExecution{}
	if protoimpl.UnsafeEnabled {
...
func (x *AIEvalExecution) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AIEvalExecution) ProtoMessage() {}

func (x *AIEvalExecution) ProtoReflect() protoreflect.Message {
	mi := &file_rill_runtime_v1_resources_proto_msgTypes[46]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AIEvalExecution.ProtoReflect.Descriptor instead.
func (*AIEvalExecution) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_resources_proto_rawDescGZIP(), []int{46}
}

func (x *AIEvalExecution) GetAdhoc() bool {
	if x != nil {
		return x.Adhoc
	}
	return false
...
func (x *AIEvalExecution) GetTriggerCases() []string {
	if x != nil {
		return x.TriggerCases
	}
	return nil
...
func (x *AIEvalExecution) GetErrorMessage() string {
	if x != nil {
		return x.ErrorMessage
	}
	return ""
...
func (x *AIEvalExecution) GetCanceled() bool {
	if x != nil {
		return x.Canceled
	}
	return false
...
func (x *AIEvalExecution) GetStartedOn() *timestamppb.Timestamp {
	if x != nil {
		return x.StartedOn
	}
	return nil
...
func (x *AIEvalExecution) GetFinishedOn() *timestamppb.Timestamp {
	if x != nil {
		return x.FinishedOn
	}
	return nil
...
func (x *AIEvalExecution) GetCaseResults() []*AIEvalCaseResult {
	if x != nil {
...
func (x *AIEvalExecution) GetPassedCount() uint32 {
	if x != nil {
...
func (x *AIEvalExecution) GetFailedCount() uint32 {
	if x != nil {
...
func (x *AIEvalExecution) GetErroredCount() uint32 {
	if x != nil {
...
type AIEvalCaseResult struct {
	...
	Verdict  AIEvalVerdict `protobuf:"varint,2,opt,name=verdict,proto3,enum=rill.runtime.v1.AIEvalVerdict" json:"verdict,omitempty"`
	...
	JudgeReasoning string   `protobuf:"bytes,4,opt,name=judge_reasoning,json=judgeReasoning,proto3" json:"judge_reasoning,omitempty"`
	...
	AnswerPreview string                 `protobuf:"bytes,6,opt,name=answer_preview,json=answerPreview,proto3" json:"answer_preview,omitempty"`
	StartedOn     *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=started_on,json=startedOn,proto3" json:"started_on,omitempty"`
	FinishedOn    *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=finished_on,json=finishedOn,proto3" json:"finished_on,omitempty"`
}

func (x *AIEvalCaseResult) Reset() {
	*x = AIEvalCaseResult{}
	if protoimpl.UnsafeEnabled {
...
func (x *AIEvalCaseResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AIEvalCaseResult) ProtoMessage() {}

func (x *AIEvalCaseResult) ProtoReflect() protoreflect.Message {
	mi := &file_rill_runtime_v1_resources_proto_msgTypes[47]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AIEvalCaseResult.ProtoReflect.Descriptor instead.
func (*AIEvalCaseResult) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_resources_proto_rawDescGZIP(), []int{47}
}

func (x *AIEvalCaseResult) GetCaseName() string {
	if x != nil {
		return x.CaseName
	}
	return ""
...
func (x *AIEvalCaseResult) GetVerdict() AIEvalVerdict {
	if x != nil {
		return x.Verdict
	}
	return AIEvalVerdict_AI_EVAL_VERDICT_UNSPECIFIED
}

func (x *AIEvalCaseResult) GetFailureReasons() []string {
	if x != nil {
...
func (x *AIEvalCaseResult) GetJudgeReasoning() string {
	if x != nil {
		return x.JudgeReasoning
	}
	return ""
}

func (x *AIEvalCaseResult) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *AIEvalCaseResult) GetAnswerPreview() string {
	if x != nil {
...
func (x *AIEvalCaseResult) GetStartedOn() *timestamppb.Timestamp {
	if x != nil {
		return x.StartedOn
	}
	return nil
...
func (x *AIEvalCaseResult) GetFinishedOn() *timestamppb.Timestamp {
	if x != nil {
		return x.FinishedOn
	}
	return nil
...
type RefreshTriggerSpec struct {
	...
	AiEvals []*AIEvalTrigger `protobuf:"bytes,3,rep,name=ai_evals,json=aiEvals,proto3" json:"ai_evals,omitempty"`
}
...
func (x *RefreshTriggerSpec) GetAiEvals() []*AIEvalTrigger {
	if x != nil {
		return x.AiEvals
	}
	return nil
...
type AIEvalTrigger struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The AI eval resource to run.
	AiEval string `protobuf:"bytes,1,opt,name=ai_eval,json=aiEval,proto3" json:"ai_eval,omitempty"`
	// Names of specific cases to run. Empty runs all cases.
	Cases []string `protobuf:"bytes,2,rep,name=cases,proto3" json:"cases,omitempty"`
...
func (x *AIEvalTrigger) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AIEvalTrigger) ProtoMessage() {}

func (x *AIEvalTrigger) ProtoReflect() protoreflect.Message {
	mi := &file_rill_runtime_v1_resources_proto_msgTypes[51]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AIEvalTrigger.ProtoReflect.Descriptor instead.
func (*AIEvalTrigger) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_resources_proto_rawDescGZIP(), []int{51}
}

func (x *AIEvalTrigger) GetAiEval() string {
	if x != nil {
		return x.AiEval
	}
	return ""
...
func (x *AIEvalTrigger) GetCases() []string {
	if x != nil {
		return x.Cases
	}
	return nil
...
func (x *AIEvalTrigger) GetCancel() bool {
	if x != nil {
		return x.Cancel
	}
	return false
...
var file_rill_runtime_v1_resources_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x94, 0x07, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
	...
	0x00, 0x52, 0x09, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x32, 0x0a, 0x07,
	0x61, 0x69, 0x5f, 0x65, 0x76, 0x61, 0x6c, 0x18, 0x12, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e,
	0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e,
	0x41, 0x49, 0x45, 0x76, 0x61, 0x6c, 0x48, 0x00, 0x52, 0x06, 0x61, 0x69, 0x45, 0x76, 0x61, 0x6c,
	0x42, 0x0a, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0xb5, 0x07, 0x0a,
	...
	0x65, 0x66, 0x73, 0x12, 0x38, 0x0a, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01,
	...
	0x65, 0x48, 0x00, 0x52, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x88, 0x01, 0x01, 0x12, 0x1d, 0x0a,
	0x0a, 0x66, 0x69, 0x6c, 0x65, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x09, 0x66, 0x69, 0x6c, 0x65, 0x50, 0x61, 0x74, 0x68, 0x73, 0x12, 0x12, 0x0a, 0x04,
	...
	,
	...
	,
	...
	0x65, 0x22, 0x13, 0x0a, 0x11, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x50, 0x61, 0x72, 0x73,
	0x65, 0x72, 0x53, 0x70, 0x65, 0x63, 0x22, 0xe6, 0x01, 0x0a, 0x12, 0x50, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x50, 0x61, 0x72, 0x73, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x3e, 0x0a,
	...
	,
	...
	0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0xf0,
	0x02, 0x0a, 0x0a, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x70, 0x65, 0x63, 0x12, 0x29, 0x0a,
	0x10, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f,
	0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x43,
	0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x25, 0x0a, 0x0e, 0x73, 0x69, 0x6e, 0x6b,
	0x5f, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0d, 0x73, 0x69, 0x6e, 0x6b, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12,
	...
	0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x12, 0x44, 0x0a, 0x10, 0x72, 0x65, 0x66, 0x72,
	0x65, 0x73, 0x68, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x18, 0x05, 0x20, 0x01,
	...
	,
	...
	0x74, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x70, 0x65, 0x63, 0x5f, 0x68, 0x61,
	0x73, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x70, 0x65, 0x63, 0x48, 0x61,
	0x73, 0x68, 0x12, 0x3d, 0x0a, 0x0c, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x65, 0x64, 0x5f,
	...
	0x6e, 0x22, 0x6a, 0x0a, 0x05, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x2e, 0x0a, 0x04, 0x73, 0x70,
	...
	0x6c, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0xec, 0x0b,
	...
	,
	...
	0x72, 0x65, 0x66, 0x73, 0x48, 0x61, 0x73, 0x68, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x65, 0x73, 0x74,
	0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x1b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x65, 0x73,
	0x74, 0x48, 0x61, 0x73, 0x68, 0x12, 0x1f, 0x0a, 0x0b, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x65, 0x72,
	0x72, 0x6f, 0x72, 0x73, 0x18, 0x1c, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x74, 0x65, 0x73, 0x74,
	0x45, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x77,
	0x61, 0x72, 0x6e, 0x69, 0x6e, 0x67, 0x73, 0x18, 0x1e, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0c, 0x74,
	0x65, 0x73, 0x74, 0x57, 0x61, 0x72, 0x6e, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x3d, 0x0a, 0x0c, 0x72,
	...
	0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x65, 0x64, 0x4f, 0x6e, 0x12, 0x44, 0x0a, 0x11, 0x69, 0x6e,
	0x63, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x6c, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18,
	...
	0x69, 0x6e, 0x63, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x65,
	0x12, 0x55, 0x0a, 0x18, 0x69, 0x6e, 0x63, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x6c, 0x5f,
	0x73, 0x74, 0x61, 0x74, 0x65, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x08, 0x20, 0x01,
	...
	,
	...
	0x73, 0x22, 0x7c, 0x0a, 0x0b, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x56, 0x69, 0x65, 0x77,
	...
	0x8a, 0x22, 0x0a, 0x0f, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x56, 0x69, 0x65, 0x77, 0x53,
	0x70, 0x65, 0x63, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x18, 0x1e, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x63,
	...
	0x61, 0x62, 0x61, 0x73, 0x65, 0x18, 0x15, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x61, 0x74,
	0x61, 0x62, 0x61, 0x73, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73,
	0x65, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x16, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e,
	...
	0x61, 0x62, 0x6c, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x18, 0x18, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x21, 0x0a, 0x0c, 0x64, 0x69,
	...
	0x6e, 0x73, 0x18, 0x1c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x61, 0x69, 0x49, 0x6e, 0x73, 0x74,
	0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x25, 0x0a, 0x0e, 0x74, 0x69, 0x6d, 0x65,
	...
	0x5f, 0x67, 0x72, 0x61, 0x69, 0x6e, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x72,
	...
	0x73, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x47, 0x72, 0x61, 0x69, 0x6e, 0x12, 0x31, 0x0a, 0x14, 0x77,
	0x61, 0x74, 0x65, 0x72, 0x6d, 0x61, 0x72, 0x6b, 0x5f, 0x65, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x18, 0x14, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x77, 0x61, 0x74, 0x65, 0x72,
	0x6d, 0x61, 0x72, 0x6b, 0x45, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x26,
	0x0a, 0x0f, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x72, 0x61, 0x6e, 0x67,
	0x65, 0x18, 0x25, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x64, 0x61, 0x74, 0x61, 0x54, 0x69, 0x6d,
	0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x4a, 0x0a, 0x0a, 0x64, 0x69, 0x6d, 0x65, 0x6e, 0x73,
	...
	,
	...
	,
	...
	0x74, 0x61, 0x67, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x18, 0x02,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x02, 0x20,
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x6f, 0x64,
	0x65, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x12,
	0x26, 0x0a, 0x0f, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x72, 0x61, 0x6e,
	0x67, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x64, 0x61, 0x74, 0x61, 0x54, 0x69,
	0x6d, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x39, 0x0a, 0x0a, 0x74, 0x69, 0x6d, 0x65, 0x5f,
	0x67, 0x72, 0x61, 0x69, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x72, 0x69,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x22, 0xb0, 0x02, 0x0a, 0x17, 0x53, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x52, 0x75,
	...
	,
	...
	,
	...
	0x6f, 0x72, 0x65, 0x53, 0x70, 0x65, 0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x12, 0x33, 0x0a,
	0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x72,
	0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x45,
	0x78, 0x70, 0x6c, 0x6f, 0x72, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61,
	0x74, 0x65, 0x22, 0xf0, 0x06, 0x0a, 0x0b, 0x45, 0x78, 0x70, 0x6c, 0x6f, 0x72, 0x65, 0x53, 0x70,
	...
	,
	...
	0x72, 0x65, 0x73, 0x5f, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x0e, 0x20, 0x01,
	...
	,
	...
	,
	...
	0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x65, 0x64, 0x4f, 0x6e, 0x22, 0x8b, 0x01, 0x0a, 0x10,
	0x45, 0x78, 0x70, 0x6c, 0x6f, 0x72, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65,
	0x12, 0x14, 0x0a, 0x05, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x61, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x72,
	0x69, 0x73, 0x6f, 0x6e, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x73,
	...
	0x6e, 0x67, 0x65, 0x52, 0x14, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x72, 0x69, 0x73, 0x6f, 0x6e, 0x54,
	0x69, 0x6d, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x22, 0x4a, 0x0a, 0x1a, 0x45, 0x78, 0x70,
	0x6c, 0x6f, 0x72, 0x65, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x72, 0x69, 0x73, 0x6f, 0x6e, 0x54, 0x69,
	0x6d, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65,
	...
	0x72, 0x61, 0x6e, 0x67, 0x65, 0x22, 0xe3, 0x13, 0x0a, 0x0d, 0x45, 0x78, 0x70, 0x6c, 0x6f, 0x72,
	0x65, 0x50, 0x72, 0x65, 0x73, 0x65, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x64, 0x69, 0x6d, 0x65, 0x6e,
	0x73, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x64, 0x69, 0x6d,
	0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x4f, 0x0a, 0x13, 0x64, 0x69, 0x6d, 0x65, 0x6e,
	0x73, 0x69, 0x6f, 0x6e, 0x73, 0x5f, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x09,
	...
	0x75, 0x72, 0x65, 0x73, 0x12, 0x4b, 0x0a, 0x11, 0x6d, 0x65, 0x61, 0x73, 0x75, 0x72, 0x65, 0x73,
	...
	,
	...
	0x06, 0x52, 0x10, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x72, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x52, 0x61,
	...
	0x20, 0x01, 0x28, 0x09, 0x48, 0x07, 0x52, 0x13, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x72, 0x69, 0x73,
	...
	0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x45,
	0x78, 0x70, 0x6c, 0x6f, 0x72, 0x65, 0x57, 0x65, 0x62, 0x56, 0x69, 0x65, 0x77, 0x48, 0x08, 0x52,
	...
	0x09, 0x48, 0x09, 0x52, 0x0d, 0x65, 0x78, 0x70, 0x6c, 0x6f, 0x72, 0x65, 0x53, 0x6f, 0x72, 0x74,
	...
	0x0a, 0x52, 0x0e, 0x65, 0x78, 0x70, 0x6c, 0x6f, 0x72, 0x65, 0x53, 0x6f, 0x72, 0x74, 0x41, 0x73,
	...
	0x65, 0x48, 0x0b, 0x52, 0x0f, 0x65, 0x78, 0x70, 0x6c, 0x6f, 0x72, 0x65, 0x53, 0x6f, 0x72, 0x74,
	...
	0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x14, 0x20, 0x01, 0x28, 0x09, 0x48, 0x0c, 0x52, 0x18, 0x65,
	...
	0x1e, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x0d, 0x52, 0x1e, 0x65, 0x78, 0x70, 0x6c, 0x6f, 0x72, 0x65,
	...
	0x73, 0x18, 0x20, 0x20, 0x01, 0x28, 0x08, 0x48, 0x0e, 0x52, 0x2b, 0x65, 0x78, 0x70, 0x6c, 0x6f,
	...
	0x75, 0x72, 0x65, 0x18, 0x15, 0x20, 0x01, 0x28, 0x09, 0x48, 0x0f, 0x52, 0x14, 0x74, 0x69, 0x6d,
	...
	0x65, 0x18, 0x16, 0x20, 0x01, 0x28, 0x09, 0x48, 0x10, 0x52, 0x16, 0x74, 0x69, 0x6d, 0x65, 0x44,
	...
	0x48, 0x11, 0x52, 0x10, 0x74, 0x69, 0x6d, 0x65, 0x44, 0x69, 0x6d, 0x65, 0x6e, 0x73, 0x69, 0x6f,
	...
	0x6f, 0x72, 0x74, 0x5f, 0x62, 0x79, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x09, 0x48, 0x12, 0x52, 0x0b,
	...
	0x18, 0x1b, 0x20, 0x01, 0x28, 0x08, 0x48, 0x13, 0x52, 0x0c, 0x70, 0x69, 0x76, 0x6f, 0x74, 0x53,
	...
	,
	...
	0x75, 0x65, 0x73, 0x22, 0x76, 0x0a, 0x09, 0x4d, 0x69, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x6f, 0x6e, 0x22, 0x6d, 0x0a, 0x06, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x2f, 0x0a, 0x04,
	...
	0x6f, 0x72, 0x74, 0x53, 0x70, 0x65, 0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x12, 0x32, 0x0a,
	...
	0x65, 0x70, 0x6f, 0x72, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74,
	0x65, 0x22, 0x8f, 0x07, 0x0a, 0x0a, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x53, 0x70, 0x65, 0x63,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x12, 0x44, 0x0a,
	...
	0x72, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x72, 0x18, 0x11, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x71, 0x75, 0x65, 0x72, 0x79, 0x4e, 0x61, 0x6d,
	0x65, 0x12, 0x26, 0x0a, 0x0f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x5f, 0x61, 0x72, 0x67, 0x73, 0x5f,
	0x6a, 0x73, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x71, 0x75, 0x65, 0x72,
	0x79, 0x41, 0x72, 0x67, 0x73, 0x4a, 0x73, 0x6f, 0x6e, 0x12, 0x21, 0x0a, 0x0c, 0x65, 0x78, 0x70,
	0x6f, 0x72, 0x74, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x0b, 0x65, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x12, 0x42, 0x0a, 0x0d,
	0x65, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x18, 0x08, 0x20,
	...
	0x61, 0x64, 0x65, 0x72, 0x12, 0x37, 0x0a, 0x09, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72,
	0x73, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x72,
	0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69,
	0x65, 0x72, 0x52, 0x09, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x73, 0x12, 0x4e, 0x0a,
	...
	,
	...
	,
	...
	0x74, 0x65, 0x22, 0xf8, 0x08, 0x0a, 0x09, 0x41, 0x6c, 0x65, 0x72, 0x74, 0x53, 0x70, 0x65, 0x63,
	0x12, 0x21, 0x0a, 0x0c, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x4e,
	0x61, 0x6d, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x12, 0x44, 0x0a,
	...
	,
	...
	,
	...
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0e, 0x71, 0x75,
	...
	,
	...
	0x18, 0x14, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75,
	...
	0x42, 0x0b, 0x0a, 0x09, 0x71, 0x75, 0x65, 0x72, 0x79, 0x5f, 0x66, 0x6f, 0x72, 0x22, 0x61, 0x0a,
	0x08, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x6f, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x74, 0x6f, 0x72, 0x79, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x72, 0x69,
	0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x49,
	0x45, 0x76, 0x61, 0x6c, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x10, 0x65,
	...
	0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74,
	0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xb6, 0x03, 0x0a, 0x0f, 0x41, 0x49, 0x45,
	0x76, 0x61, 0x6c, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05,
	0x61, 0x64, 0x68, 0x6f, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x61, 0x64, 0x68,
	0x6f, 0x63, 0x12, 0x23, 0x0a, 0x0d, 0x74, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x5f, 0x63, 0x61,
	0x73, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0c, 0x74, 0x72, 0x69, 0x67, 0x67,
	0x65, 0x72, 0x43, 0x61, 0x73, 0x65, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x65, 0x72, 0x72, 0x6f, 0x72,
	...
	0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x65, 0x64, 0x12, 0x39, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x72,
	...
	,
	...
	0x0a, 0x0e, 0x61, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x5f, 0x70, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x61, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x50, 0x72,
	0x65, 0x76, 0x69, 0x65, 0x77, 0x12, 0x39, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x72, 0x74, 0x65, 0x64,
	...
	0x70, 0x52, 0x0a, 0x66, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x65, 0x64, 0x4f, 0x6e, 0x22, 0x85, 0x01,
	0x0a, 0x0e, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72,
	...
	0x70, 0x65, 0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x12, 0x3a, 0x0a, 0x05, 0x73, 0x74, 0x61,
	0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e,
	0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x66, 0x72, 0x65,
	0x73, 0x68, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05,
	0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0xca, 0x01, 0x0a, 0x12, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73,
	0x68, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x53, 0x70, 0x65, 0x63, 0x12, 0x3b, 0x0a, 0x09,
	...
	0x65, 0x6c, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x72, 0x69, 0x6c, 0x6c,
	...
	,
	...
	,
	...
	0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0x98, 0x03, 0x0a, 0x09,
	...
	0x6e, 0x64, 0x61, 0x72, 0x79, 0x43, 0x6f, 0x6c, 0x6f, 0x72, 0x52, 0x61, 0x77, 0x12, 0x37, 0x0a,
	0x05, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x72,
	0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x54,
	0x68, 0x65, 0x6d, 0x65, 0x43, 0x6f, 0x6c, 0x6f, 0x72, 0x73, 0x48, 0x02, 0x52, 0x05, 0x6c, 0x69,
	0x67, 0x68, 0x74, 0x88, 0x01, 0x01, 0x12, 0x35, 0x0a, 0x04, 0x64, 0x61, 0x72, 0x6b, 0x18, 0x06,
	...
	0x72, 0x73, 0x48, 0x03, 0x52, 0x04, 0x64, 0x61, 0x72, 0x6b, 0x88, 0x01, 0x01, 0x42, 0x10, 0x0a,
	...
	0x6c, 0x6f, 0x72, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x42, 0x07, 0x0a,
	0x05, 0x5f, 0x64, 0x61, 0x72, 0x6b, 0x22, 0x0c, 0x0a, 0x0a, 0x54, 0x68, 0x65, 0x6d, 0x65, 0x53,
	0x74, 0x61, 0x74, 0x65, 0x22, 0xce, 0x01, 0x0a, 0x0b, 0x54, 0x68, 0x65, 0x6d, 0x65, 0x43, 0x6f,
	0x6c, 0x6f, 0x72, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x12, 0x1c,
	0x0a, 0x09, 0x73, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x61, 0x72, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x09, 0x73, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x61, 0x72, 0x79, 0x12, 0x49, 0x0a, 0x09,
	...
	0x31, 0x2e, 0x54, 0x68, 0x65, 0x6d, 0x65, 0x43, 0x6f, 0x6c, 0x6f, 0x72, 0x73, 0x2e, 0x56, 0x61,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x76, 0x0a, 0x09, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65,
	0x6e, 0x74, 0x12, 0x32, 0x0a, 0x04, 0x73, 0x70, 0x65, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	...
	0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0xdc, 0x02,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x65, 0x72,
	...
	0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x12, 0x38, 0x0a, 0x05, 0x69, 0x6e,
	0x70, 0x75, 0x74, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x72, 0x69, 0x6c, 0x6c,
	0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6f, 0x6d, 0x70,
	0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x05, 0x69,
	0x6e, 0x70, 0x75, 0x74, 0x12, 0x3a, 0x0a, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x18, 0x09,
	...
	0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74,
	0x12, 0x2a, 0x0a, 0x11, 0x64, 0x65, 0x66, 0x69, 0x6e, 0x65, 0x64, 0x5f, 0x69, 0x6e, 0x5f, 0x63,
	0x61, 0x6e, 0x76, 0x61, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x64, 0x65, 0x66,
	0x69, 0x6e, 0x65, 0x64, 0x49, 0x6e, 0x43, 0x61, 0x6e, 0x76, 0x61, 0x73, 0x22, 0x97, 0x01, 0x0a,
	0x0e, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12,
	0x3d, 0x0a, 0x0a, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69,
	...
	0x73, 0x68, 0x65, 0x64, 0x4f, 0x6e, 0x22, 0x78, 0x0a, 0x11, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e,
	...
	0x22, 0x6d, 0x0a, 0x06, 0x43, 0x61, 0x6e, 0x76, 0x61, 0x73, 0x12, 0x2f, 0x0a, 0x04, 0x73, 0x70,
	...
	0x73, 0x53, 0x70, 0x65, 0x63, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x12, 0x32, 0x0a, 0x05, 0x73,
	...
	,
	...
	0x65, 0x64, 0x5f, 0x74, 0x68, 0x65, 0x6d, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a,
	0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31,
	...
	,
	...
	0x65, 0x74, 0x12, 0x40, 0x0a, 0x09, 0x76, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x18,
	...
	,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x43, 0x61, 0x6e, 0x76, 0x61, 0x73, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x41,
	...
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52,
	0x0f, 0x64, 0x61, 0x74, 0x61, 0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x65, 0x64, 0x4f, 0x6e,
	0x22, 0xc5, 0x01, 0x0a, 0x09, 0x43, 0x61, 0x6e, 0x76, 0x61, 0x73, 0x52, 0x6f, 0x77, 0x12, 0x1b,
	...
	,
	...
	,
	...
	0x6e, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x36, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x72, 0x69,
	0x73, 0x6f, 0x6e, 0x5f, 0x64, 0x69, 0x6d, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x08, 0x20,
	0x01, 0x28, 0x09, 0x48, 0x01, 0x52, 0x13, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x72, 0x69, 0x73, 0x6f,
	0x6e, 0x44, 0x69, 0x6d, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x12, 0x4e, 0x0a,
	0x0b, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x5f, 0x65, 0x78, 0x70, 0x72, 0x18, 0x13, 0x20, 0x03,
	...
	0x74, 0x2e, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x45, 0x78, 0x70, 0x72, 0x45, 0x6e, 0x74, 0x72,
	0x79, 0x52, 0x0a, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x45, 0x78, 0x70, 0x72, 0x1a, 0x67, 0x0a,
	0x0f, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x45, 0x78, 0x70, 0x72, 0x45, 0x6e, 0x74, 0x72, 0x79,
	0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b,
	...
	,
	...
	,
	...
	0x65, 0x22, 0xbf, 0x01, 0x0a, 0x0a, 0x50, 0x61, 0x72, 0x73, 0x65, 0x45, 0x72, 0x72, 0x6f, 0x72,
	...
	,
	...
	,
...
var file_rill_runtime_v1_resources_proto_msgTypes = make([]protoimpl.MessageInfo, 94)
var file_rill_runtime_v1_resources_proto_goTypes = []any{
	...
	(AIEvalVerdict)(0),                        // 6: rill.runtime.v1.AIEvalVerdict
	...
	(*AIEval)(nil),                            // 51: rill.runtime.v1.AIEval
	(*AIEvalSpec)(nil),                        // 52: rill.runtime.v1.AIEvalSpec
	(*AIEvalCase)(nil),                        // 53: rill.runtime.v1.AIEvalCase
	(*AIEvalState)(nil),                       // 54: rill.runtime.v1.AIEvalState
	(*AIEvalExecution)(nil),                   // 55: rill.runtime.v1.AIEvalExecution
	(*AIEvalCaseResult)(nil),                  // 56: rill.runtime.v1.AIEvalCaseResult
	(*RefreshTrigger)(nil),                    // 57: rill.runtime.v1.RefreshTrigger
	(*RefreshTriggerSpec)(nil),                // 58: rill.runtime.v1.RefreshTriggerSpec
	(*RefreshTriggerState)(nil),               // 59: rill.runtime.v1.RefreshTriggerState
	(*AIEvalTrigger)(nil),                     // 60: rill.runtime.v1.AIEvalTrigger
	(*RefreshModelTrigger)(nil),               // 61: rill.runtime.v1.RefreshModelTrigger
	(*Theme)(nil),                             // 62: rill.runtime.v1.Theme
	(*ThemeSpec)(nil),                         // 63: rill.runtime.v1.ThemeSpec
	(*ThemeState)(nil),                        // 64: rill.runtime.v1.ThemeState
	(*ThemeColors)(nil),                       // 65: rill.runtime.v1.ThemeColors
	(*Component)(nil),                         // 66: rill.runtime.v1.Component
	(*ComponentSpec)(nil),                     // 67: rill.runtime.v1.ComponentSpec
	(*ComponentState)(nil),                    // 68: rill.runtime.v1.ComponentState
	(*ComponentVariable)(nil),                 // 69: rill.runtime.v1.ComponentVariable
	(*Canvas)(nil),                            // 70: rill.runtime.v1.Canvas
	(*CanvasSpec)(nil),                        // 71: rill.runtime.v1.CanvasSpec
	(*CanvasState)(nil),                       // 72: rill.runtime.v1.CanvasState
	(*CanvasRow)(nil),                         // 73: rill.runtime.v1.CanvasRow
	(*CanvasTabGroup)(nil),                    // 74: rill.runtime.v1.CanvasTabGroup
	(*CanvasTab)(nil),                         // 75: rill.runtime.v1.CanvasTab
	(*CanvasItem)(nil),                        // 76: rill.runtime.v1.CanvasItem
	(*CanvasPreset)(nil),                      // 77: rill.runtime.v1.CanvasPreset
	(*DefaultMetricsSQLFilter)(nil),           // 78: rill.runtime.v1.DefaultMetricsSQLFilter
	(*API)(nil),                               // 79: rill.runtime.v1.API
	(*APISpec)(nil),                           // 80: rill.runtime.v1.APISpec
	(*APIState)(nil),                          // 81: rill.runtime.v1.APIState
	(*Schedule)(nil),                          // 82: rill.runtime.v1.Schedule
	(*ParseError)(nil),                        // 83: rill.runtime.v1.ParseError
	(*ValidationError)(nil),                   // 84: rill.runtime.v1.ValidationError
	(*DependencyError)(nil),                   // 85: rill.runtime.v1.DependencyError
	(*ExecutionError)(nil),                    // 86: rill.runtime.v1.ExecutionError
	(*CharLocation)(nil),                      // 87: rill.runtime.v1.CharLocation
	(*ConnectorV2)(nil),                       // 88: rill.runtime.v1.ConnectorV2
	(*ConnectorSpec)(nil),                     // 89: rill.runtime.v1.ConnectorSpec
	(*ConnectorState)(nil),                    // 90: rill.runtime.v1.ConnectorState
	(*MetricsViewSpec_Dimension)(nil),         // 91: rill.runtime.v1.MetricsViewSpec.Dimension
	(*MetricsViewSpec_DimensionSelector)(nil), // 92: rill.runtime.v1.MetricsViewSpec.DimensionSelector
	(*MetricsViewSpec_MeasureWindow)(nil),     // 93: rill.runtime.v1.MetricsViewSpec.MeasureWindow
	(*MetricsViewSpec_Measure)(nil),           // 94: rill.runtime.v1.MetricsViewSpec.Measure
	(*MetricsViewSpec_Annotation)(nil),        // 95: rill.runtime.v1.MetricsViewSpec.Annotation
	(*MetricsViewSpec_Rollup)(nil),            // 96: rill.runtime.v1.MetricsViewSpec.Rollup
	nil,                                       // 97: rill.runtime.v1.MetricsViewSpec.QueryAttributesEntry
	nil,                                       // 98: rill.runtime.v1.ReportSpec.AnnotationsEntry
	nil,                                       // 99: rill.runtime.v1.AlertSpec.AnnotationsEntry
	nil,                                       // 100: rill.runtime.v1.ThemeColors.VariablesEntry
	nil,                                       // 101: rill.runtime.v1.CanvasSpec.AnnotationsEntry
	nil,                                       // 102: rill.runtime.v1.CanvasPreset.FilterExprEntry
	(*timestamppb.Timestamp)(nil),             // 103: google.protobuf.Timestamp
	(*structpb.Struct)(nil),                   // 104: google.protobuf.Struct
	(*StructType)(nil),                        // 105: rill.runtime.v1.StructType
	(TimeGrain)(0),                            // 106: rill.runtime.v1.TimeGrain
	(*Expression)(nil),                        // 107: rill.runtime.v1.Expression
	(ExportFormat)(0),                         // 108: rill.runtime.v1.ExportFormat
	(*Color)(nil),                             // 109: rill.runtime.v1.Color
	(*structpb.Value)(nil),                    // 110: google.protobuf.Value
	(*Type)(nil),                              // 111: rill.runtime.v1.Type
}
var file_rill_runtime_v1_resources_proto_depIdxs = []int32{
	...
	57,  // 9: rill.runtime.v1.Resource.refresh_trigger:type_name -> rill.runtime.v1.RefreshTrigger
	62,  // 10: rill.runtime.v1.Resource.theme:type_name -> rill.runtime.v1.Theme
	66,  // 11: rill.runtime.v1.Resource.component:type_name -> rill.runtime.v1.Component
	70,  // 12: rill.runtime.v1.Resource.canvas:type_name -> rill.runtime.v1.Canvas
	79,  // 13: rill.runtime.v1.Resource.api:type_name -> rill.runtime.v1.API
	88,  // 14: rill.runtime.v1.Resource.connector:type_name -> rill.runtime.v1.ConnectorV2
	51,  // 15: rill.runtime.v1.Resource.ai_eval:type_name -> rill.runtime.v1.AIEval
	11,  // 16: rill.runtime.v1.ResourceMeta.name:type_name -> rill.runtime.v1.ResourceName
	...
	103, // 19: rill.runtime.v1.ResourceMeta.created_on:type_name -> google.protobuf.Timestamp
	103, // 20: rill.runtime.v1.ResourceMeta.spec_updated_on:type_name -> google.protobuf.Timestamp
	103, // 21: rill.runtime.v1.ResourceMeta.state_updated_on:type_name -> google.protobuf.Timestamp
	103, // 22: rill.runtime.v1.ResourceMeta.deleted_on:type_name -> google.protobuf.Timestamp
	0,   // 23: rill.runtime.v1.ResourceMeta.reconcile_status:type_name -> rill.runtime.v1.ReconcileStatus
	103, // 24: rill.runtime.v1.ResourceMeta.reconcile_on:type_name -> google.protobuf.Timestamp
	11,  // 25: rill.runtime.v1.ResourceMeta.renamed_from:type_name -> rill.runtime.v1.ResourceName
	13,  // 26: rill.runtime.v1.ProjectParser.spec:type_name -> rill.runtime.v1.ProjectParserSpec
	14,  // 27: rill.runtime.v1.ProjectParser.state:type_name -> rill.runtime.v1.ProjectParserState
	83,  // 28: rill.runtime.v1.ProjectParserState.parse_errors:type_name -> rill.runtime.v1.ParseError
	103, // 29: rill.runtime.v1.ProjectParserState.current_commit_on:type_name -> google.protobuf.Timestamp
	16,  // 30: rill.runtime.v1.Source.spec:type_name -> rill.runtime.v1.SourceSpec
	17,  // 31: rill.runtime.v1.Source.state:type_name -> rill.runtime.v1.SourceState
	104, // 32: rill.runtime.v1.SourceSpec.properties:type_name -> google.protobuf.Struct
	82,  // 33: rill.runtime.v1.SourceSpec.refresh_schedule:type_name -> rill.runtime.v1.Schedule
	103, // 34: rill.runtime.v1.SourceState.refreshed_on:type_name -> google.protobuf.Timestamp
	19,  // 35: rill.runtime.v1.Model.spec:type_name -> rill.runtime.v1.ModelSpec
	20,  // 36: rill.runtime.v1.Model.state:type_name -> rill.runtime.v1.ModelState
	82,  // 37: rill.runtime.v1.ModelSpec.refresh_schedule:type_name -> rill.runtime.v1.Schedule
	104, // 38: rill.runtime.v1.ModelSpec.incremental_state_resolver_properties:type_name -> google.protobuf.Struct
	104, // 39: rill.runtime.v1.ModelSpec.partitions_resolver_properties:type_name -> google.protobuf.Struct
	104, // 40: rill.runtime.v1.ModelSpec.input_properties:type_name -> google.protobuf.Struct
	104, // 41: rill.runtime.v1.ModelSpec.stage_properties:type_name -> google.protobuf.Struct
	104, // 42: rill.runtime.v1.ModelSpec.output_properties:type_name -> google.protobuf.Struct
	1,   // 43: rill.runtime.v1.ModelSpec.change_mode:type_name -> rill.runtime.v1.ModelChangeMode
	21,  // 44: rill.runtime.v1.ModelSpec.tests:type_name -> rill.runtime.v1.ModelTest
	104, // 45: rill.runtime.v1.ModelState.result_properties:type_name -> google.protobuf.Struct
	103, // 46: rill.runtime.v1.ModelState.refreshed_on:type_name -> google.protobuf.Timestamp
	104, // 47: rill.runtime.v1.ModelState.incremental_state:type_name -> google.protobuf.Struct
	105, // 48: rill.runtime.v1.ModelState.incremental_state_schema:type_name -> rill.runtime.v1.StructType
	104, // 49: rill.runtime.v1.ModelTest.resolver_properties:type_name -> google.protobuf.Struct
	23,  // 50: rill.runtime.v1.MetricsView.spec:type_name -> rill.runtime.v1.MetricsViewSpec
	29,  // 51: rill.runtime.v1.MetricsView.state:type_name -> rill.runtime.v1.MetricsViewState
	106, // 52: rill.runtime.v1.MetricsViewSpec.smallest_time_grain:type_name -> rill.runtime.v1.TimeGrain
	91,  // 53: rill.runtime.v1.MetricsViewSpec.dimensions:type_name -> rill.runtime.v1.MetricsViewSpec.Dimension
	94,  // 54: rill.runtime.v1.MetricsViewSpec.measures:type_name -> rill.runtime.v1.MetricsViewSpec.Measure
	36,  // 55: rill.runtime.v1.MetricsViewSpec.parent_dimensions:type_name -> rill.runtime.v1.FieldSelector
	36,  // 56: rill.runtime.v1.MetricsViewSpec.parent_measures:type_name -> rill.runtime.v1.FieldSelector
	95,  // 57: rill.runtime.v1.MetricsViewSpec.annotations:type_name -> rill.runtime.v1.MetricsViewSpec.Annotation
	24,  // 58: rill.runtime.v1.MetricsViewSpec.security_rules:type_name -> rill.runtime.v1.SecurityRule
	97,  // 59: rill.runtime.v1.MetricsViewSpec.query_attributes:type_name -> rill.runtime.v1.MetricsViewSpec.QueryAttributesEntry
	96,  // 60: rill.runtime.v1.MetricsViewSpec.rollups:type_name -> rill.runtime.v1.MetricsViewSpec.Rollup
	25,  // 61: rill.runtime.v1.SecurityRule.access:type_name -> rill.runtime.v1.SecurityRuleAccess
	26,  // 62: rill.runtime.v1.SecurityRule.field_access:type_name -> rill.runtime.v1.SecurityRuleFieldAccess
	27,  // 63: rill.runtime.v1.SecurityRule.row_filter:type_name -> rill.runtime.v1.SecurityRuleRowFilter
	28,  // 64: rill.runtime.v1.SecurityRule.transitive_access:type_name -> rill.runtime.v1.SecurityRuleTransitiveAccess
	11,  // 65: rill.runtime.v1.SecurityRuleAccess.condition_resources:type_name -> rill.runtime.v1.ResourceName
	11,  // 66: rill.runtime.v1.SecurityRuleFieldAccess.condition_resources:type_name -> rill.runtime.v1.ResourceName
	11,  // 67: rill.runtime.v1.SecurityRuleRowFilter.condition_resources:type_name -> rill.runtime.v1.ResourceName
	107, // 68: rill.runtime.v1.SecurityRuleRowFilter.expression:type_name -> rill.runtime.v1.Expression
	11,  // 69: rill.runtime.v1.SecurityRuleTransitiveAccess.resource:type_name -> rill.runtime.v1.ResourceName
	23,  // 70: rill.runtime.v1.MetricsViewState.valid_spec:type_name -> rill.runtime.v1.MetricsViewSpec
	103, // 71: rill.runtime.v1.MetricsViewState.data_refreshed_on:type_name -> google.protobuf.Timestamp
	31,  // 72: rill.runtime.v1.Explore.spec:type_name -> rill.runtime.v1.ExploreSpec
	32,  // 73: rill.runtime.v1.Explore.state:type_name -> rill.runtime.v1.ExploreState
	36,  // 74: rill.runtime.v1.ExploreSpec.dimensions_selector:type_name -> rill.runtime.v1.FieldSelector
	36,  // 75: rill.runtime.v1.ExploreSpec.measures_selector:type_name -> rill.runtime.v1.FieldSelector
	63,  // 76: rill.runtime.v1.ExploreSpec.embedded_theme:type_name -> rill.runtime.v1.ThemeSpec
	33,  // 77: rill.runtime.v1.ExploreSpec.time_ranges:type_name -> rill.runtime.v1.ExploreTimeRange
	35,  // 78: rill.runtime.v1.ExploreSpec.default_preset:type_name -> rill.runtime.v1.ExplorePreset
	24,  // 79: rill.runtime.v1.ExploreSpec.security_rules:type_name -> rill.runtime.v1.SecurityRule
	31,  // 80: rill.runtime.v1.ExploreState.valid_spec:type_name -> rill.runtime.v1.ExploreSpec
	103, // 81: rill.runtime.v1.ExploreState.data_refreshed_on:type_name -> google.protobuf.Timestamp
	34,  // 82: rill.runtime.v1.ExploreTimeRange.comparison_time_ranges:type_name -> rill.runtime.v1.ExploreComparisonTimeRange
	36,  // 83: rill.runtime.v1.ExplorePreset.dimensions_selector:type_name -> rill.runtime.v1.FieldSelector
	36,  // 84: rill.runtime.v1.ExplorePreset.measures_selector:type_name -> rill.runtime.v1.FieldSelector
	107, // 85: rill.runtime.v1.ExplorePreset.where:type_name -> rill.runtime.v1.Expression
	2,   // 86: rill.runtime.v1.ExplorePreset.comparison_mode:type_name -> rill.runtime.v1.ExploreComparisonMode
	3,   // 87: rill.runtime.v1.ExplorePreset.view:type_name -> rill.runtime.v1.ExploreWebView
	4,   // 88: rill.runtime.v1.ExplorePreset.explore_sort_type:type_name -> rill.runtime.v1.ExploreSortType
	37,  // 89: rill.runtime.v1.FieldSelector.fields:type_name -> rill.runtime.v1.StringListValue
	39,  // 90: rill.runtime.v1.Migration.spec:type_name -> rill.runtime.v1.MigrationSpec
	40,  // 91: rill.runtime.v1.Migration.state:type_name -> rill.runtime.v1.MigrationState
	42,  // 92: rill.runtime.v1.Report.spec:type_name -> rill.runtime.v1.ReportSpec
	43,  // 93: rill.runtime.v1.Report.state:type_name -> rill.runtime.v1.ReportState
	82,  // 94: rill.runtime.v1.ReportSpec.refresh_schedule:type_name -> rill.runtime.v1.Schedule
	104, // 95: rill.runtime.v1.ReportSpec.resolver_properties:type_name -> google.protobuf.Struct
	108, // 96: rill.runtime.v1.ReportSpec.export_format:type_name -> rill.runtime.v1.ExportFormat
	47,  // 97: rill.runtime.v1.ReportSpec.notifiers:type_name -> rill.runtime.v1.Notifier
	98,  // 98: rill.runtime.v1.ReportSpec.annotations:type_name -> rill.runtime.v1.ReportSpec.AnnotationsEntry
	103, // 99: rill.runtime.v1.ReportState.next_run_on:type_name -> google.protobuf.Timestamp
	44,  // 100: rill.runtime.v1.ReportState.current_execution:type_name -> rill.runtime.v1.ReportExecution
	44,  // 101: rill.runtime.v1.ReportState.execution_history:type_name -> rill.runtime.v1.ReportExecution
	103, // 102: rill.runtime.v1.ReportExecution.report_time:type_name -> google.protobuf.Timestamp
	103, // 103: rill.runtime.v1.ReportExecution.started_on:type_name -> google.protobuf.Timestamp
	103, // 104: rill.runtime.v1.ReportExecution.finished_on:type_name -> google.protobuf.Timestamp
	46,  // 105: rill.runtime.v1.Alert.spec:type_name -> rill.runtime.v1.AlertSpec
	48,  // 106: rill.runtime.v1.Alert.state:type_name -> rill.runtime.v1.AlertState
	82,  // 107: rill.runtime.v1.AlertSpec.refresh_schedule:type_name -> rill.runtime.v1.Schedule
	104, // 108: rill.runtime.v1.AlertSpec.resolver_properties:type_name -> google.protobuf.Struct
	104, // 109: rill.runtime.v1.AlertSpec.query_for_attributes:type_name -> google.protobuf.Struct
	47,  // 110: rill.runtime.v1.AlertSpec.notifiers:type_name -> rill.runtime.v1.Notifier
	99,  // 111: rill.runtime.v1.AlertSpec.annotations:type_name -> rill.runtime.v1.AlertSpec.AnnotationsEntry
	104, // 112: rill.runtime.v1.Notifier.properties:type_name -> google.protobuf.Struct
	103, // 113: rill.runtime.v1.AlertState.next_run_on:type_name -> google.protobuf.Timestamp
	49,  // 114: rill.runtime.v1.AlertState.current_execution:type_name -> rill.runtime.v1.AlertExecution
	49,  // 115: rill.runtime.v1.AlertState.execution_history:type_name -> rill.runtime.v1.AlertExecution
	50,  // 116: rill.runtime.v1.AlertExecution.result:type_name -> rill.runtime.v1.AssertionResult
	103, // 117: rill.runtime.v1.AlertExecution.execution_time:type_name -> google.protobuf.Timestamp
	103, // 118: rill.runtime.v1.AlertExecution.started_on:type_name -> google.protobuf.Timestamp
	103, // 119: rill.runtime.v1.AlertExecution.finished_on:type_name -> google.protobuf.Timestamp
	103, // 120: rill.runtime.v1.AlertExecution.suppressed_since:type_name -> google.protobuf.Timestamp
	5,   // 121: rill.runtime.v1.AssertionResult.status:type_name -> rill.runtime.v1.AssertionStatus
	104, // 122: rill.runtime.v1.AssertionResult.fail_row:type_name -> google.protobuf.Struct
	52,  // 123: rill.runtime.v1.AIEval.spec:type_name -> rill.runtime.v1.AIEvalSpec
	54,  // 124: rill.runtime.v1.AIEval.state:type_name -> rill.runtime.v1.AIEvalState
	53,  // 125: rill.runtime.v1.AIEvalSpec.cases:type_name -> rill.runtime.v1.AIEvalCase
	55,  // 126: rill.runtime.v1.AIEvalState.current_execution:type_name -> rill.runtime.v1.AIEvalExecution
	55,  // 127: rill.runtime.v1.AIEvalState.execution_history:type_name -> rill.runtime.v1.AIEvalExecution
	103, // 128: rill.runtime.v1.AIEvalExecution.started_on:type_name -> google.protobuf.Timestamp
	103, // 129: rill.runtime.v1.AIEvalExecution.finished_on:type_name -> google.protobuf.Timestamp
	56,  // 130: rill.runtime.v1.AIEvalExecution.case_results:type_name -> rill.runtime.v1.AIEvalCaseResult
	6,   // 131: rill.runtime.v1.AIEvalCaseResult.verdict:type_name -> rill.runtime.v1.AIEvalVerdict
	103, // 132: rill.runtime.v1.AIEvalCaseResult.started_on:type_name -> google.protobuf.Timestamp
	103, // 133: rill.runtime.v1.AIEvalCaseResult.finished_on:type_name -> google.protobuf.Timestamp
	58,  // 134: rill.runtime.v1.RefreshTrigger.spec:type_name -> rill.runtime.v1.RefreshTriggerSpec
	59,  // 135: rill.runtime.v1.RefreshTrigger.state:type_name -> rill.runtime.v1.RefreshTriggerState
	11,  // 136: rill.runtime.v1.RefreshTriggerSpec.resources:type_name -> rill.runtime.v1.ResourceName
	61,  // 137: rill.runtime.v1.RefreshTriggerSpec.models:type_name -> rill.runtime.v1.RefreshModelTrigger
	60,  // 138: rill.runtime.v1.RefreshTriggerSpec.ai_evals:type_name -> rill.runtime.v1.AIEvalTrigger
	63,  // 139: rill.runtime.v1.Theme.spec:type_name -> rill.runtime.v1.ThemeSpec
	64,  // 140: rill.runtime.v1.Theme.state:type_name -> rill.runtime.v1.ThemeState
	109, // 141: rill.runtime.v1.ThemeSpec.primary_color:type_name -> rill.runtime.v1.Color
	109, // 142: rill.runtime.v1.ThemeSpec.secondary_color:type_name -> rill.runtime.v1.Color
	65,  // 143: rill.runtime.v1.ThemeSpec.light:type_name -> rill.runtime.v1.ThemeColors
	65,  // 144: rill.runtime.v1.ThemeSpec.dark:type_name -> rill.runtime.v1.ThemeColors
	100, // 145: rill.runtime.v1.ThemeColors.variables:type_name -> rill.runtime.v1.ThemeColors.VariablesEntry
	67,  // 146: rill.runtime.v1.Component.spec:type_name -> rill.runtime.v1.ComponentSpec
	68,  // 147: rill.runtime.v1.Component.state:type_name -> rill.runtime.v1.ComponentState
	104, // 148: rill.runtime.v1.ComponentSpec.renderer_properties:type_name -> google.protobuf.Struct
	69,  // 149: rill.runtime.v1.ComponentSpec.input:type_name -> rill.runtime.v1.ComponentVariable
	69,  // 150: rill.runtime.v1.ComponentSpec.output:type_name -> rill.runtime.v1.ComponentVariable
	67,  // 151: rill.runtime.v1.ComponentState.valid_spec:type_name -> rill.runtime.v1.ComponentSpec
	103, // 152: rill.runtime.v1.ComponentState.data_refreshed_on:type_name -> google.protobuf.Timestamp
	110, // 153: rill.runtime.v1.ComponentVariable.default_value:type_name -> google.protobuf.Value
	71,  // 154: rill.runtime.v1.Canvas.spec:type_name -> rill.runtime.v1.CanvasSpec
	72,  // 155: rill.runtime.v1.Canvas.state:type_name -> rill.runtime.v1.CanvasState
	...
	77,  // 158: rill.runtime.v1.CanvasSpec.default_preset:type_name -> rill.runtime.v1.CanvasPreset
	69,  // 159: rill.runtime.v1.CanvasSpec.variables:type_name -> rill.runtime.v1.ComponentVariable
	73,  // 160: rill.runtime.v1.CanvasSpec.rows:type_name -> rill.runtime.v1.CanvasRow
	24,  // 161: rill.runtime.v1.CanvasSpec.security_rules:type_name -> rill.runtime.v1.SecurityRule
	101, // 162: rill.runtime.v1.CanvasSpec.annotations:type_name -> rill.runtime.v1.CanvasSpec.AnnotationsEntry
	71,  // 163: rill.runtime.v1.CanvasState.valid_spec:type_name -> rill.runtime.v1.CanvasSpec
	103, // 164: rill.runtime.v1.CanvasState.data_refreshed_on:type_name -> google.protobuf.Timestamp
	76,  // 165: rill.runtime.v1.CanvasRow.items:type_name -> rill.runtime.v1.CanvasItem
	74,  // 166: rill.runtime.v1.CanvasRow.tab_group:type_name -> rill.runtime.v1.CanvasTabGroup
	75,  // 167: rill.runtime.v1.CanvasTabGroup.tabs:type_name -> rill.runtime.v1.CanvasTab
	73,  // 168: rill.runtime.v1.CanvasTab.rows:type_name -> rill.runtime.v1.CanvasRow
	2,   // 169: rill.runtime.v1.CanvasPreset.comparison_mode:type_name -> rill.runtime.v1.ExploreComparisonMode
	102, // 170: rill.runtime.v1.CanvasPreset.filter_expr:type_name -> rill.runtime.v1.CanvasPreset.FilterExprEntry
	107, // 171: rill.runtime.v1.DefaultMetricsSQLFilter.expression:type_name -> rill.runtime.v1.Expression
	80,  // 172: rill.runtime.v1.API.spec:type_name -> rill.runtime.v1.APISpec
	81,  // 173: rill.runtime.v1.API.state:type_name -> rill.runtime.v1.APIState
	104, // 174: rill.runtime.v1.APISpec.resolver_properties:type_name -> google.protobuf.Struct
	24,  // 175: rill.runtime.v1.APISpec.security_rules:type_name -> rill.runtime.v1.SecurityRule
	87,  // 176: rill.runtime.v1.ParseError.start_location:type_name -> rill.runtime.v1.CharLocation
	89,  // 177: rill.runtime.v1.ConnectorV2.spec:type_name -> rill.runtime.v1.ConnectorSpec
	90,  // 178: rill.runtime.v1.ConnectorV2.state:type_name -> rill.runtime.v1.ConnectorState
	104, // 179: rill.runtime.v1.ConnectorSpec.properties:type_name -> google.protobuf.Struct
	104, // 180: rill.runtime.v1.ConnectorSpec.provision_args:type_name -> google.protobuf.Struct
	7,   // 181: rill.runtime.v1.MetricsViewSpec.Dimension.type:type_name -> rill.runtime.v1.MetricsViewSpec.DimensionType
	106, // 182: rill.runtime.v1.MetricsViewSpec.Dimension.smallest_time_grain:type_name -> rill.runtime.v1.TimeGrain
	111, // 183: rill.runtime.v1.MetricsViewSpec.Dimension.data_type:type_name -> rill.runtime.v1.Type
	106, // 184: rill.runtime.v1.MetricsViewSpec.DimensionSelector.time_grain:type_name -> rill.runtime.v1.TimeGrain
	92,  // 185: rill.runtime.v1.MetricsViewSpec.MeasureWindow.order_by:type_name -> rill.runtime.v1.MetricsViewSpec.DimensionSelector
	8,   // 186: rill.runtime.v1.MetricsViewSpec.Measure.type:type_name -> rill.runtime.v1.MetricsViewSpec.MeasureType
	93,  // 187: rill.runtime.v1.MetricsViewSpec.Measure.window:type_name -> rill.runtime.v1.MetricsViewSpec.MeasureWindow
	92,  // 188: rill.runtime.v1.MetricsViewSpec.Measure.per_dimensions:type_name -> rill.runtime.v1.MetricsViewSpec.DimensionSelector
	...
	104, // 190: rill.runtime.v1.MetricsViewSpec.Measure.format_d3_locale:type_name -> google.protobuf.Struct
	111, // 191: rill.runtime.v1.MetricsViewSpec.Measure.data_type:type_name -> rill.runtime.v1.Type
	36,  // 192: rill.runtime.v1.MetricsViewSpec.Annotation.measures_selector:type_name -> rill.runtime.v1.FieldSelector
	106, // 193: rill.runtime.v1.MetricsViewSpec.Rollup.time_grain:type_name -> rill.runtime.v1.TimeGrain
	36,  // 194: rill.runtime.v1.MetricsViewSpec.Rollup.dimensions_selector:type_name -> rill.runtime.v1.FieldSelector
	36,  // 195: rill.runtime.v1.MetricsViewSpec.Rollup.measures_selector:type_name -> rill.runtime.v1.FieldSelector
	78,  // 196: rill.runtime.v1.CanvasPreset.FilterExprEntry.value:type_name -> rill.runtime.v1.DefaultMetricsSQLFilter
...
func file_rill_runtime_v1_resources_proto_init() {
	...
	file_rill_runtime_v1_resources_proto_msgTypes[54].OneofWrappers = []any{}
	file_rill_runtime_v1_resources_proto_msgTypes[64].OneofWrappers = []any{}
	file_rill_runtime_v1_resources_proto_msgTypes[67].OneofWrappers = []any{}
	file_rill_runtime_v1_resources_proto_msgTypes[68].OneofWrappers = []any{}
	type x struct{}
