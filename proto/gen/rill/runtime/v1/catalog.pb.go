...
// Materialization values for models, specified using @materialize: tag in the comment
type Model_Materialize int32

const (
	// When tag is not specified
	Model_MATERIALIZE_UNSPECIFIED Model_Materialize = 0
	// If its true
	Model_MATERIALIZE_TRUE Model_Materialize = 1
	// If its false
	Model_MATERIALIZE_FALSE Model_Materialize = 2
	// When its not specified by the user but we infer it and set this value
	Model_MATERIALIZE_INFERRED Model_Materialize = 3
	// When tag is specified but value is either empty or invalid
	Model_MATERIALIZE_INVALID Model_Materialize = 4
)

// Enum value maps for Model_Materialize.
var (
	Model_Materialize_name = map[int32]string{
		0: "MATERIALIZE_UNSPECIFIED",
		1: "MATERIALIZE_TRUE",
		2: "MATERIALIZE_FALSE",
		3: "MATERIALIZE_INFERRED",
		4: "MATERIALIZE_INVALID",
	}
	Model_Materialize_value = map[string]int32{
		"MATERIALIZE_UNSPECIFIED": 0,
		"MATERIALIZE_TRUE":        1,
		"MATERIALIZE_FALSE":       2,
		"MATERIALIZE_INFERRED":    3,
		"MATERIALIZE_INVALID":     4,
	}
)

func (x Model_Materialize) Enum() *Model_Materialize {
	p := new(Model_Materialize)
	*p = x
	return p
}

func (x Model_Materialize) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Model_Materialize) Descriptor() protoreflect.EnumDescriptor {
	return file_rill_runtime_v1_catalog_proto_enumTypes[2].Descriptor()
}

func (Model_Materialize) Type() protoreflect.EnumType {
	return &file_rill_runtime_v1_catalog_proto_enumTypes[2]
}

func (x Model_Materialize) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Model_Materialize.Descriptor instead.
func (Model_Materialize) EnumDescriptor() ([]byte, []int) {
	return file_rill_runtime_v1_catalog_proto_rawDescGZIP(), []int{2, 1}
}
...
type Model struct {
	...
	Materialize Model_Materialize `protobuf:"varint,5,opt,name=materialize,proto3,enum=rill.runtime.v1.Model_Materialize" json:"materialize,omitempty"`
}
...
func (x *Model) GetMaterialize() Model_Materialize {
	if x != nil {
		return x.Materialize
	}
	return Model_MATERIALIZE_UNSPECIFIED
}
...
var file_rill_runtime_v1_catalog_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x61, 0x22, 0xa7, 0x03, 0x0a, 0x05, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x12, 0x0a,
	...
	,
	...
	0x77, 0x2e, 0x44, 0x69, 0x6d, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x0a, 0x64, 0x69, 0x6d,
	0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x40, 0x0a, 0x08, 0x6d, 0x65, 0x61, 0x73, 0x75,
	0x72, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x72, 0x69, 0x6c, 0x6c,
	0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x65, 0x74, 0x72,
	0x69, 0x63, 0x73, 0x56, 0x69, 0x65, 0x77, 0x2e, 0x4d, 0x65, 0x61, 0x73, 0x75, 0x72, 0x65, 0x52,
	0x08, 0x6d, 0x65, 0x61, 0x73, 0x75, 0x72, 0x65, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61, 0x62,
	...
	0x6e, 0x1a, 0x57, 0x0a, 0x09, 0x44, 0x69, 0x6d, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x12,
	...
	0x49, 0x43, 0x53, 0x5f, 0x56, 0x49, 0x45, 0x57, 0x10, 0x04, 0x42, 0xb5, 0x01, 0x0a, 0x13, 0x63,
...
var file_rill_runtime_v1_catalog_proto_goTypes = []interface{}{
	...
	(Model_Materialize)(0),        // 2: rill.runtime.v1.Model.Materialize
	...
	(*MetricsView_Dimension)(nil), // 7: rill.runtime.v1.MetricsView.Dimension
	(*MetricsView_Measure)(nil),   // 8: rill.runtime.v1.MetricsView.Measure
	(*StructType)(nil),            // 9: rill.runtime.v1.StructType
	(*structpb.Struct)(nil),       // 10: google.protobuf.Struct
}
var file_rill_runtime_v1_catalog_proto_depIdxs = []int32{
	9,  // 0: rill.runtime.v1.Table.schema:type_name -> rill.runtime.v1.StructType
	10, // 1: rill.runtime.v1.Source.properties:type_name -> google.protobuf.Struct
	9,  // 2: rill.runtime.v1.Source.schema:type_name -> rill.runtime.v1.StructType
	1,  // 3: rill.runtime.v1.Model.dialect:type_name -> rill.runtime.v1.Model.Dialect
	9,  // 4: rill.runtime.v1.Model.schema:type_name -> rill.runtime.v1.StructType
	2,  // 5: rill.runtime.v1.Model.materialize:type_name -> rill.runtime.v1.Model.Materialize
	7,  // 6: rill.runtime.v1.MetricsView.dimensions:type_name -> rill.runtime.v1.MetricsView.Dimension
	8,  // 7: rill.runtime.v1.MetricsView.measures:type_name -> rill.runtime.v1.MetricsView.Measure
