...
type ResolveCanvasResponse struct {
	...
	ResolvedComponents map[string]*ComponentSpec `protobuf:"bytes,2,rep,name=resolved_components,json=resolvedComponents,proto3" json:"resolved_components,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// All the metrics view resources referenced in the components' renderer_properties.metrics_view field.
	ReferencedMetricsViews map[string]*MetricsViewSpec `protobuf:"bytes,3,rep,name=referenced_metrics_views,json=referencedMetricsViews,proto3" json:"referenced_metrics_views,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *ResolveCanvasResponse) GetResolvedComponents() map[string]*ComponentSpec {
	if x != nil {
...
func (x *ResolveCanvasResponse) GetReferencedMetricsViews() map[string]*MetricsViewSpec {
	if x != nil {
...
var file_rill_runtime_v1_queries_proto_rawDesc = []byte{
	...
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e,
	0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x52, 0x04, 0x61, 0x72, 0x67, 0x73, 0x22, 0x8d, 0x04, 0x0a,
	...
	0x69, 0x63, 0x73, 0x56, 0x69, 0x65, 0x77, 0x73, 0x1a, 0x65, 0x0a, 0x17, 0x52, 0x65, 0x73, 0x6f,
	...
	0x6b, 0x0a, 0x1b, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x64, 0x4d, 0x65, 0x74,
	...
	0x63, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x85, 0x01, 0x0a,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x73, 0x22, 0x8c, 0x02, 0x0a,
	...
	0x44, 0x49, 0x41, 0x47, 0x4e, 0x4f, 0x53, 0x54, 0x49, 0x43, 0x10, 0x02, 0x32, 0xd6, 0x28, 0x0a,
	...
	0x6d, 0x65, 0x7d, 0x2f, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x12, 0xa8, 0x01, 0x0a, 0x0d, 0x52,
...
var file_rill_runtime_v1_queries_proto_goTypes = []any{
	...
	(*ComponentSpec)(nil),         // 110: rill.runtime.v1.ComponentSpec
	(*MetricsViewSpec)(nil),       // 111: rill.runtime.v1.MetricsViewSpec
}
var file_rill_runtime_v1_queries_proto_depIdxs = []int32{
	...
	110, // 173: rill.runtime.v1.ResolveCanvasResponse.ResolvedComponentsEntry.value:type_name -> rill.runtime.v1.ComponentSpec
	111, // 174: rill.runtime.v1.ResolveCanvasResponse.ReferencedMetricsViewsEntry.value:type_name -> rill.runtime.v1.MetricsViewSpec
