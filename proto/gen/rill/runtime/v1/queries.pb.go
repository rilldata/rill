...
type MetricsViewMeasureAlias_MeasureType int32

const (
	MetricsViewMeasureAlias_MEASURE_TYPE_UNSPECIFIED      MetricsViewMeasureAlias_MeasureType = 0
	MetricsViewMeasureAlias_MEASURE_TYPE_BASE_VALUE       MetricsViewMeasureAlias_MeasureType = 1
	MetricsViewMeasureAlias_MEASURE_TYPE_COMPARISON_VALUE MetricsViewMeasureAlias_MeasureType = 2
	MetricsViewMeasureAlias_MEASURE_TYPE_ABS_DELTA        MetricsViewMeasureAlias_MeasureType = 3
	MetricsViewMeasureAlias_MEASURE_TYPE_REL_DELTA        MetricsViewMeasureAlias_MeasureType = 4
)

// Enum value maps for MetricsViewMeasureAlias_MeasureType.
var (
	MetricsViewMeasureAlias_MeasureType_name = map[int32]string{
		0: "MEASURE_TYPE_UNSPECIFIED",
		1: "MEASURE_TYPE_BASE_VALUE",
		2: "MEASURE_TYPE_COMPARISON_VALUE",
		3: "MEASURE_TYPE_ABS_DELTA",
		4: "MEASURE_TYPE_REL_DELTA",
	}
	MetricsViewMeasureAlias_MeasureType_value = map[string]int32{
...
func (x MetricsViewMeasureAlias_MeasureType) Enum() *MetricsViewMeasureAlias_MeasureType {
	p := new(MetricsViewMeasureAlias_MeasureType)
	*p = x
	return p
}

func (x MetricsViewMeasureAlias_MeasureType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MetricsViewMeasureAlias_MeasureType) Descriptor() protoreflect.EnumDescriptor {
	return file_rill_runtime_v1_queries_proto_enumTypes[3].Descriptor()
}

func (MetricsViewMeasureAlias_MeasureType) Type() protoreflect.EnumType {
	return &file_rill_runtime_v1_queries_proto_enumTypes[3]
}

func (x MetricsViewMeasureAlias_MeasureType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MetricsViewMeasureAlias_MeasureType.Descriptor instead.
func (MetricsViewMeasureAlias_MeasureType) EnumDescriptor() ([]byte, []int) {
...
type MetricsViewAggregationRequest struct {
	...
	Where       *Condition                         `protobuf:"bytes,8,opt,name=where,proto3" json:"where,omitempty"`
	Having      *Condition                         `protobuf:"bytes,13,opt,name=having,proto3" json:"having,omitempty"`
...
func (x *MetricsViewAggregationRequest) GetWhere() *Condition {
	if x != nil {
		return x.Where
	}
	return nil
...
func (x *MetricsViewAggregationRequest) GetHaving() *Condition {
	if x != nil {
		return x.Having
	}
	return nil
...
type MetricsViewComparisonRequest struct {
	...
	Where               *Condition                       `protobuf:"bytes,8,opt,name=where,proto3" json:"where,omitempty"`
	Having              *Condition                       `protobuf:"bytes,14,opt,name=having,proto3" json:"having,omitempty"`
	Aliases             []*MetricsViewMeasureAlias       `protobuf:"bytes,15,rep,name=aliases,proto3" json:"aliases,omitempty"`
	Limit               int64                            `protobuf:"varint,9,opt,name=limit,proto3" json:"limit,omitempty"`
	Offset              int64                            `protobuf:"varint,10,opt,name=offset,proto3" json:"offset,omitempty"`
	Priority            int32                            `protobuf:"varint,11,opt,name=priority,proto3" json:"priority,omitempty"`
...
func (x *MetricsViewComparisonRequest) GetWhere() *Condition {
	if x != nil {
		return x.Where
	}
	return nil
...
func (x *MetricsViewComparisonRequest) GetHaving() *Condition {
	if x != nil {
		return x.Having
	}
	return nil
...
func (x *MetricsViewComparisonRequest) GetAliases() []*MetricsViewMeasureAlias {
	if x != nil {
		return x.Aliases
	}
	return nil
...
type MetricsViewMeasureAlias struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Name  string                              `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Type  MetricsViewMeasureAlias_MeasureType `protobuf:"varint,2,opt,name=type,proto3,enum=rill.runtime.v1.MetricsViewMeasureAlias_MeasureType" json:"type,omitempty"`
	Args  []*structpb.Value                   `protobuf:"bytes,3,rep,name=args,proto3" json:"args,omitempty"`
	Alias string                              `protobuf:"bytes,4,opt,name=alias,proto3" json:"alias,omitempty"`
}

func (x *MetricsViewMeasureAlias) Reset() {
	*x = MetricsViewMeasureAlias{}
	if protoimpl.UnsafeEnabled {
...
func (x *MetricsViewMeasureAlias) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MetricsViewMeasureAlias) ProtoMessage() {}

func (x *MetricsViewMeasureAlias) ProtoReflect() protoreflect.Message {
	mi := &file_rill_runtime_v1_queries_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MetricsViewMeasureAlias.ProtoReflect.Descriptor instead.
func (*MetricsViewMeasureAlias) Descriptor() ([]byte, []int) {
	return file_rill_runtime_v1_queries_proto_rawDescGZIP(), []int{23}
}

func (x *MetricsViewMeasureAlias) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *MetricsViewMeasureAlias) GetType() MetricsViewMeasureAlias_MeasureType {
	if x != nil {
		return x.Type
	}
	return MetricsViewMeasureAlias_MEASURE_TYPE_UNSPECIFIED
}

func (x *MetricsViewMeasureAlias) GetArgs() []*structpb.Value {
	if x != nil {
		return x.Args
	}
	return nil
...
func (x *MetricsViewMeasureAlias) GetAlias() string {
	if x != nil {
		return x.Alias
	}
	return ""
...
var file_rill_runtime_v1_queries_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0xba, 0x05, 0x0a, 0x1d, 0x4d, 0x65, 0x74, 0x72, 0x69,
	...
	0x64, 0x12, 0x30, 0x0a, 0x05, 0x77, 0x68, 0x65, 0x72, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x1a, 0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e,
	0x76, 0x31, 0x2e, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x05, 0x77, 0x68,
	0x65, 0x72, 0x65, 0x12, 0x32, 0x0a, 0x06, 0x68, 0x61, 0x76, 0x69, 0x6e, 0x67, 0x18, 0x0d, 0x20,
	...
	0x66, 0x2e, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xf7,
	0x05, 0x0a, 0x1c, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x56, 0x69, 0x65, 0x77, 0x43, 0x6f,
	...
	0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x4a, 0x0a, 0x08, 0x6d, 0x65, 0x61, 0x73, 0x75, 0x72, 0x65,
	...
	,
	...
	0x08, 0x52, 0x05, 0x65, 0x78, 0x61, 0x63, 0x74, 0x22, 0x5e, 0x0a, 0x1d, 0x4d, 0x65, 0x74, 0x72,
	...
	0x69, 0x6d, 0x65, 0x5a, 0x6f, 0x6e, 0x65, 0x22, 0x90, 0x01, 0x0a, 0x19, 0x4d, 0x65, 0x74, 0x72,
	0x69, 0x63, 0x73, 0x56, 0x69, 0x65, 0x77, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x72, 0x69, 0x73, 0x6f,
	...
	0xdf, 0x02, 0x0a, 0x17, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x56, 0x69, 0x65, 0x77, 0x4d,
	...
	0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e,
	0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x56, 0x69, 0x65, 0x77, 0x4d, 0x65, 0x61, 0x73, 0x75,
	0x72, 0x65, 0x41, 0x6c, 0x69, 0x61, 0x73, 0x2e, 0x4d, 0x65, 0x61, 0x73, 0x75, 0x72, 0x65, 0x54,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x22, 0xa3, 0x01, 0x0a, 0x0b,
	...
	,
	...
	0x61, 0x73, 0x75, 0x72, 0x65, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x72,
	...
	0x75, 0x63, 0x74, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x92, 0x04, 0x0a, 0x16, 0x4d, 0x65,
	...
	0x69, 0x74, 0x79, 0x12, 0x3a, 0x0a, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x72, 0x69, 0x6c, 0x6c, 0x2e, 0x72, 0x75, 0x6e, 0x74, 0x69,
	0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x56, 0x69, 0x65,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x69, 0x6d, 0x65, 0x5a, 0x6f, 0x6e, 0x65, 0x22, 0x7e,
...
var file_rill_runtime_v1_queries_proto_goTypes = []interface{}{
	...
	(MetricsViewMeasureAlias_MeasureType)(0),     // 3: rill.runtime.v1.MetricsViewMeasureAlias.MeasureType
	...
	(*MetricsViewTimeSeriesRequest)(nil),         // 25: rill.runtime.v1.MetricsViewTimeSeriesRequest
	(*MetricsViewTimeSeriesResponse)(nil),        // 26: rill.runtime.v1.MetricsViewTimeSeriesResponse
	(*MetricsViewMeasureAlias)(nil),              // 27: rill.runtime.v1.MetricsViewMeasureAlias
	...
	(*ColumnRollupIntervalRequest)(nil),          // 38: rill.runtime.v1.ColumnRollupIntervalRequest
	(*ColumnRollupIntervalResponse)(nil),         // 39: rill.runtime.v1.ColumnRollupIntervalResponse
	(*ColumnTopKRequest)(nil),                    // 40: rill.runtime.v1.ColumnTopKRequest
	(*ColumnTopKResponse)(nil),                   // 41: rill.runtime.v1.ColumnTopKResponse
	(*CategoricalSummary)(nil),                   // 42: rill.runtime.v1.CategoricalSummary
	(*TopK)(nil),                                 // 43: rill.runtime.v1.TopK
	(*ColumnNullCountRequest)(nil),               // 44: rill.runtime.v1.ColumnNullCountRequest
	(*ColumnNullCountResponse)(nil),              // 45: rill.runtime.v1.ColumnNullCountResponse
	(*ColumnDescriptiveStatisticsRequest)(nil),   // 46: rill.runtime.v1.ColumnDescriptiveStatisticsRequest
	(*ColumnDescriptiveStatisticsResponse)(nil),  // 47: rill.runtime.v1.ColumnDescriptiveStatisticsResponse
	(*NumericSummary)(nil),                       // 48: rill.runtime.v1.NumericSummary
	(*NumericHistogramBins)(nil),                 // 49: rill.runtime.v1.NumericHistogramBins
	(*NumericStatistics)(nil),                    // 50: rill.runtime.v1.NumericStatistics
	(*NumericOutliers)(nil),                      // 51: rill.runtime.v1.NumericOutliers
	(*ColumnTimeGrainRequest)(nil),               // 52: rill.runtime.v1.ColumnTimeGrainRequest
	(*ColumnTimeGrainResponse)(nil),              // 53: rill.runtime.v1.ColumnTimeGrainResponse
	(*ColumnNumericHistogramRequest)(nil),        // 54: rill.runtime.v1.ColumnNumericHistogramRequest
	(*ColumnNumericHistogramResponse)(nil),       // 55: rill.runtime.v1.ColumnNumericHistogramResponse
	(*ColumnRugHistogramRequest)(nil),            // 56: rill.runtime.v1.ColumnRugHistogramRequest
	(*ColumnRugHistogramResponse)(nil),           // 57: rill.runtime.v1.ColumnRugHistogramResponse
	(*ColumnTimeRangeRequest)(nil),               // 58: rill.runtime.v1.ColumnTimeRangeRequest
	(*ColumnTimeRangeResponse)(nil),              // 59: rill.runtime.v1.ColumnTimeRangeResponse
	(*TimeRangeSummary)(nil),                     // 60: rill.runtime.v1.TimeRangeSummary
	(*ColumnCardinalityRequest)(nil),             // 61: rill.runtime.v1.ColumnCardinalityRequest
	(*ColumnCardinalityResponse)(nil),            // 62: rill.runtime.v1.ColumnCardinalityResponse
	(*ColumnTimeSeriesRequest)(nil),              // 63: rill.runtime.v1.ColumnTimeSeriesRequest
	(*ColumnTimeSeriesResponse)(nil),             // 64: rill.runtime.v1.ColumnTimeSeriesResponse
	(*TimeSeriesTimeRange)(nil),                  // 65: rill.runtime.v1.TimeSeriesTimeRange
	(*TimeSeriesResponse)(nil),                   // 66: rill.runtime.v1.TimeSeriesResponse
	(*TimeSeriesValue)(nil),                      // 67: rill.runtime.v1.TimeSeriesValue
	(*TableCardinalityRequest)(nil),              // 68: rill.runtime.v1.TableCardinalityRequest
	(*TableCardinalityResponse)(nil),             // 69: rill.runtime.v1.TableCardinalityResponse
	(*TableColumnsRequest)(nil),                  // 70: rill.runtime.v1.TableColumnsRequest
	(*TableColumnsResponse)(nil),                 // 71: rill.runtime.v1.TableColumnsResponse
	(*ProfileColumn)(nil),                        // 72: rill.runtime.v1.ProfileColumn
	(*TableRowsRequest)(nil),                     // 73: rill.runtime.v1.TableRowsRequest
	(*TableRowsResponse)(nil),                    // 74: rill.runtime.v1.TableRowsResponse
	(*MetricsViewFilter_Cond)(nil),               // 75: rill.runtime.v1.MetricsViewFilter.Cond
	(*TopK_Entry)(nil),                           // 76: rill.runtime.v1.TopK.Entry
	(*NumericHistogramBins_Bin)(nil),             // 77: rill.runtime.v1.NumericHistogramBins.Bin
	(*NumericOutliers_Outlier)(nil),              // 78: rill.runtime.v1.NumericOutliers.Outlier
	(*TimeRangeSummary_Interval)(nil),            // 79: rill.runtime.v1.TimeRangeSummary.Interval
	(*ColumnTimeSeriesRequest_BasicMeasure)(nil), // 80: rill.runtime.v1.ColumnTimeSeriesRequest.BasicMeasure
	...
	(*Condition)(nil),                            // 86: rill.runtime.v1.Condition
	(TimeGrain)(0),                               // 87: rill.runtime.v1.TimeGrain
}
var file_rill_runtime_v1_queries_proto_depIdxs = []int32{
	81,  // 0: rill.runtime.v1.QueryRequest.args:type_name -> google.protobuf.Value
	82,  // 1: rill.runtime.v1.QueryResponse.meta:type_name -> rill.runtime.v1.StructType
	83,  // 2: rill.runtime.v1.QueryResponse.data:type_name -> google.protobuf.Struct
	...
	84,  // 5: rill.runtime.v1.ExportRequest.format:type_name -> rill.runtime.v1.ExportFormat
	...
	25,  // 10: rill.runtime.v1.Query.metrics_view_time_series_request:type_name -> rill.runtime.v1.MetricsViewTimeSeriesRequest
	...
	38,  // 13: rill.runtime.v1.Query.column_rollup_interval_request:type_name -> rill.runtime.v1.ColumnRollupIntervalRequest
	40,  // 14: rill.runtime.v1.Query.column_top_k_request:type_name -> rill.runtime.v1.ColumnTopKRequest
	44,  // 15: rill.runtime.v1.Query.column_null_count_request:type_name -> rill.runtime.v1.ColumnNullCountRequest
	46,  // 16: rill.runtime.v1.Query.column_descriptive_statistics_request:type_name -> rill.runtime.v1.ColumnDescriptiveStatisticsRequest
	52,  // 17: rill.runtime.v1.Query.column_time_grain_request:type_name -> rill.runtime.v1.ColumnTimeGrainRequest
	54,  // 18: rill.runtime.v1.Query.column_numeric_histogram_request:type_name -> rill.runtime.v1.ColumnNumericHistogramRequest
	56,  // 19: rill.runtime.v1.Query.column_rug_histogram_request:type_name -> rill.runtime.v1.ColumnRugHistogramRequest
	58,  // 20: rill.runtime.v1.Query.column_time_range_request:type_name -> rill.runtime.v1.ColumnTimeRangeRequest
	61,  // 21: rill.runtime.v1.Query.column_cardinality_request:type_name -> rill.runtime.v1.ColumnCardinalityRequest
	63,  // 22: rill.runtime.v1.Query.column_time_series_request:type_name -> rill.runtime.v1.ColumnTimeSeriesRequest
	68,  // 23: rill.runtime.v1.Query.table_cardinality_request:type_name -> rill.runtime.v1.TableCardinalityRequest
	70,  // 24: rill.runtime.v1.Query.table_columns_request:type_name -> rill.runtime.v1.TableColumnsRequest
	73,  // 25: rill.runtime.v1.Query.table_rows_request:type_name -> rill.runtime.v1.TableRowsRequest
	...
	26,  // 29: rill.runtime.v1.QueryResult.metrics_view_time_series_response:type_name -> rill.runtime.v1.MetricsViewTimeSeriesResponse
	...
	39,  // 32: rill.runtime.v1.QueryResult.column_rollup_interval_response:type_name -> rill.runtime.v1.ColumnRollupIntervalResponse
	41,  // 33: rill.runtime.v1.QueryResult.column_top_k_response:type_name -> rill.runtime.v1.ColumnTopKResponse
	45,  // 34: rill.runtime.v1.QueryResult.column_null_count_response:type_name -> rill.runtime.v1.ColumnNullCountResponse
	47,  // 35: rill.runtime.v1.QueryResult.column_descriptive_statistics_response:type_name -> rill.runtime.v1.ColumnDescriptiveStatisticsResponse
	53,  // 36: rill.runtime.v1.QueryResult.column_time_grain_response:type_name -> rill.runtime.v1.ColumnTimeGrainResponse
	55,  // 37: rill.runtime.v1.QueryResult.column_numeric_histogram_response:type_name -> rill.runtime.v1.ColumnNumericHistogramResponse
	57,  // 38: rill.runtime.v1.QueryResult.column_rug_histogram_response:type_name -> rill.runtime.v1.ColumnRugHistogramResponse
	59,  // 39: rill.runtime.v1.QueryResult.column_time_range_response:type_name -> rill.runtime.v1.ColumnTimeRangeResponse
	62,  // 40: rill.runtime.v1.QueryResult.column_cardinality_response:type_name -> rill.runtime.v1.ColumnCardinalityResponse
	64,  // 41: rill.runtime.v1.QueryResult.column_time_series_response:type_name -> rill.runtime.v1.ColumnTimeSeriesResponse
	69,  // 42: rill.runtime.v1.QueryResult.table_cardinality_response:type_name -> rill.runtime.v1.TableCardinalityResponse
	71,  // 43: rill.runtime.v1.QueryResult.table_columns_response:type_name -> rill.runtime.v1.TableColumnsResponse
	74,  // 44: rill.runtime.v1.QueryResult.table_rows_response:type_name -> rill.runtime.v1.TableRowsResponse
	...
	85,  // 49: rill.runtime.v1.MetricsViewAggregationRequest.time_start:type_name -> google.protobuf.Timestamp
	85,  // 50: rill.runtime.v1.MetricsViewAggregationRequest.time_end:type_name -> google.protobuf.Timestamp
	86,  // 51: rill.runtime.v1.MetricsViewAggregationRequest.where:type_name -> rill.runtime.v1.Condition
	86,  // 52: rill.runtime.v1.MetricsViewAggregationRequest.having:type_name -> rill.runtime.v1.Condition
	82,  // 53: rill.runtime.v1.MetricsViewAggregationResponse.schema:type_name -> rill.runtime.v1.StructType
	83,  // 54: rill.runtime.v1.MetricsViewAggregationResponse.data:type_name -> google.protobuf.Struct
	87,  // 55: rill.runtime.v1.MetricsViewAggregationDimension.time_grain:type_name -> rill.runtime.v1.TimeGrain
	0,   // 56: rill.runtime.v1.MetricsViewAggregationMeasure.builtin_measure:type_name -> rill.runtime.v1.BuiltinMeasure
	81,  // 57: rill.runtime.v1.MetricsViewAggregationMeasure.builtin_measure_args:type_name -> google.protobuf.Value
	35,  // 58: rill.runtime.v1.MetricsViewToplistRequest.inline_measures:type_name -> rill.runtime.v1.InlineMeasure
	85,  // 59: rill.runtime.v1.MetricsViewToplistRequest.time_start:type_name -> google.protobuf.Timestamp
	85,  // 60: rill.runtime.v1.MetricsViewToplistRequest.time_end:type_name -> google.protobuf.Timestamp
	32,  // 61: rill.runtime.v1.MetricsViewToplistRequest.sort:type_name -> rill.runtime.v1.MetricsViewSort
	33,  // 62: rill.runtime.v1.MetricsViewToplistRequest.filter:type_name -> rill.runtime.v1.MetricsViewFilter
	34,  // 63: rill.runtime.v1.MetricsViewToplistResponse.meta:type_name -> rill.runtime.v1.MetricsViewColumn
	83,  // 64: rill.runtime.v1.MetricsViewToplistResponse.data:type_name -> google.protobuf.Struct
	14,  // 65: rill.runtime.v1.MetricsViewComparisonRequest.dimension:type_name -> rill.runtime.v1.MetricsViewAggregationDimension
	15,  // 66: rill.runtime.v1.MetricsViewComparisonRequest.measures:type_name -> rill.runtime.v1.MetricsViewAggregationMeasure
	22,  // 67: rill.runtime.v1.MetricsViewComparisonRequest.sort:type_name -> rill.runtime.v1.MetricsViewComparisonSort
	21,  // 68: rill.runtime.v1.MetricsViewComparisonRequest.time_range:type_name -> rill.runtime.v1.TimeRange
	21,  // 69: rill.runtime.v1.MetricsViewComparisonRequest.comparison_time_range:type_name -> rill.runtime.v1.TimeRange
	86,  // 70: rill.runtime.v1.MetricsViewComparisonRequest.where:type_name -> rill.runtime.v1.Condition
	86,  // 71: rill.runtime.v1.MetricsViewComparisonRequest.having:type_name -> rill.runtime.v1.Condition
	27,  // 72: rill.runtime.v1.MetricsViewComparisonRequest.aliases:type_name -> rill.runtime.v1.MetricsViewMeasureAlias
	23,  // 73: rill.runtime.v1.MetricsViewComparisonResponse.rows:type_name -> rill.runtime.v1.MetricsViewComparisonRow
	85,  // 74: rill.runtime.v1.TimeRange.start:type_name -> google.protobuf.Timestamp
	85,  // 75: rill.runtime.v1.TimeRange.end:type_name -> google.protobuf.Timestamp
	87,  // 76: rill.runtime.v1.TimeRange.round_to_grain:type_name -> rill.runtime.v1.TimeGrain
	1,   // 77: rill.runtime.v1.MetricsViewComparisonSort.type:type_name -> rill.runtime.v1.MetricsViewComparisonSortType
	81,  // 78: rill.runtime.v1.MetricsViewComparisonRow.dimension_value:type_name -> google.protobuf.Value
	24,  // 79: rill.runtime.v1.MetricsViewComparisonRow.measure_values:type_name -> rill.runtime.v1.MetricsViewComparisonValue
	81,  // 80: rill.runtime.v1.MetricsViewComparisonValue.base_value:type_name -> google.protobuf.Value
	81,  // 81: rill.runtime.v1.MetricsViewComparisonValue.comparison_value:type_name -> google.protobuf.Value
	81,  // 82: rill.runtime.v1.MetricsViewComparisonValue.delta_abs:type_name -> google.protobuf.Value
	81,  // 83: rill.runtime.v1.MetricsViewComparisonValue.delta_rel:type_name -> google.protobuf.Value
	35,  // 84: rill.runtime.v1.MetricsViewTimeSeriesRequest.inline_measures:type_name -> rill.runtime.v1.InlineMeasure
	85,  // 85: rill.runtime.v1.MetricsViewTimeSeriesRequest.time_start:type_name -> google.protobuf.Timestamp
	85,  // 86: rill.runtime.v1.MetricsViewTimeSeriesRequest.time_end:type_name -> google.protobuf.Timestamp
	87,  // 87: rill.runtime.v1.MetricsViewTimeSeriesRequest.time_granularity:type_name -> rill.runtime.v1.TimeGrain
	33,  // 88: rill.runtime.v1.MetricsViewTimeSeriesRequest.filter:type_name -> rill.runtime.v1.MetricsViewFilter
	34,  // 89: rill.runtime.v1.MetricsViewTimeSeriesResponse.meta:type_name -> rill.runtime.v1.MetricsViewColumn
	67,  // 90: rill.runtime.v1.MetricsViewTimeSeriesResponse.data:type_name -> rill.runtime.v1.TimeSeriesValue
	3,   // 91: rill.runtime.v1.MetricsViewMeasureAlias.type:type_name -> rill.runtime.v1.MetricsViewMeasureAlias.MeasureType
	81,  // 92: rill.runtime.v1.MetricsViewMeasureAlias.args:type_name -> google.protobuf.Value
	35,  // 93: rill.runtime.v1.MetricsViewTotalsRequest.inline_measures:type_name -> rill.runtime.v1.InlineMeasure
	85,  // 94: rill.runtime.v1.MetricsViewTotalsRequest.time_start:type_name -> google.protobuf.Timestamp
	85,  // 95: rill.runtime.v1.MetricsViewTotalsRequest.time_end:type_name -> google.protobuf.Timestamp
	33,  // 96: rill.runtime.v1.MetricsViewTotalsRequest.filter:type_name -> rill.runtime.v1.MetricsViewFilter
	34,  // 97: rill.runtime.v1.MetricsViewTotalsResponse.meta:type_name -> rill.runtime.v1.MetricsViewColumn
	83,  // 98: rill.runtime.v1.MetricsViewTotalsResponse.data:type_name -> google.protobuf.Struct
	85,  // 99: rill.runtime.v1.MetricsViewRowsRequest.time_start:type_name -> google.protobuf.Timestamp
	85,  // 100: rill.runtime.v1.MetricsViewRowsRequest.time_end:type_name -> google.protobuf.Timestamp
	87,  // 101: rill.runtime.v1.MetricsViewRowsRequest.time_granularity:type_name -> rill.runtime.v1.TimeGrain
	33,  // 102: rill.runtime.v1.MetricsViewRowsRequest.filter:type_name -> rill.runtime.v1.MetricsViewFilter
	32,  // 103: rill.runtime.v1.MetricsViewRowsRequest.sort:type_name -> rill.runtime.v1.MetricsViewSort
	34,  // 104: rill.runtime.v1.MetricsViewRowsResponse.meta:type_name -> rill.runtime.v1.MetricsViewColumn
	83,  // 105: rill.runtime.v1.MetricsViewRowsResponse.data:type_name -> google.protobuf.Struct
	75,  // 106: rill.runtime.v1.MetricsViewFilter.include:type_name -> rill.runtime.v1.MetricsViewFilter.Cond
	75,  // 107: rill.runtime.v1.MetricsViewFilter.exclude:type_name -> rill.runtime.v1.MetricsViewFilter.Cond
	60,  // 108: rill.runtime.v1.MetricsViewTimeRangeResponse.time_range_summary:type_name -> rill.runtime.v1.TimeRangeSummary
	85,  // 109: rill.runtime.v1.ColumnRollupIntervalResponse.start:type_name -> google.protobuf.Timestamp
	85,  // 110: rill.runtime.v1.ColumnRollupIntervalResponse.end:type_name -> google.protobuf.Timestamp
	87,  // 111: rill.runtime.v1.ColumnRollupIntervalResponse.interval:type_name -> rill.runtime.v1.TimeGrain
	42,  // 112: rill.runtime.v1.ColumnTopKResponse.categorical_summary:type_name -> rill.runtime.v1.CategoricalSummary
	43,  // 113: rill.runtime.v1.CategoricalSummary.top_k:type_name -> rill.runtime.v1.TopK
	76,  // 114: rill.runtime.v1.TopK.entries:type_name -> rill.runtime.v1.TopK.Entry
	48,  // 115: rill.runtime.v1.ColumnDescriptiveStatisticsResponse.numeric_summary:type_name -> rill.runtime.v1.NumericSummary
	49,  // 116: rill.runtime.v1.NumericSummary.numeric_histogram_bins:type_name -> rill.runtime.v1.NumericHistogramBins
	50,  // 117: rill.runtime.v1.NumericSummary.numeric_statistics:type_name -> rill.runtime.v1.NumericStatistics
	51,  // 118: rill.runtime.v1.NumericSummary.numeric_outliers:type_name -> rill.runtime.v1.NumericOutliers
	77,  // 119: rill.runtime.v1.NumericHistogramBins.bins:type_name -> rill.runtime.v1.NumericHistogramBins.Bin
	78,  // 120: rill.runtime.v1.NumericOutliers.outliers:type_name -> rill.runtime.v1.NumericOutliers.Outlier
	87,  // 121: rill.runtime.v1.ColumnTimeGrainResponse.time_grain:type_name -> rill.runtime.v1.TimeGrain
	2,   // 122: rill.runtime.v1.ColumnNumericHistogramRequest.histogram_method:type_name -> rill.runtime.v1.HistogramMethod
	48,  // 123: rill.runtime.v1.ColumnNumericHistogramResponse.numeric_summary:type_name -> rill.runtime.v1.NumericSummary
	48,  // 124: rill.runtime.v1.ColumnRugHistogramResponse.numeric_summary:type_name -> rill.runtime.v1.NumericSummary
	60,  // 125: rill.runtime.v1.ColumnTimeRangeResponse.time_range_summary:type_name -> rill.runtime.v1.TimeRangeSummary
	85,  // 126: rill.runtime.v1.TimeRangeSummary.min:type_name -> google.protobuf.Timestamp
	85,  // 127: rill.runtime.v1.TimeRangeSummary.max:type_name -> google.protobuf.Timestamp
	79,  // 128: rill.runtime.v1.TimeRangeSummary.interval:type_name -> rill.runtime.v1.TimeRangeSummary.Interval
	42,  // 129: rill.runtime.v1.ColumnCardinalityResponse.categorical_summary:type_name -> rill.runtime.v1.CategoricalSummary
	80,  // 130: rill.runtime.v1.ColumnTimeSeriesRequest.measures:type_name -> rill.runtime.v1.ColumnTimeSeriesRequest.BasicMeasure
	65,  // 131: rill.runtime.v1.ColumnTimeSeriesRequest.time_range:type_name -> rill.runtime.v1.TimeSeriesTimeRange
	66,  // 132: rill.runtime.v1.ColumnTimeSeriesResponse.rollup:type_name -> rill.runtime.v1.TimeSeriesResponse
	85,  // 133: rill.runtime.v1.TimeSeriesTimeRange.start:type_name -> google.protobuf.Timestamp
	85,  // 134: rill.runtime.v1.TimeSeriesTimeRange.end:type_name -> google.protobuf.Timestamp
	87,  // 135: rill.runtime.v1.TimeSeriesTimeRange.interval:type_name -> rill.runtime.v1.TimeGrain
	67,  // 136: rill.runtime.v1.TimeSeriesResponse.results:type_name -> rill.runtime.v1.TimeSeriesValue
	67,  // 137: rill.runtime.v1.TimeSeriesResponse.spark:type_name -> rill.runtime.v1.TimeSeriesValue
	85,  // 138: rill.runtime.v1.TimeSeriesValue.ts:type_name -> google.protobuf.Timestamp
	83,  // 139: rill.runtime.v1.TimeSeriesValue.records:type_name -> google.protobuf.Struct
	72,  // 140: rill.runtime.v1.TableColumnsResponse.profile_columns:type_name -> rill.runtime.v1.ProfileColumn
	83,  // 141: rill.runtime.v1.TableRowsResponse.data:type_name -> google.protobuf.Struct
	81,  // 142: rill.runtime.v1.MetricsViewFilter.Cond.in:type_name -> google.protobuf.Value
	81,  // 143: rill.runtime.v1.TopK.Entry.value:type_name -> google.protobuf.Value
	4,   // 144: rill.runtime.v1.QueryService.Query:input_type -> rill.runtime.v1.QueryRequest
	6,   // 145: rill.runtime.v1.QueryService.QueryBatch:input_type -> rill.runtime.v1.QueryBatchRequest
	8,   // 146: rill.runtime.v1.QueryService.Export:input_type -> rill.runtime.v1.ExportRequest
	12,  // 147: rill.runtime.v1.QueryService.MetricsViewAggregation:input_type -> rill.runtime.v1.MetricsViewAggregationRequest
	17,  // 148: rill.runtime.v1.QueryService.MetricsViewToplist:input_type -> rill.runtime.v1.MetricsViewToplistRequest
	19,  // 149: rill.runtime.v1.QueryService.MetricsViewComparison:input_type -> rill.runtime.v1.MetricsViewComparisonRequest
	25,  // 150: rill.runtime.v1.QueryService.MetricsViewTimeSeries:input_type -> rill.runtime.v1.MetricsViewTimeSeriesRequest
	28,  // 151: rill.runtime.v1.QueryService.MetricsViewTotals:input_type -> rill.runtime.v1.MetricsViewTotalsRequest
	30,  // 152: rill.runtime.v1.QueryService.MetricsViewRows:input_type -> rill.runtime.v1.MetricsViewRowsRequest
	36,  // 153: rill.runtime.v1.QueryService.MetricsViewTimeRange:input_type -> rill.runtime.v1.MetricsViewTimeRangeRequest
	38,  // 154: rill.runtime.v1.QueryService.ColumnRollupInterval:input_type -> rill.runtime.v1.ColumnRollupIntervalRequest
	40,  // 155: rill.runtime.v1.QueryService.ColumnTopK:input_type -> rill.runtime.v1.ColumnTopKRequest
	44,  // 156: rill.runtime.v1.QueryService.ColumnNullCount:input_type -> rill.runtime.v1.ColumnNullCountRequest
	46,  // 157: rill.runtime.v1.QueryService.ColumnDescriptiveStatistics:input_type -> rill.runtime.v1.ColumnDescriptiveStatisticsRequest
	52,  // 158: rill.runtime.v1.QueryService.ColumnTimeGrain:input_type -> rill.runtime.v1.ColumnTimeGrainRequest
	54,  // 159: rill.runtime.v1.QueryService.ColumnNumericHistogram:input_type -> rill.runtime.v1.ColumnNumericHistogramRequest
	56,  // 160: rill.runtime.v1.QueryService.ColumnRugHistogram:input_type -> rill.runtime.v1.ColumnRugHistogramRequest
	58,  // 161: rill.runtime.v1.QueryService.ColumnTimeRange:input_type -> rill.runtime.v1.ColumnTimeRangeRequest
	61,  // 162: rill.runtime.v1.QueryService.ColumnCardinality:input_type -> rill.runtime.v1.ColumnCardinalityRequest
	63,  // 163: rill.runtime.v1.QueryService.ColumnTimeSeries:input_type -> rill.runtime.v1.ColumnTimeSeriesRequest
	68,  // 164: rill.runtime.v1.QueryService.TableCardinality:input_type -> rill.runtime.v1.TableCardinalityRequest
	70,  // 165: rill.runtime.v1.QueryService.TableColumns:input_type -> rill.runtime.v1.TableColumnsRequest
	73,  // 166: rill.runtime.v1.QueryService.TableRows:input_type -> rill.runtime.v1.TableRowsRequest
	5,   // 167: rill.runtime.v1.QueryService.Query:output_type -> rill.runtime.v1.QueryResponse
	7,   // 168: rill.runtime.v1.QueryService.QueryBatch:output_type -> rill.runtime.v1.QueryBatchResponse
	9,   // 169: rill.runtime.v1.QueryService.Export:output_type -> rill.runtime.v1.ExportResponse
	13,  // 170: rill.runtime.v1.QueryService.MetricsViewAggregation:output_type -> rill.runtime.v1.MetricsViewAggregationResponse
	18,  // 171: rill.runtime.v1.QueryService.MetricsViewToplist:output_type -> rill.runtime.v1.MetricsViewToplistResponse
	20,  // 172: rill.runtime.v1.QueryService.MetricsViewComparison:output_type -> rill.runtime.v1.MetricsViewComparisonResponse
	26,  // 173: rill.runtime.v1.QueryService.MetricsViewTimeSeries:output_type -> rill.runtime.v1.MetricsViewTimeSeriesResponse
	29,  // 174: rill.runtime.v1.QueryService.MetricsViewTotals:output_type -> rill.runtime.v1.MetricsViewTotalsResponse
	31,  // 175: rill.runtime.v1.QueryService.MetricsViewRows:output_type -> rill.runtime.v1.MetricsViewRowsResponse
	37,  // 176: rill.runtime.v1.QueryService.MetricsViewTimeRange:output_type -> rill.runtime.v1.MetricsViewTimeRangeResponse
	39,  // 177: rill.runtime.v1.QueryService.ColumnRollupInterval:output_type -> rill.runtime.v1.ColumnRollupIntervalResponse
	41,  // 178: rill.runtime.v1.QueryService.ColumnTopK:output_type -> rill.runtime.v1.ColumnTopKResponse
	45,  // 179: rill.runtime.v1.QueryService.ColumnNullCount:output_type -> rill.runtime.v1.ColumnNullCountResponse
	47,  // 180: rill.runtime.v1.QueryService.ColumnDescriptiveStatistics:output_type -> rill.runtime.v1.ColumnDescriptiveStatisticsResponse
	53,  // 181: rill.runtime.v1.QueryService.ColumnTimeGrain:output_type -> rill.runtime.v1.ColumnTimeGrainResponse
	55,  // 182: rill.runtime.v1.QueryService.ColumnNumericHistogram:output_type -> rill.runtime.v1.ColumnNumericHistogramResponse
	57,  // 183: rill.runtime.v1.QueryService.ColumnRugHistogram:output_type -> rill.runtime.v1.ColumnRugHistogramResponse
	59,  // 184: rill.runtime.v1.QueryService.ColumnTimeRange:output_type -> rill.runtime.v1.ColumnTimeRangeResponse
	62,  // 185: rill.runtime.v1.QueryService.ColumnCardinality:output_type -> rill.runtime.v1.ColumnCardinalityResponse
	64,  // 186: rill.runtime.v1.QueryService.ColumnTimeSeries:output_type -> rill.runtime.v1.ColumnTimeSeriesResponse
	69,  // 187: rill.runtime.v1.QueryService.TableCardinality:output_type -> rill.runtime.v1.TableCardinalityResponse
	71,  // 188: rill.runtime.v1.QueryService.TableColumns:output_type -> rill.runtime.v1.TableColumnsResponse
	74,  // 189: rill.runtime.v1.QueryService.TableRows:output_type -> rill.runtime.v1.TableRowsResponse
...
func file_rill_runtime_v1_queries_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rill_runtime_v1_queries_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MetricsViewMeasureAlias); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
