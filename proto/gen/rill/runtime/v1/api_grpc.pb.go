...
const (
	...
	RuntimeService_Healthz_FullMethodName                 = "/rill.runtime.v1.RuntimeService/Healthz"
...
func (c *runtimeServiceClient) Healthz(ctx context.Context, in *HealthzRequest, opts ...grpc.CallOption) (*HealthzResponse, error) {
	...
	err := c.cc.Invoke(ctx, RuntimeService_Healthz_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *runtimeServiceClient) WatchFiles(ctx context.Context, in *WatchFilesRequest, opts ...grpc.CallOption) (RuntimeService_WatchFilesClient, error) {
	...
	x := &runtimeServiceWatchFilesClient{ClientStream: stream}
...
func (c *runtimeServiceClient) WatchLogs(ctx context.Context, in *WatchLogsRequest, opts ...grpc.CallOption) (RuntimeService_WatchLogsClient, error) {
	...
	x := &runtimeServiceWatchLogsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *runtimeServiceClient) WatchResources(ctx context.Context, in *WatchResourcesRequest, opts ...grpc.CallOption) (RuntimeService_WatchResourcesClient, error) {
	...
	x := &runtimeServiceWatchResourcesClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (UnimplementedRuntimeServiceServer) Healthz(context.Context, *HealthzRequest) (*HealthzResponse, error) {
...
func _RuntimeService_Healthz_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RuntimeService_Healthz_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RuntimeService_WatchFiles_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(RuntimeServiceServer).WatchFiles(m, &runtimeServiceWatchFilesServer{ServerStream: stream})
}
...
func _RuntimeService_WatchLogs_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(RuntimeServiceServer).WatchLogs(m, &runtimeServiceWatchLogsServer{ServerStream: stream})
}
...
func _RuntimeService_WatchResources_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(RuntimeServiceServer).WatchResources(m, &runtimeServiceWatchResourcesServer{ServerStream: stream})
}
