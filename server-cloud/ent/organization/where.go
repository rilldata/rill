...
func CreatedOn(v time.Time) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func UpdatedOn(v time.Time) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func CreatedOnEQ(v time.Time) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCreatedOn), v))
	})
}
...
func CreatedOnNEQ(v time.Time) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func CreatedOnIn(vs ...time.Time) predicate.Organization {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreatedOnNotIn(vs ...time.Time) predicate.Organization {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreatedOnGT(v time.Time) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func CreatedOnGTE(v time.Time) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func CreatedOnLT(v time.Time) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func CreatedOnLTE(v time.Time) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func UpdatedOnEQ(v time.Time) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUpdatedOn), v))
	})
}
...
func UpdatedOnNEQ(v time.Time) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func UpdatedOnIn(vs ...time.Time) predicate.Organization {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdatedOnNotIn(vs ...time.Time) predicate.Organization {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdatedOnGT(v time.Time) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func UpdatedOnGTE(v time.Time) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func UpdatedOnLT(v time.Time) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func UpdatedOnLTE(v time.Time) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func HasGroupsWith(preds ...predicate.Groups) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
