...
# Rill 0.90 - Ad Hoc Measures, Canvas Maps, AI Skills, Unified MCP Server and Bookmark Manager
...
- Added support for Databricks Lakehouse//RT warehouses by auto-detecting the Statement Execution API backend
