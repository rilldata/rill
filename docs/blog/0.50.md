...
## Bug Fixes and Misc (not finished ~ Oct 9)
...
- explore dashboard support for regex for `dimensions:` and `measures:`
- explore dashboard support for `defaults:`
- new observability in the UI for incremental models and splits, allows for incremental refreshes and insight into splits.
...
- due to the behavior of metric view generation, default to 
...
- increased limit of pivot measures.
