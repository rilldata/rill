...
For more details, check out [Azure Connector](/connect/source/connectors/azure) documentation.
...
For more details, check out [Athena Connector](/connect/source/connectors/athena) documentation. 
...
For more details, check out [Postgres Connector](/connect/source/connectors/postgres) documentation.
