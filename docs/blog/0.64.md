...
We now support AWS STS authentication for our DuckDB and S3 connectors. You can find more details in our [documentation](/developers/build/connectors/data-source/s3#iam-role-based-authentication).
