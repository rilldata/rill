...
To [try out Rill Developer, check out these instructions](/developer/get-started/install) and [let us know over on Discord](https://discord.gg/2ubRfjC7Rh) if you encounter any problems or have ideas about how to improve Rill Developer!
:::
...
- **Self-serve local project deployment with the CLI - ** [Deploying a project](/developer/deploy/deploy-dashboard/) makes dashboards available online and enables you to invite others to access it without installing Rill locally. To try deploying your project `cd` into the project's root directory and run `rill deploy`.
