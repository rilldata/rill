...
To [try out Rill Developer, check out these instructions](/developers/get-started/install) and [join us over on Discord](https://discord.gg/2ubRfjC7Rh) to meet the team behind the product as well as other users. In addition, once you have a project set up in Rill Developer, you can then [deploy the project](/developers/deploy/deploy-dashboard) and collaborate with others / invite your team members by [logging into Rill Cloud](https://ui.rilldata.com)!
:::
...
Read more in our [documentation](/users/explore/mcp) and watch the [introduction video](https://www.rilldata.com/mcp)
