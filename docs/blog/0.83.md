...
# Rill 0.83 - AI Reports, Canvas Generation, Supabase Connector, Project Table Information
...
You can now use the AI agent to generate and schedule reports. Ask the agent to create a report and it will build one for you, making it easier to share insights with your team on a recurring basis.
...
- Added Netlify Content Security Policy
