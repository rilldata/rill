...
Snowflake is starting to phase out single-factor password authentication. If you are using password authentication for your Snowflake source, we recommend migrating to [private key authentication](/connect/connector/sources/snowflake#using-keypair-authentication) to avoid service disruptions.
