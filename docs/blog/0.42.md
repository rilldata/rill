...
For more details on configuration and use cases [check out our alerts page](/user-guide/alerts).
...
More details on [bookmarks here](/user-guide/dashboards/bookmarks).
...
We're always looking for more ways to bring data into Rill. This release includes a connector for Redshift - [more details here](/developer/build/connectors/data-source/redshift) on how to set up credentials and create sources from your Redshift data.
...
- Adding support for configuring the default OLAP engine directly through `rill.yaml`.
