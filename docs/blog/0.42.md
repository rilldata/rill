...
We're always looking for more ways to bring data into Rill. This release includes a connector for Redshift - [more details here](/connect/source/connectors/redshift) on how to set up credentials and create sources from your Redshift data.
