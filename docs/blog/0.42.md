...
For more details on configuration and use cases [check out our alerts page](../docs/explore/alerts.md).
...
=======
More details on [bookmarks here](../docs/explore/bookmarks.md).
>>>>>>> Stashed changes
