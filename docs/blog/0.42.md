...
For more details on configuration and use cases [check out our alerts page](/user-guide/explore/alerts).
...
More details on [bookmarks here](/user-guide/explore/bookmarks).
