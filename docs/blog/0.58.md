...
- Changes to user management, including adding `guest` and `editor` and how project users are handled. See [documentation](/users/manage/user-management) for more information.
