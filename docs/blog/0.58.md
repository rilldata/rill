...
- Changes to user management, including adding `guest` and `editor` and how project users are handled. See [documentation](/user-guide/users/user-management) for more information.
