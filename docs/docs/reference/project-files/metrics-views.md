...
**`model`** — Refers to the **model** powering the dashboard with no path specified; should only be used for [Rill models](/build/models/sql-models) _(either **model** or **table** is required)_.
