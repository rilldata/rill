...
While we go into more details in our [Rill Basics course](/developers/guides/rill-basics/dashboard) and [our documentation](https://docs.rilldata.com/developers/build/dashboards), let's go over it quickly.
