...
When using the [Embed API](/developers/embed/iframe-api), you can use these URL parameters in the `setState` method:
...
- [Embed Dashboards](/developers/embed/dashboards) - Learn how to embed Rill dashboards
- [Embed Iframe API](/developers/embed/iframe-api) - Programmatically control embedded dashboards
- [Time Series Filter](/guide/dashboards/time-series) - Detailed guide on time range syntax and usage
