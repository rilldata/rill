...
3. **Credentials configured via CLI** - For [AWS](/developers/build/connectors/data-source/duckdb/s3#method-4-local-aws-credentials-local-development-only) / [Azure](/developers/build/connectors/data-source/duckdb/azure#method-5-azure-cli-authentication-local-development-only) / [Google Cloud](/developers/build/connectors/data-source/duckdb/gcs#method-4-local-google-cloud-cli-credentials) - **NOT RECOMMENDED for production use**
