...
[Databricks](https://docs.databricks.com) is a unified data and AI platform built on top of Apache Spark and the lakehouse architecture. Rill connects to Databricks SQL warehouses using the [Databricks SQL Go driver](https://github.com/databricks/databricks-sql-go), streaming query results in Arrow IPC format and writing them to Parquet files for fast ingestion into Rill's embedded engine.
