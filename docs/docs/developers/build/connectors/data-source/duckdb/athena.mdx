...
When no explicit credentials are provided in the connector, Rill will automatically use your local AWS CLI credentials. Then, [create your first model](#create-your-first-model).

## Create Your First Model

Once your connector is configured using any method above, create a model to define what data to pull.

Create `models/athena_data.yaml`:
