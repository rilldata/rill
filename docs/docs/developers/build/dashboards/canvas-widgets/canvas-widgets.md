...
<div className="component-icon-grid">
    <ComponentTile
        header="KPIs"
        link="/developers/build/dashboards/canvas-widgets/data#kpi-grid"
        multiple_measures="False"
        image={<img src="/img/build/dashboard/canvas/components/kpi.png" alt="KPI" />}
    />
    <ComponentTile
        header="Leaderboard"
        link="/developers/build/dashboards/canvas-widgets/data#leaderboard"
        multiple_measures="False"
        image={<img src="/img/build/dashboard/canvas/components/leaderboard.png" alt="Leaderboard" />}
    />
    <ComponentTile
        header="Pivot / Table"
        link="/developers/build/dashboards/canvas-widgets/data#pivottable"
        multiple_measures="False"
...
<div className="component-icon-grid">
    <ComponentTile
        header="Text"
        link="/developers/build/dashboards/canvas-widgets/misc#textmarkdown"
        multiple_measures="False"
        image={<img src="/img/build/dashboard/canvas/components/text.png" alt="Text" />}
    />
    <ComponentTile
        header="Image"
        link="/developers/build/dashboards/canvas-widgets/misc#image"
        multiple_measures="False"
        image={<img src="/img/build/dashboard/canvas/components/image.png" alt="Image" />}
    /> 
    <ComponentTile
        header="Component"
        link="/developers/build/dashboards/canvas-widgets/misc#component"
        multiple_measures="False"
