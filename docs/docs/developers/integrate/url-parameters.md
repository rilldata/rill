...
When using the [Embed API](/developers/integrate/embed-iframe-api), you can use these URL parameters in the `setState` method:
...
- [Embed Dashboards](/developers/integrate/embedding) - Learn how to embed Rill dashboards
- [Embed Iframe API](/developers/integrate/embed-iframe-api) - Programmatically control embedded dashboards
