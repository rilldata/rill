...
Due to the [separation of dashboards to metrics layer and dashboards](/developers/build/metrics-view), you will need to review your current dashboards and make the following changes (note: Legacy dashboards will continue to function.):
