...
Now - any changes you make locally can be synced directly with your GitHub repo in one click! You can revisit our [build section](/connect/source/) for refreshers on connecting to new sources, modeling data, or building dashboards.
