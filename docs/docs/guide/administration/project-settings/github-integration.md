...
If you have already [setup your connection to GitHub](/developers/deploy/from-local#connect-github-to-an-existing-project), you can edit the branch from the project settings:
