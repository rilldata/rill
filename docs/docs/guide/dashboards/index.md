...
**[Time Series Analysis](/guide/dashboards/time-series)** enables you to analyze trends and patterns over time. Explore:
- Trends and patterns in your data across different time periods
...
**[Bookmarks](/guide/dashboards/bookmarks)** let you save and share specific dashboard states. You can:
- Save specific dashboard states with filters, metrics, and dimensions
- Share bookmarks with your team members
- Set bookmarks as default views for quick access
