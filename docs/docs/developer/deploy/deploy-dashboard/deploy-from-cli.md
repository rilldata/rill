...
2. On your local, [authenticate with Rill Cloud](/user-guide/users/user-management#logging-into-rill-cloud) and create an organization (replace `my-org-name` with your desired name):
```bash
rill login
