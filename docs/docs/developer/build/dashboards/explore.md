...
[Learn more about dashboard defaults →](/developer/build/project-configuration#explore-defaults)
:::

### Using AI

In various locations throughout the platform, you have the opportunity to fast-track your dashboard creation via AI. This feature [creates the underlying metrics view with AI](/developer/build/metrics-view/what-are-metrics-views#creating-a-metrics-view-with-ai) and generates your explore.yaml similar to the example above with the required components.
...
Once a dashboard is ready to preview, before [deploying to Rill Cloud](/developer/deploy/deploy-dashboard), you can preview the dashboard in Rill Developer.
...
If you are setting up [dashboard policies](/developer/build/dashboards/customization#define-dashboard-access), it is recommended to preview and test the dashboard before deploying. This option will be available for testing if you have set up access policies at the [project level](/developer/build/project-configuration#testing-security), [metrics view level](/developer/build/metrics-view/security), or [dashboard level](/developer/build/dashboards/customization#define-dashboard-access).
