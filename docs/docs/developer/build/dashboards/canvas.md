...
While Rill's signature **[Explore dashboards](/developer/build/dashboards/explore)** let you slice, dice, and interact with your data in our suggested layout, **Canvas dashboards** let you define your own visualizations and arrange them into your preferred layout.
...
- **[Data components](/developer/build/dashboards/canvas-widgets/data)** - Display structured data and key metrics (KPIs, leaderboards, tables)
- **[Chart components](/developer/build/dashboards/canvas-widgets/chart)** - Create rich visualizations (bar charts, line charts, heat maps, etc.)
- **[Miscellaneous components](/developer/build/dashboards/canvas-widgets/misc)** - Add text, images, and other content
...
For a complete overview of all available components, see our [**Canvas components**](/developer/build/dashboards/canvas-widgets) reference.
...
While we encourage creating Canvas dashboards via the visual editing experience described above, you can always edit the YAML file directly using the code view by toggling the switch next to the filename at the top of the page. Please see our [customization page](/developer/build/dashboards/customization) and [reference documentation](/reference/project-files/canvas-dashboards) for more information.
...
[Learn more about canvas defaults →](/developer/build/project-configuration#canvas-defaults)
::: 
