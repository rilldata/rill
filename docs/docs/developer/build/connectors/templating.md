...
You can set up environmental variables in several locations in Rill. Please review our [configure local credentials documentation](/developer/build/connectors/credentials#setting-credentials-for-rill-developer) for more information.
...
- [Performance Optimization Guide](/developer/guides/performance)
