...
After establishing a connection, you can import data through the connector UI. This process will write data from your attached database to [Rill's embedded DuckDB.](/developer/build/connectors/olap/duckdb#rill-managed-duckdb)
