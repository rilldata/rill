...
Rill also offers the ability to ingest and create tables directly from a [data source](/developer/build/connectors/data-source) to your OLAP engine via the live connector, however you'll need to consider a few topics.
...
<div className="connector-icon-grid">
  ...
  <ConnectorIcon
    icon={<img src="/img/build/connectors/icons/Logo-StarRocks.png" alt="StarRocks" />}
    content="Distributed OLAP datastore for real-time analytics and business intelligence."
...
Rill supports the use of multiple OLAP engines in a single project with some limitations. For more detailed information, see our reference on [multiple OLAP engines](/developer/build/connectors/olap/multiple-olap). The basic use cases for multiple engines in a single project are:
