...
Rill supports connecting to an existing StarRocks cluster via a "live connector" and using it as an OLAP engine built against [external tables](/developer/build/connectors/olap#external-olap-tables) to power Rill dashboards.
