...
Please see our [Using Multiple OLAP Engines](/developer/build/connectors/olap/multiple-olap) page.
...
- For dashboards powered by Pinot, [measure definitions](/developer/build/metrics-view/#measures) are required to follow [Pinot SQL](https://docs.pinot.apache.org/users/user-guide-query/querying-pinot) syntax.
