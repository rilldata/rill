...
Rill exposes [custom APIs](/developer/build/custom-apis) you have created with `type: api` as HTTP endpoints 
...
- **[User Tokens](/user-guide/manage/user-tokens)** - Personal access tokens for development
- **[Service Tokens](/user-guide/manage/service-tokens)** - Long-lived tokens for production systems
- **[Roles and Permissions](/user-guide/manage/roles-permissions)** - Understand access levels

:::

### Using custom attributes with security policies

Service tokens can include custom attributes for fine-grained access control. Reference these attributes in your [security policies](/developer/build/metrics-view/security#advanced-example-custom-attributes-embed-dashboards):
