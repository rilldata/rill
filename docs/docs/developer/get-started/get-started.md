...
## Install 
Install Rill using the command below, then launch your first project to explore core features hands-on. For more installation methods, see our [complete installation instructions docs](/developer/get-started/install). 
...
<TileIcon
  ...
  link="/developer/build/metrics-view"
...
<TileIcon
  ...
  link="/developer/integrate/embedding"
