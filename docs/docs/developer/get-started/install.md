...
Installing Rill Developer locally is required to create a new project, or [clone a project](/developer/guides/clone-a-project) from Rill Cloud. For key differences between Rill Cloud and Rill Developer, see [Rill Cloud vs. Rill Developer](/developer/deploy/cloud-vs-developer).
:::
