...
While we go into more details in our [Rill Basics course](/developer/guides/rill-basics/dashboard) and [our documentation](https://docs.rilldata.com/build/dashboards), let's go over it quickly.
