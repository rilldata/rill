...
Starting from version 0.50, we have introduced the [visual-metric-editor](/developer/build/metrics-view/what-are-metrics-views#using-the-visual-metrics-editor), in the top right corner, you can select whether you want to modify the YAML directly or use a UI tool.
