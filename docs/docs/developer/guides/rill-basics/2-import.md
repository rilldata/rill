...
In Rill, a source model represents your raw data. See our list of [connectors](/developer/build/connectors) or select Add -> Add Data from Rill Developer to see the supported sources.
...
We support various OLAP engines. If you have a different OLAP engine that you're interested in using, please let us know! Looking for a ClickHouse tutorial? Click [here!](/developer/guides/rill-clickhouse/r_ch_launch)
:::
