...
The source connects to our static public dataset containing operational cost and revenue data. You can modify this [source](/developer/build/connectors) to point to your own data export.
...
- Connects to our public GCS bucket (if modified, will need to be verified via [credentials](/developer/build/connectors/credentials))
...
## Step 4: Data Models
:::tip Modeling
In our example, we've already processed the data, but if you need to do some last-mile ETL in Rill, this is possible via a [model](/developer/build/models).
:::
