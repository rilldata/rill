...
In this case, we are not joining the data models and having two unique explore models and joining the visualization in a [Canvas Dashboard](/developer/build/dashboards/canvas).
