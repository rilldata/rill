...
1. Installed the Rill developer CLI - see [Install Rill Developer](/developer/get-started/install)
...
- [Custom API Integration Guide](/developer/integrate/custom-api)
