...
Rill supports a wide range of data sources through our [connector library](/connect/connect/connectors/). For this tutorial, we'll use a sample dataset hosted on Google Cloud Storage.
