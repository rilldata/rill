...
Public URL can also be managed via the Settings page in Rill Cloud. Please refer to the [administrators guide](../../administration/project/project-maintanence#public-url-management)!
