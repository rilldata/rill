...
4. Select "Attach policies directly" and search for the "AmazonS3ReadOnlyAccess" policy. Check the box next to the policy to select it and click "Next". Then, under "Set permissions boundaries and tags", click the "Create user" button.
