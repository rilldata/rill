...
Access to Rill can be granted on the [organization level](/user-guide/manage/user-management#how-to-add-an-organization-user), [project level](/user-guide/manage/user-management#how-to-add-a-project-user), and [user group level](/user-guide/manage/user-management#how-to-add-a-user-to-a-usergroup).
