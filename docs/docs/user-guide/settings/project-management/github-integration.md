...
If you have already [setup your connection to GitHub](/developer/deploy/deploy-dashboard/#syncing-your-github-repository), you can edit the branch from the project settings:
