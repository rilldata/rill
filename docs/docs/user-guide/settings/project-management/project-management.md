...
Projects can be connected to a GitHub repository for continuous deployment. See [GitHub Integration](/user-guide/settings/project-management/github-integration) for details on connecting and managing repository connections.
::: 
