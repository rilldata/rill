...
For more details on roles, see [Roles and Permissions](/user-guide/manage/roles-permissions).
...
For more details, see [Custom API Integration](/developer/integrate/custom-api).
