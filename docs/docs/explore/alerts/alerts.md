...
On the final tab, you will choose how and where your alert is delivered. By default, the alert will be checked whenever the source data is [refreshed](/connect/source/source-refresh). There are a few additional things worth noting:
