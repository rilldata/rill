...
- **[Pivot Tables](/explore/dashboard-101/pivot)** - Create cross-tabulations and data summaries directly in your dashboard.
- **[Time Dimension Details](/explore/dashboard-101/tdd)** - Drill down into specific time periods for granular analysis.
