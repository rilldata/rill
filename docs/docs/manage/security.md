...
To support this, ingest a separate data [source](/connect/source/) containing mappings of user email addresses to tenant IDs and reference it in the row-level filter. This can be a locally created csv file or any hosted data source.
