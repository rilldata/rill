...
- **Works directly with your data lake**: [Connects directly](/build/connectors) to your cloud data warehouse (BigQuery, Snowflake), lakehouse, or object storage (S3, GCS, Azure) without complex ETL.
- **Built-in OLAP**: An [integrated, in-memory OLAP engine](/build/connectors/olap) handles data orchestration and query execution automatically for blazing speed.
...
*   **AI-Powered**: Rill integrates with AI tools to let you query your metrics views using natural language, ensuring responses are accurate and governed by your predefined measures and dimensions. See [AI Chat](/explore/ai-chat) for more.
